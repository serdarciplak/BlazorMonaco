...
export function initializeMonacoEditor() {
    ...
    window.blazorMonaco.editor = {
        ...
        colorizeElement: function (elementId, options) {
            return editor.colorizeElement(document.getElementById(elementId), options);
        },
        ...
        colorizeModelLine: function (uriStr, lineNumber, tabSize) {
            ...
            if (model == null)
                return null;
            return editor.colorizeModelLine(model, lineNumber, tabSize);
        },
        ...
        create: function (id, options, dotnetRef) {
            ...
            var editorResult = editor.create(document.getElementById(id), options);
            window.blazorMonaco.editors.push({ id: id, editor: editorResult, dotnetRef: dotnetRef });
        },
        ...
        createDiffEditor: function (id, options, dotnetRef) {
            ...
            var editorResult = editor.createDiffEditor(document.getElementById(id), options);
            window.blazorMonaco.editors.push({ id: id, editor: editorResult, dotnetRef: dotnetRef });
            window.blazorMonaco.editors.push({ id: id + "_original", editor: editorResult.getOriginalEditor() });
            window.blazorMonaco.editors.push({ id: id + "_modified", editor: editorResult.getModifiedEditor() });

            if (oldModel !== null)
                editorResult.setModel(oldModel);
        },
        ...
        createModel: function (value, language, uriStr) {
            ...
            var model = editor.createModel(value, language, uri);
            if (model == null)
                return null;
        ...
        getModels: function () {
            return editor.getModels().map(function (value) {
                return {
                    id: value.id,
        ...
        setModelLanguage: function (uriStr, languageId) {
            ...
            if (model == null)
                return null;
            return editor.setModelLanguage(model, languageId);
        },
