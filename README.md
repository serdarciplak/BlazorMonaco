...
* You can define custom themes using the `DefineTheme` method.

```csharp
await BlazorMonaco.Editor.Global.DefineTheme(jsRuntime, "my-custom-theme", new StandaloneThemeData
{
	Base = "vs-dark",
	Inherit = true,
