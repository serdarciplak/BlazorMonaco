define("vs/language/css/cssWorker",["require","require"],e=>{"use strict";return(()=>{var d,P,A=Object.defineProperty,W=Object.getOwnPropertyDescriptor,L=Object.getOwnPropertyNames,$=Object.prototype.hasOwnProperty,U={},V=U,j={CSSWorker:()=>Oi,create:()=>function(e,t){return new Oi(e,t)}};for(P in j)A(V,P,{get:j[P],enumerable:!0});(e=d=d||{})[e.Ident=0]="Ident",e[e.AtKeyword=1]="AtKeyword",e[e.String=2]="String",e[e.BadString=3]="BadString",e[e.UnquotedString=4]="UnquotedString",e[e.Hash=5]="Hash",e[e.Num=6]="Num",e[e.Percentage=7]="Percentage",e[e.Dimension=8]="Dimension",e[e.UnicodeRange=9]="UnicodeRange",e[e.CDO=10]="CDO",e[e.CDC=11]="CDC",e[e.Colon=12]="Colon",e[e.SemiColon=13]="SemiColon",e[e.CurlyL=14]="CurlyL",e[e.CurlyR=15]="CurlyR",e[e.ParenthesisL=16]="ParenthesisL",e[e.ParenthesisR=17]="ParenthesisR",e[e.BracketL=18]="BracketL",e[e.BracketR=19]="BracketR",e[e.Whitespace=20]="Whitespace",e[e.Includes=21]="Includes",e[e.Dashmatch=22]="Dashmatch",e[e.SubstringOperator=23]="SubstringOperator",e[e.PrefixOperator=24]="PrefixOperator",e[e.SuffixOperator=25]="SuffixOperator",e[e.Delim=26]="Delim",e[e.EMS=27]="EMS",e[e.EXS=28]="EXS",e[e.Length=29]="Length",e[e.Angle=30]="Angle",e[e.Time=31]="Time",e[e.Freq=32]="Freq",e[e.Exclamation=33]="Exclamation",e[e.Resolution=34]="Resolution",e[e.Comma=35]="Comma",e[e.Charset=36]="Charset",e[e.EscapedJavaScript=37]="EscapedJavaScript",e[e.BadEscapedJavaScript=38]="BadEscapedJavaScript",e[e.Comment=39]="Comment",e[e.SingleLineComment=40]="SingleLineComment",e[e.EOF=41]="EOF",e[e.ContainerQueryLength=42]="ContainerQueryLength",e[e.CustomToken=43]="CustomToken";var u,o,B=class{constructor(e){this.source=e,this.len=e.length,this.position=0}substring(e,t=this.position){return this.source.substring(e,t)}eos(){return this.len<=this.position}pos(){return this.position}goBackTo(e){this.position=e}goBack(e){this.position-=e}advance(e){this.position+=e}nextChar(){return this.source.charCodeAt(this.position++)||0}peekChar(e=0){return this.source.charCodeAt(this.position+e)||0}lookbackChar(e=0){return this.source.charCodeAt(this.position-e)||0}advanceIfChar(e){return e===this.source.charCodeAt(this.position)&&(this.position++,!0)}advanceIfChars(e){if(this.position+e.length>this.source.length)return!1;let t=0;for(;t<e.length;t++)if(this.source.charCodeAt(this.position+t)!==e[t])return!1;return this.advance(t),!0}advanceWhileChar(e){for(var t=this.position;this.position<this.len&&e(this.source.charCodeAt(this.position));)this.position++;return this.position-t}},q=45,K=10,G=13,i={},s=(i[59]=d.SemiColon,i[58]=d.Colon,i[123]=d.CurlyL,i[125]=d.CurlyR,i[93]=d.BracketR,i[91]=d.BracketL,i[40]=d.ParenthesisL,i[41]=d.ParenthesisR,i[44]=d.Comma,{}),J=(s.em=d.EMS,s.ex=d.EXS,s.px=d.Length,s.cm=d.Length,s.mm=d.Length,s.in=d.Length,s.pt=d.Length,s.pc=d.Length,s.deg=d.Angle,s.rad=d.Angle,s.grad=d.Angle,s.ms=d.Time,s.s=d.Time,s.hz=d.Freq,s.khz=d.Freq,s["%"]=d.Percentage,s.fr=d.Percentage,s.dpi=d.Resolution,s.dpcm=d.Resolution,s.cqw=d.ContainerQueryLength,s.cqh=d.ContainerQueryLength,s.cqi=d.ContainerQueryLength,s.cqb=d.ContainerQueryLength,s.cqmin=d.ContainerQueryLength,s.cqmax=d.ContainerQueryLength,class{constructor(){this.stream=new B(""),this.ignoreComment=!0,this.ignoreWhitespace=!0,this.inURL=!1}setSource(e){this.stream=new B(e)}finishToken(e,t,n){return{offset:e,len:this.stream.pos()-e,type:t,text:n||this.stream.substring(e)}}substring(e,t){return this.stream.substring(e,e+t)}pos(){return this.stream.pos()}goBackTo(e){this.stream.goBackTo(e)}scanUnquotedString(){let e=this.stream.pos(),t=[];return this._unquotedString(t)?this.finishToken(e,d.UnquotedString,t.join("")):null}scan(){var e=this.trivia();if(null!==e)return e;e=this.stream.pos();return this.stream.eos()?this.finishToken(e,d.EOF):this.scanNext(e)}tryScanUnicode(){var e=this.stream.pos();if(!this.stream.eos()&&this._unicodeRange())return this.finishToken(e,d.UnicodeRange);this.stream.goBackTo(e)}scanNext(e){if(this.stream.advanceIfChars([60,33,q,q]))return this.finishToken(e,d.CDO);if(this.stream.advanceIfChars([q,q,62]))return this.finishToken(e,d.CDC);let t=[];if(this.ident(t))return this.finishToken(e,d.Ident,t.join(""));var n;if(this.stream.advanceIfChar(64))return t=["@"],this._name(t)?"@charset"===(n=t.join(""))?this.finishToken(e,d.Charset,n):this.finishToken(e,d.AtKeyword,n):this.finishToken(e,d.Delim);if(this.stream.advanceIfChar(35))return t=["#"],this._name(t)?this.finishToken(e,d.Hash,t.join("")):this.finishToken(e,d.Delim);if(this.stream.advanceIfChar(33))return this.finishToken(e,d.Exclamation);if(this._number())return n=this.stream.pos(),t=[this.stream.substring(e,n)],this.stream.advanceIfChar(37)?this.finishToken(e,d.Percentage):this.ident(t)?(n=this.stream.substring(n).toLowerCase(),typeof(n=s[n])<"u"?this.finishToken(e,n,t.join("")):this.finishToken(e,d.Dimension,t.join(""))):this.finishToken(e,d.Num);t=[];let r=this._string(t);return null!==r?this.finishToken(e,r,t.join("")):typeof(r=i[this.stream.peekChar()])<"u"?(this.stream.advance(1),this.finishToken(e,r)):126===this.stream.peekChar(0)&&61===this.stream.peekChar(1)?(this.stream.advance(2),this.finishToken(e,d.Includes)):124===this.stream.peekChar(0)&&61===this.stream.peekChar(1)?(this.stream.advance(2),this.finishToken(e,d.Dashmatch)):42===this.stream.peekChar(0)&&61===this.stream.peekChar(1)?(this.stream.advance(2),this.finishToken(e,d.SubstringOperator)):94===this.stream.peekChar(0)&&61===this.stream.peekChar(1)?(this.stream.advance(2),this.finishToken(e,d.PrefixOperator)):36===this.stream.peekChar(0)&&61===this.stream.peekChar(1)?(this.stream.advance(2),this.finishToken(e,d.SuffixOperator)):(this.stream.nextChar(),this.finishToken(e,d.Delim))}trivia(){for(;;){var e=this.stream.pos();if(this._whitespace()){if(!this.ignoreWhitespace)return this.finishToken(e,d.Whitespace)}else{if(!this.comment())return null;if(!this.ignoreComment)return this.finishToken(e,d.Comment)}}}comment(){if(this.stream.advanceIfChars([47,42])){let t=!1,n=!1;return this.stream.advanceWhileChar(e=>n&&47===e?!(t=!0):(n=42===e,!0)),t&&this.stream.advance(1),!0}return!1}_number(){let t=0,e;return 46===this.stream.peekChar()&&(t=1),48<=(e=this.stream.peekChar(t))&&e<=57&&(this.stream.advance(t+1),this.stream.advanceWhileChar(e=>48<=e&&e<=57||0===t&&46===e),!0)}_newline(e){var t=this.stream.peekChar();switch(t){case G:case 12:case K:return this.stream.advance(1),e.push(String.fromCharCode(t)),t===G&&this.stream.advanceIfChar(K)&&e.push(`
`),!0}return!1}_escape(t,n){let r=this.stream.peekChar();if(92===r){this.stream.advance(1),r=this.stream.peekChar();let e=0;for(;e<6&&(48<=r&&r<=57||97<=r&&r<=102||65<=r&&r<=70);)this.stream.advance(1),r=this.stream.peekChar(),e++;if(0<e){try{var i=parseInt(this.stream.substring(this.stream.pos()-e),16);i&&t.push(String.fromCharCode(i))}catch{}return 32===r||9===r?this.stream.advance(1):this._newline([]),!0}if(r!==G&&12!==r&&r!==K)return this.stream.advance(1),t.push(String.fromCharCode(r)),!0;if(n)return this._newline(t)}return!1}_stringChar(e,t){var n=this.stream.peekChar();return 0!==n&&n!==e&&92!==n&&n!==G&&12!==n&&n!==K&&(this.stream.advance(1),t.push(String.fromCharCode(n)),!0)}_string(e){if(39!==this.stream.peekChar()&&34!==this.stream.peekChar())return null;var t=this.stream.nextChar();for(e.push(String.fromCharCode(t));this._stringChar(t,e)||this._escape(e,!0););return this.stream.peekChar()===t?(this.stream.nextChar(),e.push(String.fromCharCode(t)),d.String):d.BadString}_unquotedChar(e){var t=this.stream.peekChar();return 0!==t&&92!==t&&39!==t&&34!==t&&40!==t&&41!==t&&32!==t&&9!==t&&t!==K&&12!==t&&t!==G&&(this.stream.advance(1),e.push(String.fromCharCode(t)),!0)}_unquotedString(e){let t=!1;for(;this._unquotedChar(e)||this._escape(e);)t=!0;return t}_whitespace(){return 0<this.stream.advanceWhileChar(e=>32===e||9===e||e===K||12===e||e===G)}_name(e){let t=!1;for(;this._identChar(e)||this._escape(e);)t=!0;return t}ident(e){var t=this.stream.pos();if(this._minus(e)){if(this._minus(e)||this._identFirstChar(e)||this._escape(e)){for(;this._identChar(e)||this._escape(e););return!0}}else if(this._identFirstChar(e)||this._escape(e)){for(;this._identChar(e)||this._escape(e););return!0}return this.stream.goBackTo(t),!1}_identFirstChar(e){var t=this.stream.peekChar();return(95===t||97<=t&&t<=122||65<=t&&t<=90||128<=t&&t<=65535)&&(this.stream.advance(1),e.push(String.fromCharCode(t)),!0)}_minus(e){var t=this.stream.peekChar();return t===q&&(this.stream.advance(1),e.push(String.fromCharCode(t)),!0)}_identChar(e){var t=this.stream.peekChar();return(95===t||t===q||97<=t&&t<=122||65<=t&&t<=90||48<=t&&t<=57||128<=t&&t<=65535)&&(this.stream.advance(1),e.push(String.fromCharCode(t)),!0)}_unicodeRange(){if(this.stream.advanceIfChar(43)){var e=e=>48<=e&&e<=57||97<=e&&e<=102||65<=e&&e<=70,t=this.stream.advanceWhileChar(e)+this.stream.advanceWhileChar(e=>63===e);if(1<=t&&t<=6){if(!this.stream.advanceIfChar(q))return!0;t=this.stream.advanceWhileChar(e);if(1<=t&&t<=6)return!0}}return!1}});function v(t,n){if(t.length<n.length)return!1;for(let e=0;e<n.length;e++)if(t[e]!==n[e])return!1;return!0}function H(e,t){var n=e.length-t.length;return 0<n?e.lastIndexOf(t)===n:0==n&&e===t}function X(e,t=!0){return e?e.length<140?e:e.slice(0,140)+(t?"…":""):""}function Y(e,t){let n="";for(;0<t;)1==(1&t)&&(n+=e),e+=e,t>>>=1;return n}function Q(e,t){let n=null;return!e||t<e.offset||t>e.end?null:(e.accept(e=>-1===e.offset&&-1===e.length||e.offset<=t&&e.end>=t&&((!n||e.length<=n.length)&&(n=e),!0)),n)}function Z(e,t){let n=Q(e,t),r=[];for(;n;)r.unshift(n),n=n.parent;return r}(e=u=u||{})[e.Undefined=0]="Undefined",e[e.Identifier=1]="Identifier",e[e.Stylesheet=2]="Stylesheet",e[e.Ruleset=3]="Ruleset",e[e.Selector=4]="Selector",e[e.SimpleSelector=5]="SimpleSelector",e[e.SelectorInterpolation=6]="SelectorInterpolation",e[e.SelectorCombinator=7]="SelectorCombinator",e[e.SelectorCombinatorParent=8]="SelectorCombinatorParent",e[e.SelectorCombinatorSibling=9]="SelectorCombinatorSibling",e[e.SelectorCombinatorAllSiblings=10]="SelectorCombinatorAllSiblings",e[e.SelectorCombinatorShadowPiercingDescendant=11]="SelectorCombinatorShadowPiercingDescendant",e[e.Page=12]="Page",e[e.PageBoxMarginBox=13]="PageBoxMarginBox",e[e.ClassSelector=14]="ClassSelector",e[e.IdentifierSelector=15]="IdentifierSelector",e[e.ElementNameSelector=16]="ElementNameSelector",e[e.PseudoSelector=17]="PseudoSelector",e[e.AttributeSelector=18]="AttributeSelector",e[e.Declaration=19]="Declaration",e[e.Declarations=20]="Declarations",e[e.Property=21]="Property",e[e.Expression=22]="Expression",e[e.BinaryExpression=23]="BinaryExpression",e[e.Term=24]="Term",e[e.Operator=25]="Operator",e[e.Value=26]="Value",e[e.StringLiteral=27]="StringLiteral",e[e.URILiteral=28]="URILiteral",e[e.EscapedValue=29]="EscapedValue",e[e.Function=30]="Function",e[e.NumericValue=31]="NumericValue",e[e.HexColorValue=32]="HexColorValue",e[e.RatioValue=33]="RatioValue",e[e.MixinDeclaration=34]="MixinDeclaration",e[e.MixinReference=35]="MixinReference",e[e.VariableName=36]="VariableName",e[e.VariableDeclaration=37]="VariableDeclaration",e[e.Prio=38]="Prio",e[e.Interpolation=39]="Interpolation",e[e.NestedProperties=40]="NestedProperties",e[e.ExtendsReference=41]="ExtendsReference",e[e.SelectorPlaceholder=42]="SelectorPlaceholder",e[e.Debug=43]="Debug",e[e.If=44]="If",e[e.Else=45]="Else",e[e.For=46]="For",e[e.Each=47]="Each",e[e.While=48]="While",e[e.MixinContentReference=49]="MixinContentReference",e[e.MixinContentDeclaration=50]="MixinContentDeclaration",e[e.Media=51]="Media",e[e.Keyframe=52]="Keyframe",e[e.FontFace=53]="FontFace",e[e.Import=54]="Import",e[e.Namespace=55]="Namespace",e[e.Invocation=56]="Invocation",e[e.FunctionDeclaration=57]="FunctionDeclaration",e[e.ReturnStatement=58]="ReturnStatement",e[e.MediaQuery=59]="MediaQuery",e[e.MediaCondition=60]="MediaCondition",e[e.MediaFeature=61]="MediaFeature",e[e.FunctionParameter=62]="FunctionParameter",e[e.FunctionArgument=63]="FunctionArgument",e[e.KeyframeSelector=64]="KeyframeSelector",e[e.ViewPort=65]="ViewPort",e[e.Document=66]="Document",e[e.AtApplyRule=67]="AtApplyRule",e[e.CustomPropertyDeclaration=68]="CustomPropertyDeclaration",e[e.CustomPropertySet=69]="CustomPropertySet",e[e.ListEntry=70]="ListEntry",e[e.Supports=71]="Supports",e[e.SupportsCondition=72]="SupportsCondition",e[e.NamespacePrefix=73]="NamespacePrefix",e[e.GridLine=74]="GridLine",e[e.Plugin=75]="Plugin",e[e.UnknownAtRule=76]="UnknownAtRule",e[e.Use=77]="Use",e[e.ModuleConfiguration=78]="ModuleConfiguration",e[e.Forward=79]="Forward",e[e.ForwardVisibility=80]="ForwardVisibility",e[e.Module=81]="Module",e[e.UnicodeRange=82]="UnicodeRange",e[e.Layer=83]="Layer",e[e.LayerNameList=84]="LayerNameList",e[e.LayerName=85]="LayerName",e[e.PropertyAtRule=86]="PropertyAtRule",e[e.Container=87]="Container",(e=o=o||{})[e.Mixin=0]="Mixin",e[e.Rule=1]="Rule",e[e.Variable=2]="Variable",e[e.Function=3]="Function",e[e.Keyframe=4]="Keyframe",e[e.Unknown=5]="Unknown",e[e.Module=6]="Module",e[e.Forward=7]="Forward",e[e.ForwardVisibility=8]="ForwardVisibility",e[e.Property=9]="Property";var a,p=class{get end(){return this.offset+this.length}constructor(e=-1,t=-1,n){this.parent=null,this.offset=e,this.length=t,n&&(this.nodeType=n)}set type(e){this.nodeType=e}get type(){return this.nodeType||u.Undefined}getTextProvider(){let e=this;for(;e&&!e.textProvider;)e=e.parent;return e?e.textProvider:()=>"unknown"}getText(){return this.getTextProvider()(this.offset,this.length)}matches(e){return this.length===e.length&&this.getTextProvider()(this.offset,this.length)===e}startsWith(e){return this.length>=e.length&&this.getTextProvider()(this.offset,e.length)===e}endsWith(e){return this.length>=e.length&&this.getTextProvider()(this.end-e.length,e.length)===e}accept(e){if(e(this)&&this.children)for(var t of this.children)t.accept(e)}acceptVisitor(e){this.accept(e.visitNode.bind(e))}adoptChild(e,t=-1){var n;e.parent&&e.parent.children&&(0<=(n=e.parent.children.indexOf(e))&&e.parent.children.splice(n,1));let r=(e.parent=this).children;return r=r||(this.children=[]),-1!==t?r.splice(t,0,e):r.push(e),e}attachTo(e,t=-1){return e&&e.adoptChild(this,t),this}collectIssues(e){this.issues&&e.push.apply(e,this.issues)}addIssue(e){this.issues||(this.issues=[]),this.issues.push(e)}hasIssue(t){return Array.isArray(this.issues)&&this.issues.some(e=>e.getRule()===t)}isErroneous(e=!1){return!!(this.issues&&0<this.issues.length)||e&&Array.isArray(this.children)&&this.children.some(e=>e.isErroneous(!0))}setNode(e,t,n=-1){return!!t&&(t.attachTo(this,n),this[e]=t,!0)}addChild(e){return!!e&&(this.children||(this.children=[]),e.attachTo(this),this.updateOffsetAndLength(e),!0)}updateOffsetAndLength(e){(e.offset<this.offset||-1===this.offset)&&(this.offset=e.offset);e=e.end;(e>this.end||-1===this.length)&&(this.length=e-this.offset)}hasChildren(){return!!this.children&&0<this.children.length}getChildren(){return this.children?this.children.slice(0):[]}getChild(e){return this.children&&e<this.children.length?this.children[e]:null}addChildren(e){for(var t of e)this.addChild(t)}findFirstChildBeforeOffset(t){if(this.children){var n;for(let e=this.children.length-1;0<=e;e--)if((n=this.children[e]).offset<=t)return n}return null}findChildAtOffset(e,t){let n=this.findFirstChildBeforeOffset(e);return n&&n.end>=e?t&&n.findChildAtOffset(e,!0)||n:null}encloses(e){return this.offset<=e.offset&&this.offset+this.length>=e.offset+e.length}getParent(){let e=this.parent;for(;e instanceof l;)e=e.parent;return e}findParent(e){let t=this;for(;t&&t.type!==e;)t=t.parent;return t}findAParent(...e){let t=this;for(;t&&!e.some(e=>t.type===e);)t=t.parent;return t}setData(e,t){this.options||(this.options={}),this.options[e]=t}getData(e){return this.options&&this.options.hasOwnProperty(e)?this.options[e]:null}},l=class extends p{constructor(e,t=-1){super(-1,-1),this.attachTo(e,t),this.offset=-1,this.length=-1}},ee=class extends p{constructor(e,t){super(e,t)}get type(){return u.UnicodeRange}setRangeStart(e){return this.setNode("rangeStart",e)}getRangeStart(){return this.rangeStart}setRangeEnd(e){return this.setNode("rangeEnd",e)}getRangeEnd(){return this.rangeEnd}},c=class extends p{constructor(e,t){super(e,t),this.isCustomProperty=!1}get type(){return u.Identifier}containsInterpolation(){return this.hasChildren()}},te=class extends p{constructor(e,t){super(e,t)}get type(){return u.Stylesheet}},ne=class extends p{constructor(e,t){super(e,t)}get type(){return u.Declarations}},h=class extends p{constructor(e,t){super(e,t)}getDeclarations(){return this.declarations}setDeclarations(e){return this.setNode("declarations",e)}},re=class extends h{constructor(e,t){super(e,t)}get type(){return u.Ruleset}getSelectors(){return this.selectors||(this.selectors=new l(this)),this.selectors}isNested(){return!!this.parent&&null!==this.parent.findParent(u.Declarations)}},ie=class extends p{constructor(e,t){super(e,t)}get type(){return u.Selector}},se=class extends p{constructor(e,t){super(e,t)}get type(){return u.SimpleSelector}},ae=class extends p{constructor(e,t){super(e,t)}},oe=class extends h{constructor(e,t){super(e,t)}get type(){return u.CustomPropertySet}},y=class Ui extends ae{constructor(e,t){super(e,t),this.property=null}get type(){return u.Declaration}setProperty(e){return this.setNode("property",e)}getProperty(){return this.property}getFullPropertyName(){var t=this.property?this.property.getName():"unknown";if(this.parent instanceof ne&&this.parent.getParent()instanceof xe){let e=this.parent.getParent().getParent();if(e instanceof Ui)return e.getFullPropertyName()+t}return t}getNonPrefixedPropertyName(){let e=this.getFullPropertyName();if(e&&"-"===e.charAt(0)){var t=e.indexOf("-",1);if(-1!==t)return e.substring(t+1)}return e}setValue(e){return this.setNode("value",e)}getValue(){return this.value}setNestedProperties(e){return this.setNode("nestedProperties",e)}getNestedProperties(){return this.nestedProperties}},le=class extends y{constructor(e,t){super(e,t)}get type(){return u.CustomPropertyDeclaration}setPropertySet(e){return this.setNode("propertySet",e)}getPropertySet(){return this.propertySet}},ce=class extends p{constructor(e,t){super(e,t)}get type(){return u.Property}setIdentifier(e){return this.setNode("identifier",e)}getIdentifier(){return this.identifier}getName(){return e=this.getText(),(t=(t=/[_\+]+$/).exec(e))&&t[0].length?e.substr(0,e.length-t[0].length):e;var e,t}isCustomProperty(){return!!this.identifier&&this.identifier.isCustomProperty}},de=class extends class extends p{constructor(e,t){super(e,t)}get type(){return u.Invocation}getArguments(){return this.arguments||(this.arguments=new l(this)),this.arguments}}{constructor(e,t){super(e,t)}get type(){return u.Function}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}},he=class extends p{constructor(e,t){super(e,t)}get type(){return u.FunctionParameter}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}setDefaultValue(e){return this.setNode("defaultValue",e,0)}getDefaultValue(){return this.defaultValue}},pe=class extends p{constructor(e,t){super(e,t)}get type(){return u.FunctionArgument}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}setValue(e){return this.setNode("value",e,0)}getValue(){return this.value}},me=class extends h{constructor(e,t){super(e,t)}get type(){return u.If}setExpression(e){return this.setNode("expression",e,0)}setElseClause(e){return this.setNode("elseClause",e)}},ue=class extends h{constructor(e,t){super(e,t)}get type(){return u.For}setVariable(e){return this.setNode("variable",e,0)}},fe=class extends h{constructor(e,t){super(e,t)}get type(){return u.Each}getVariables(){return this.variables||(this.variables=new l(this)),this.variables}},ge=class extends h{constructor(e,t){super(e,t)}get type(){return u.While}},be=class extends h{constructor(e,t){super(e,t)}get type(){return u.Else}},ve=class extends h{constructor(e,t){super(e,t)}get type(){return u.FunctionDeclaration}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}getParameters(){return this.parameters||(this.parameters=new l(this)),this.parameters}},we=class extends h{constructor(e,t){super(e,t)}get type(){return u.ViewPort}},ye=class extends h{constructor(e,t){super(e,t)}get type(){return u.FontFace}},xe=class extends h{constructor(e,t){super(e,t)}get type(){return u.NestedProperties}},Se=class extends h{constructor(e,t){super(e,t)}get type(){return u.Keyframe}setKeyword(e){return this.setNode("keyword",e,0)}getKeyword(){return this.keyword}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}},Ce=class extends h{constructor(e,t){super(e,t)}get type(){return u.KeyframeSelector}},ke=class extends p{constructor(e,t){super(e,t)}get type(){return u.Import}setMedialist(e){return!!e&&(e.attachTo(this),!0)}},Fe=class extends p{get type(){return u.Use}getParameters(){return this.parameters||(this.parameters=new l(this)),this.parameters}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}},Ee=class extends p{get type(){return u.ModuleConfiguration}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}setValue(e){return this.setNode("value",e,0)}getValue(){return this.value}},_e=class extends p{get type(){return u.Forward}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getMembers(){return this.members||(this.members=new l(this)),this.members}getParameters(){return this.parameters||(this.parameters=new l(this)),this.parameters}},Ie=class extends p{get type(){return u.ForwardVisibility}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}},ze=class extends p{constructor(e,t){super(e,t)}get type(){return u.Namespace}},De=class extends h{constructor(e,t){super(e,t)}get type(){return u.Media}},Re=class extends h{constructor(e,t){super(e,t)}get type(){return u.Supports}},Te=class extends h{constructor(e,t){super(e,t)}get type(){return u.Layer}setNames(e){return this.setNode("names",e)}getNames(){return this.names}},Me=class extends h{constructor(e,t){super(e,t)}get type(){return u.PropertyAtRule}setName(e){return!!e&&(e.attachTo(this),this.name=e,!0)}getName(){return this.name}},Ne=class extends h{constructor(e,t){super(e,t)}get type(){return u.Document}},Oe=class extends h{constructor(e,t){super(e,t)}get type(){return u.Container}},Pe=class extends p{constructor(e,t){super(e,t)}},Ae=class extends p{constructor(e,t){super(e,t)}get type(){return u.MediaQuery}},We=class extends p{constructor(e,t){super(e,t)}get type(){return u.MediaCondition}},Le=class extends p{constructor(e,t){super(e,t)}get type(){return u.MediaFeature}},$e=class extends p{constructor(e,t){super(e,t)}get type(){return u.SupportsCondition}},Ue=class extends h{constructor(e,t){super(e,t)}get type(){return u.Page}},Ve=class extends h{constructor(e,t){super(e,t)}get type(){return u.PageBoxMarginBox}},je=class extends p{constructor(e,t){super(e,t)}get type(){return u.Expression}},Be=class extends p{constructor(e,t){super(e,t)}get type(){return u.BinaryExpression}setLeft(e){return this.setNode("left",e)}getLeft(){return this.left}setRight(e){return this.setNode("right",e)}getRight(){return this.right}setOperator(e){return this.setNode("operator",e)}getOperator(){return this.operator}},qe=class extends p{constructor(e,t){super(e,t)}get type(){return u.Term}setOperator(e){return this.setNode("operator",e)}getOperator(){return this.operator}setExpression(e){return this.setNode("expression",e)}getExpression(){return this.expression}},Ke=class extends p{constructor(e,t){super(e,t)}get type(){return u.AttributeSelector}setNamespacePrefix(e){return this.setNode("namespacePrefix",e)}getNamespacePrefix(){return this.namespacePrefix}setIdentifier(e){return this.setNode("identifier",e)}getIdentifier(){return this.identifier}setOperator(e){return this.setNode("operator",e)}getOperator(){return this.operator}setValue(e){return this.setNode("value",e)}getValue(){return this.value}},Ge=class extends p{constructor(e,t){super(e,t)}get type(){return u.HexColorValue}},Je=class extends p{constructor(e,t){super(e,t)}get type(){return u.RatioValue}},He=class extends p{constructor(e,t){super(e,t)}get type(){return u.NumericValue}getValue(){let n=this.getText(),r=0,i;for(let e=0,t=n.length;e<t&&(48<=(i=n.charCodeAt(e))&&i<=57||46===i);e++)r+=1;return{value:n.substring(0,r),unit:r<n.length?n.substring(r):void 0}}},Xe=class extends ae{constructor(e,t){super(e,t),this.needsSemicolon=!0}get type(){return u.VariableDeclaration}setVariable(e){return!!e&&(e.attachTo(this),this.variable=e,!0)}getVariable(){return this.variable}getName(){return this.variable?this.variable.getName():""}setValue(e){return!!e&&(e.attachTo(this),this.value=e,!0)}getValue(){return this.value}},Ye=class extends p{constructor(e,t){super(e,t)}get type(){return u.Interpolation}},Qe=class extends p{constructor(e,t){super(e,t)}get type(){return u.VariableName}getName(){return this.getText()}},Ze=class extends p{constructor(e,t){super(e,t)}get type(){return u.ExtendsReference}getSelectors(){return this.selectors||(this.selectors=new l(this)),this.selectors}},et=class extends p{constructor(e,t){super(e,t)}get type(){return u.MixinContentReference}getArguments(){return this.arguments||(this.arguments=new l(this)),this.arguments}},tt=class extends h{constructor(e,t){super(e,t)}get type(){return u.MixinContentDeclaration}getParameters(){return this.parameters||(this.parameters=new l(this)),this.parameters}},nt=class extends p{constructor(e,t){super(e,t)}get type(){return u.MixinReference}getNamespaces(){return this.namespaces||(this.namespaces=new l(this)),this.namespaces}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}getArguments(){return this.arguments||(this.arguments=new l(this)),this.arguments}setContent(e){return this.setNode("content",e)}getContent(){return this.content}},rt=class extends h{constructor(e,t){super(e,t)}get type(){return u.MixinDeclaration}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}getName(){return this.identifier?this.identifier.getText():""}getParameters(){return this.parameters||(this.parameters=new l(this)),this.parameters}setGuard(e){return e&&(e.attachTo(this),this.guard=e),!1}},it=class extends h{constructor(e,t){super(e,t)}get type(){return u.UnknownAtRule}setAtRuleName(e){this.atRuleName=e}getAtRuleName(){return this.atRuleName}},st=class extends p{get type(){return u.ListEntry}setKey(e){return this.setNode("key",e,0)}setValue(e){return this.setNode("value",e,1)}},at=class extends p{getConditions(){return this.conditions||(this.conditions=new l(this)),this.conditions}},ot=class extends p{setVariable(e){return this.setNode("variable",e)}},lt=class extends p{get type(){return u.Module}setIdentifier(e){return this.setNode("identifier",e,0)}getIdentifier(){return this.identifier}},ct=((e=a=a||{})[e.Ignore=1]="Ignore",e[e.Warning=2]="Warning",e[e.Error=4]="Error",class{constructor(e,t,n,r,i=e.offset,s=e.length){this.node=e,this.rule=t,this.level=n,this.message=r||t.message,this.offset=i,this.length=s}getRule(){return this.rule}getLevel(){return this.level}getOffset(){return this.offset}getLength(){return this.length}getNode(){return this.node}getMessage(){return this.message}}),dt=class Vi{static entries(e){var t=new Vi;return e.acceptVisitor(t),t.entries}constructor(){this.entries=[]}visitNode(e){return e.isErroneous()&&e.collectIssues(this.entries),!0}};function x(...e){let n=e[0],t,r,i;if("string"==typeof n)t=n,r=n,e.splice(0,1),i=e&&"object"==typeof e[0]?e[0]:e;else{if(n instanceof Array){e=e.slice(1);if(n.length!==e.length+1)throw new Error("expected a string as the first argument to l10n.t");let t=n[0];for(let e=1;e<n.length;e++)t+=`{${e-1}}`+n[e];return x(t,...e)}r=n.message,t=r,n.comment&&0<n.comment.length&&(t+="/"+(Array.isArray(n.comment)?n.comment.join(""):n.comment)),i=n.args??{}}return pt(r,i)}var ht=/{([^}]+)}/g;function pt(e,n){return 0===Object.keys(n).length?e:e.replace(ht,(e,t)=>n[t]??e)}var mt,ut,ft,m,w,gt,bt,vt,wt,yt,S,xt,St,Ct,kt,Ft,Et,_t,It,f,zt,Dt,C,g,Rt,Tt,Mt,b,Nt,Ot,Pt,At,Wt,Lt,$t,Ut,Vt,jt,Bt,qt,k,e=class{constructor(e,t){this.id=e,this.message=t}},F={NumberExpected:new e("css-numberexpected",x("number expected")),ConditionExpected:new e("css-conditionexpected",x("condition expected")),RuleOrSelectorExpected:new e("css-ruleorselectorexpected",x("at-rule or selector expected")),DotExpected:new e("css-dotexpected",x("dot expected")),ColonExpected:new e("css-colonexpected",x("colon expected")),SemiColonExpected:new e("css-semicolonexpected",x("semi-colon expected")),TermExpected:new e("css-termexpected",x("term expected")),ExpressionExpected:new e("css-expressionexpected",x("expression expected")),OperatorExpected:new e("css-operatorexpected",x("operator expected")),IdentifierExpected:new e("css-identifierexpected",x("identifier expected")),PercentageExpected:new e("css-percentageexpected",x("percentage expected")),URIOrStringExpected:new e("css-uriorstringexpected",x("uri or string expected")),URIExpected:new e("css-uriexpected",x("URI expected")),VariableNameExpected:new e("css-varnameexpected",x("variable name expected")),VariableValueExpected:new e("css-varvalueexpected",x("variable value expected")),PropertyValueExpected:new e("css-propertyvalueexpected",x("property value expected")),LeftCurlyExpected:new e("css-lcurlyexpected",x("{ expected")),RightCurlyExpected:new e("css-rcurlyexpected",x("} expected")),LeftSquareBracketExpected:new e("css-rbracketexpected",x("[ expected")),RightSquareBracketExpected:new e("css-lbracketexpected",x("] expected")),LeftParenthesisExpected:new e("css-lparentexpected",x("( expected")),RightParenthesisExpected:new e("css-rparentexpected",x(") expected")),CommaExpected:new e("css-commaexpected",x("comma expected")),PageDirectiveOrDeclarationExpected:new e("css-pagedirordeclexpected",x("page directive or declaraton expected")),UnknownAtRule:new e("css-unknownatrule",x("at-rule unknown")),UnknownKeyword:new e("css-unknownkeyword",x("unknown keyword")),SelectorExpected:new e("css-selectorexpected",x("selector expected")),StringLiteralExpected:new e("css-stringliteralexpected",x("string literal expected")),WhitespaceExpected:new e("css-whitespaceexpected",x("whitespace expected")),MediaQueryExpected:new e("css-mediaqueryexpected",x("media query expected")),IdentifierOrWildcardExpected:new e("css-idorwildcardexpected",x("identifier or wildcard expected")),WildcardExpected:new e("css-wildcardexpected",x("wildcard expected")),IdentifierOrVariableExpected:new e("css-idorvarexpected",x("identifier or variable expected"))};(r||{}).is=function(e){return"string"==typeof e},(mt||(mt={})).is=function(e){return"string"==typeof e},(ft=ut=ut||{}).MIN_VALUE=0,ft.MAX_VALUE=2147483647,ft.is=function(e){return"number"==typeof e&&ft.MIN_VALUE<=e&&e<=ft.MAX_VALUE},(e=m=m||{}).create=function(e,t){return{line:e=e===Number.MAX_VALUE?ut.MAX_VALUE:e,character:t=t===Number.MAX_VALUE?ut.MAX_VALUE:t}},e.is=function(e){return k.objectLiteral(e)&&k.uinteger(e.line)&&k.uinteger(e.character)},(r=w=w||{}).create=function(e,t,n,r){if(k.uinteger(e)&&k.uinteger(t)&&k.uinteger(n)&&k.uinteger(r))return{start:m.create(e,t),end:m.create(n,r)};if(m.is(e)&&m.is(t))return{start:e,end:t};throw new Error(`Range#create called with invalid arguments[${e}, ${t}, ${n}, ${r}]`)},r.is=function(e){return k.objectLiteral(e)&&m.is(e.start)&&m.is(e.end)},(e=gt=gt||{}).create=function(e,t){return{uri:e,range:t}},e.is=function(e){return k.objectLiteral(e)&&w.is(e.range)&&(k.string(e.uri)||k.undefined(e.uri))},(r=M=M||{}).create=function(e,t,n,r){return{red:e,green:t,blue:n,alpha:r}},r.is=function(e){return k.objectLiteral(e)&&k.numberRange(e.red,0,1)&&k.numberRange(e.green,0,1)&&k.numberRange(e.blue,0,1)&&k.numberRange(e.alpha,0,1)},(e=bt=bt||{}).create=function(e,t){return{location:e,message:t}},e.is=function(e){return k.defined(e)&&gt.is(e.location)&&k.string(e.message)},(M=vt=vt||{}).Error=1,M.Warning=2,M.Information=3,M.Hint=4,(_||{}).is=function(e){return k.objectLiteral(e)&&k.string(e.href)},(r=wt=wt||{}).create=function(e,t,n,r,i,s){let a={range:e,message:t};return k.defined(n)&&(a.severity=n),k.defined(r)&&(a.code=r),k.defined(i)&&(a.source=i),k.defined(s)&&(a.relatedInformation=s),a},r.is=function(e){var t;return k.defined(e)&&w.is(e.range)&&k.string(e.message)&&(k.number(e.severity)||k.undefined(e.severity))&&(k.integer(e.code)||k.string(e.code)||k.undefined(e.code))&&(k.undefined(e.codeDescription)||k.string(null==(t=e.codeDescription)?void 0:t.href))&&(k.string(e.source)||k.undefined(e.source))&&(k.undefined(e.relatedInformation)||k.typedArray(e.relatedInformation,bt.is))},(e=yt=yt||{}).create=function(e,t,...n){let r={title:e,command:t};return k.defined(n)&&0<n.length&&(r.arguments=n),r},e.is=function(e){return k.defined(e)&&k.string(e.title)&&k.string(e.command)},(M=S=S||{}).replace=function(e,t){return{range:e,newText:t}},M.insert=function(e,t){return{range:{start:e,end:e},newText:t}},M.del=function(e){return{range:e,newText:""}},M.is=function(e){return k.objectLiteral(e)&&k.string(e.newText)&&w.is(e.range)},(_=t=t||{}).create=function(e,t,n){let r={label:e};return void 0!==t&&(r.needsConfirmation=t),void 0!==n&&(r.description=n),r},_.is=function(e){return k.objectLiteral(e)&&k.string(e.label)&&(k.boolean(e.needsConfirmation)||void 0===e.needsConfirmation)&&(k.string(e.description)||void 0===e.description)},(xt||(xt={})).is=function(e){return k.string(e)},(r=St=St||{}).create=function(e,t){return{textDocument:e,edits:t}},r.is=function(e){return k.defined(e)&&It.is(e.textDocument)&&Array.isArray(e.edits)},(e=Ct=Ct||{}).create=function(e,t,n){let r={kind:"create",uri:e};return void 0===t||void 0===t.overwrite&&void 0===t.ignoreIfExists||(r.options=t),void 0!==n&&(r.annotationId=n),r},e.is=function(e){return e&&"create"===e.kind&&k.string(e.uri)&&(void 0===e.options||(void 0===e.options.overwrite||k.boolean(e.options.overwrite))&&(void 0===e.options.ignoreIfExists||k.boolean(e.options.ignoreIfExists)))&&(void 0===e.annotationId||xt.is(e.annotationId))},(M=kt=kt||{}).create=function(e,t,n,r){let i={kind:"rename",oldUri:e,newUri:t};return void 0===n||void 0===n.overwrite&&void 0===n.ignoreIfExists||(i.options=n),void 0!==r&&(i.annotationId=r),i},M.is=function(e){return e&&"rename"===e.kind&&k.string(e.oldUri)&&k.string(e.newUri)&&(void 0===e.options||(void 0===e.options.overwrite||k.boolean(e.options.overwrite))&&(void 0===e.options.ignoreIfExists||k.boolean(e.options.ignoreIfExists)))&&(void 0===e.annotationId||xt.is(e.annotationId))},(t=Ft=Ft||{}).create=function(e,t,n){let r={kind:"delete",uri:e};return void 0===t||void 0===t.recursive&&void 0===t.ignoreIfNotExists||(r.options=t),void 0!==n&&(r.annotationId=n),r},t.is=function(e){return e&&"delete"===e.kind&&k.string(e.uri)&&(void 0===e.options||(void 0===e.options.recursive||k.boolean(e.options.recursive))&&(void 0===e.options.ignoreIfNotExists||k.boolean(e.options.ignoreIfNotExists)))&&(void 0===e.annotationId||xt.is(e.annotationId))},(Et||(Et={})).is=function(e){let t=e;return t&&(void 0!==t.changes||void 0!==t.documentChanges)&&(void 0===t.documentChanges||t.documentChanges.every(e=>k.string(e.kind)?Ct.is(e)||kt.is(e)||Ft.is(e):St.is(e)))},(_=_t=_t||{}).create=function(e,t){return{uri:e,version:t}},_.is=function(e){return k.defined(e)&&k.string(e.uri)&&k.integer(e.version)},(r=It=It||{}).create=function(e,t){return{uri:e,version:t}},r.is=function(e){return k.defined(e)&&k.string(e.uri)&&(null===e.version||k.integer(e.version))},(zt=f=f||{}).PlainText="plaintext",zt.Markdown="markdown",zt.is=function(e){return e===zt.PlainText||e===zt.Markdown},(Dt||(Dt={})).is=function(e){var t=e;return k.objectLiteral(e)&&f.is(t.kind)&&k.string(t.value)},(e=C=C||{}).Text=1,e.Method=2,e.Function=3,e.Constructor=4,e.Field=5,e.Variable=6,e.Class=7,e.Interface=8,e.Module=9,e.Property=10,e.Unit=11,e.Value=12,e.Enum=13,e.Keyword=14,e.Snippet=15,e.Color=16,e.File=17,e.Reference=18,e.Folder=19,e.EnumMember=20,e.Constant=21,e.Struct=22,e.Event=23,e.Operator=24,e.TypeParameter=25,(M=g=g||{}).PlainText=1,M.Snippet=2,(Rt=Rt||{}).Deprecated=1,(oi||{}).is=function(e){return e&&(k.string(e.detail)||void 0===e.detail)&&(k.string(e.description)||void 0===e.description)},(Pi||{}).create=function(e){return{label:e}},(Lt||{}).create=function(e,t){return{items:e||[],isIncomplete:!!t}},(t=Tt=Tt||{}).fromPlainText=function(e){return e.replace(/[\\`*_{}[\]()#+\-.!]/g,"\\$&")},t.is=function(e){return k.string(e)||k.objectLiteral(e)&&k.string(e.language)&&k.string(e.value)},(Gt||{}).is=function(e){var t=e;return!!t&&k.objectLiteral(t)&&(Dt.is(t.contents)||Tt.is(t.contents)||k.typedArray(t.contents,Tt.is))&&(void 0===e.range||w.is(e.range))},(Ht||{}).create=function(e,t){return t?{label:e,documentation:t}:{label:e}},(Gn||{}).create=function(e,t,...n){let r={label:e};return k.defined(t)&&(r.documentation=t),k.defined(n)?r.parameters=n:r.parameters=[],r},(_=Mt=Mt||{}).Text=1,_.Read=2,_.Write=3,(dr||{}).create=function(e,t){let n={range:e};return k.number(t)&&(n.kind=t),n},(r=b=b||{}).File=1,r.Module=2,r.Namespace=3,r.Package=4,r.Class=5,r.Method=6,r.Property=7,r.Field=8,r.Constructor=9,r.Enum=10,r.Interface=11,r.Function=12,r.Variable=13,r.Constant=14,r.String=15,r.Number=16,r.Boolean=17,r.Array=18,r.Object=19,r.Key=20,r.Null=21,r.EnumMember=22,r.Struct=23,r.Event=24,r.Operator=25,r.TypeParameter=26,(Ar||{}).create=function(e,t,n,r,i){let s={name:e,kind:t,location:{uri:r,range:n}};return i&&(s.containerName=i),s},(Wr||{}).create=function(e,t,n,r){return void 0!==r?{name:e,kind:t,location:{uri:n,range:r}}:{name:e,kind:t,location:{uri:n}}},(e=Nt=Nt||{}).Empty="",e.QuickFix="quickfix",e.Refactor="refactor",e.RefactorExtract="refactor.extract",e.RefactorInline="refactor.inline",e.RefactorRewrite="refactor.rewrite",e.Source="source",e.SourceOrganizeImports="source.organizeImports",e.SourceFixAll="source.fixAll",(M=D=D||{}).Invoked=1,M.Automatic=2,(oi=Ot=Ot||{}).create=function(e,t,n){let r={title:e},i=!0;return"string"==typeof t?(i=!1,r.kind=t):yt.is(t)?r.command=t:r.edit=t,i&&void 0!==n&&(r.kind=n),r},oi.is=function(e){return e&&k.string(e.title)&&(void 0===e.diagnostics||k.typedArray(e.diagnostics,wt.is))&&(void 0===e.kind||k.string(e.kind))&&(void 0!==e.edit||void 0!==e.command)&&(void 0===e.command||yt.is(e.command))&&(void 0===e.isPreferred||k.boolean(e.isPreferred))&&(void 0===e.edit||Et.is(e.edit))},(At=Pt=Pt||{}).create=function(e,t){return{range:e,parent:t}},At.is=function(e){return k.objectLiteral(e)&&w.is(e.range)&&(void 0===e.parent||At.is(e.parent))},(N||{}).is=function(e){return k.objectLiteral(e)&&(void 0===e.resultId||"string"==typeof e.resultId)&&Array.isArray(e.data)&&(0===e.data.length||"number"==typeof e.data[0])},(Pi=ui=ui||{}).Type=1,Pi.Parameter=2,Pi.is=function(e){return 1===e||2===e},(Lt=Wt=Wt||{}).create=function(e){return{value:e}},Lt.is=function(e){return k.objectLiteral(e)&&(void 0===e.tooltip||k.string(e.tooltip)||Dt.is(e.tooltip))&&(void 0===e.location||gt.is(e.location))&&(void 0===e.command||yt.is(e.command))},($t||{}).createSnippet=function(e){return{kind:"snippet",value:e}},(Ut||{}).create=function(e,t,n,r){return{insertText:e,filterText:t,range:n,command:r}},(Vt||{}).create=function(e){return{items:e}},(jt||{}).create=function(e,t){return{range:e,text:t}},(Bt||{}).create=function(e,t){return{triggerKind:e,selectedCompletionInfo:t}},(qt||{}).is=function(e){return k.objectLiteral(e)&&mt.is(e.uri)&&k.string(e.name)};{var t=k=k||{};let r=Object.prototype.toString;t.defined=function(e){return typeof e<"u"},t.undefined=function(e){return"u"<typeof e},t.boolean=function(e){return!0===e||!1===e},t.string=function(e){return"[object String]"===r.call(e)},t.number=function(e){return"[object Number]"===r.call(e)},t.numberRange=function(e,t,n){return"[object Number]"===r.call(e)&&t<=e&&e<=n},t.integer=function(e){return"[object Number]"===r.call(e)&&-2147483648<=e&&e<=2147483647},t.uinteger=function(e){return"[object Number]"===r.call(e)&&0<=e&&e<=2147483647},t.func=function(e){return"[object Function]"===r.call(e)},t.objectLiteral=function(e){return null!==e&&"object"==typeof e},t.typedArray=function(e,t){return Array.isArray(e)&&e.every(t)}}var Kt,Gt,Jt,Ht,Xt=class ji{constructor(e,t,n,r){this._uri=e,this._languageId=t,this._version=n,this._content=r,this._lineOffsets=void 0}get uri(){return this._uri}get languageId(){return this._languageId}get version(){return this._version}getText(e){var t;return e?(t=this.offsetAt(e.start),e=this.offsetAt(e.end),this._content.substring(t,e)):this._content}update(e,t){for(var s of e)if(ji.isIncremental(s)){var a=Qt(s.range),o=this.offsetAt(a.start),l=this.offsetAt(a.end);this._content=this._content.substring(0,o)+s.text+this._content.substring(l,this._content.length);let n=Math.max(a.start.line,0),e=Math.max(a.end.line,0),r=this._lineOffsets,i=Yt(s.text,!1,o);if(e-n===i.length)for(let e=0,t=i.length;e<t;e++)r[e+n+1]=i[e];else i.length<1e4?r.splice(n+1,e-n,...i):this._lineOffsets=r=r.slice(0,n+1).concat(i,r.slice(e+1));var c=s.text.length-(l-o);if(0!=c)for(let e=n+1+i.length,t=r.length;e<t;e++)r[e]=r[e]+c}else{if(!ji.isFull(s))throw new Error("Unknown change event received");this._content=s.text,this._lineOffsets=void 0}this._version=t}getLineOffsets(){return void 0===this._lineOffsets&&(this._lineOffsets=Yt(this._content,!0)),this._lineOffsets}positionAt(e){e=Math.max(Math.min(e,this._content.length),0);let t=this.getLineOffsets(),n=0,r=t.length;if(0===r)return{line:0,character:e};for(;n<r;){var i=Math.floor((n+r)/2);t[i]>e?r=i:n=i+1}var s=n-1;return{line:s,character:e-t[s]}}offsetAt(e){var t=this.getLineOffsets();if(e.line>=t.length)return this._content.length;if(e.line<0)return 0;var n=t[e.line],t=e.line+1<t.length?t[e.line+1]:this._content.length;return Math.max(Math.min(n+e.character,t),n)}get lineCount(){return this.getLineOffsets().length}static isIncremental(e){return null!=e&&"string"==typeof e.text&&void 0!==e.range&&(void 0===e.rangeLength||"number"==typeof e.rangeLength)}static isFull(e){return null!=e&&"string"==typeof e.text&&void 0===e.range&&void 0===e.rangeLength}};function Yt(t,e,n=0){let r=e?[n]:[];for(let e=0;e<t.length;e++){var i=t.charCodeAt(e);13!==i&&10!==i||(13===i&&e+1<t.length&&10===t.charCodeAt(e+1)&&e++,r.push(n+e+1))}return r}function Qt(e){var t=e.start,n=e.end;return t.line>n.line||t.line===n.line&&t.character>n.character?{start:n,end:t}:e}function Zt(e){var t=Qt(e.range);return t!==e.range?{newText:e.newText,range:t}:e}(Gt=Kt=Kt||{}).create=function(e,t,n,r){return new Xt(e,t,n,r)},Gt.update=function(e,t,n){if(e instanceof Xt)return e.update(t,n),e;throw new Error("TextDocument.update: document must be created by TextDocument.create")},Gt.applyEdits=function(e,t){let n=e.getText(),r=function e(t,n){if(t.length<=1)return t;let r=t.length/2|0,i=t.slice(0,r),s=t.slice(r);e(i,n),e(s,n);let a=0,o=0,l=0;for(;a<i.length&&o<s.length;)n(i[a],s[o])<=0?t[l++]=i[a++]:t[l++]=s[o++];for(;a<i.length;)t[l++]=i[a++];for(;o<s.length;)t[l++]=s[o++];return t}(t.map(Zt),(e,t)=>{var n=e.range.start.line-t.range.start.line;return 0==n?e.range.start.character-t.range.start.character:n}),i=0,s=[];for(var a of r){var o=e.offsetAt(a.range.start);if(o<i)throw new Error("Overlapping edit");o>i&&s.push(n.substring(i,o)),a.newText.length&&s.push(a.newText),i=e.offsetAt(a.range.end)}return s.push(n.substr(i)),s.join("")},f.Markdown,f.PlainText,f.Markdown,f.PlainText,(Ht=Jt=Jt||{})[Ht.Unknown=0]="Unknown",Ht[Ht.File=1]="File",Ht[Ht.Directory=2]="Directory",Ht[Ht.SymbolicLink=64]="SymbolicLink";var en={E:"Edge",FF:"Firefox",S:"Safari",C:"Chrome",IE:"IE",O:"Opera"};function tn(e){switch(e){case"experimental":return`⚠️ Property is experimental. Be cautious when using it.️
...
`;default:return""}}function nn(e,t,n){let r;if(""!==(r=t?{kind:"markdown",value:function(e,t){if(!e.description||""===e.description)return"";let n="";{var r;!1!==t?.documentation&&(e.status&&(n+=tn(e.status)),"string"==typeof e.description?n+=rn(e.description):n+=e.description.kind===f.Markdown?e.description.value:rn(e.description.value),(r=sn(e.browsers))&&(n+=`

(`+rn(r)+")"),"syntax"in e&&e.syntax&&(n+=`

Syntax: `+rn(e.syntax)))}return e.references&&0<e.references.length&&!1!==t?.references&&(0<n.length&&(n+=`

`),n+=e.references.map(e=>`[${e.name}](${e.url})`).join(" | ")),n}(e,n)}:{kind:"plaintext",value:function(e,t){if(!e.description||""===e.description)return"";if("string"!=typeof e.description)return e.description.value;let n="";{var r;!1!==t?.documentation&&(e.status&&(n+=tn(e.status)),n+=e.description,(r=sn(e.browsers))&&(n+=`
(`+r+")"),"syntax"in e&&(n+=`

Syntax: `+e.syntax))}return e.references&&0<e.references.length&&!1!==t?.references&&(0<n.length&&(n+=`

`),n+=e.references.map(e=>e.name+": "+e.url).join(" | ")),n}(e,n)}).value)return r}function rn(e){return(e=e.replace(/[\\`*_{}[\]()#+\-.!]/g,"\\$&")).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function sn(e=[]){return 0===e.length?null:e.map(e=>{let t="",n=e.match(/([A-Z]+)(\d+)?/),r=n[1],i=n[2];return r in en&&(t+=en[r]),i&&(t+=" "+i),t}).join(", ")}var an=/(^#([0-9A-F]{3}){1,2}$)|(^#([0-9A-F]{4}){1,2}$)/i,on=[{label:"rgb",func:"rgb($red, $green, $blue)",insertText:"rgb(${1:red}, ${2:green}, ${3:blue})",desc:x("Creates a Color from red, green, and blue values.")},{label:"rgba",func:"rgba($red, $green, $blue, $alpha)",insertText:"rgba(${1:red}, ${2:green}, ${3:blue}, ${4:alpha})",desc:x("Creates a Color from red, green, blue, and alpha values.")},{label:"rgb relative",func:"rgb(from $color $red $green $blue)",insertText:"rgb(from ${1:color} ${2:r} ${3:g} ${4:b})",desc:x("Creates a Color from the red, green, and blue values of another Color.")},{label:"hsl",func:"hsl($hue, $saturation, $lightness)",insertText:"hsl(${1:hue}, ${2:saturation}, ${3:lightness})",desc:x("Creates a Color from hue, saturation, and lightness values.")},{label:"hsla",func:"hsla($hue, $saturation, $lightness, $alpha)",insertText:"hsla(${1:hue}, ${2:saturation}, ${3:lightness}, ${4:alpha})",desc:x("Creates a Color from hue, saturation, lightness, and alpha values.")},{label:"hsl relative",func:"hsl(from $color $hue $saturation $lightness)",insertText:"hsl(from ${1:color} ${2:h} ${3:s} ${4:l})",desc:x("Creates a Color from the hue, saturation, and lightness values of another Color.")},{label:"hwb",func:"hwb($hue $white $black)",insertText:"hwb(${1:hue} ${2:white} ${3:black})",desc:x("Creates a Color from hue, white, and black values.")},{label:"hwb relative",func:"hwb(from $color $hue $white $black)",insertText:"hwb(from ${1:color} ${2:h} ${3:w} ${4:b})",desc:x("Creates a Color from the hue, white, and black values of another Color.")},{label:"lab",func:"lab($lightness $a $b)",insertText:"lab(${1:lightness} ${2:a} ${3:b})",desc:x("Creates a Color from lightness, a, and b values.")},{label:"lab relative",func:"lab(from $color $lightness $a $b)",insertText:"lab(from ${1:color} ${2:l} ${3:a} ${4:b})",desc:x("Creates a Color from the lightness, a, and b values of another Color.")},{label:"oklab",func:"oklab($lightness $a $b)",insertText:"oklab(${1:lightness} ${2:a} ${3:b})",desc:x("Creates a Color from lightness, a, and b values.")},{label:"oklab relative",func:"oklab(from $color $lightness $a $b)",insertText:"oklab(from ${1:color} ${2:l} ${3:a} ${4:b})",desc:x("Creates a Color from the lightness, a, and b values of another Color.")},{label:"lch",func:"lch($lightness $chroma $hue)",insertText:"lch(${1:lightness} ${2:chroma} ${3:hue})",desc:x("Creates a Color from lightness, chroma, and hue values.")},{label:"lch relative",func:"lch(from $color $lightness $chroma $hue)",insertText:"lch(from ${1:color} ${2:l} ${3:c} ${4:h})",desc:x("Creates a Color from the lightness, chroma, and hue values of another Color.")},{label:"oklch",func:"oklch($lightness $chroma $hue)",insertText:"oklch(${1:lightness} ${2:chroma} ${3:hue})",desc:x("Creates a Color from lightness, chroma, and hue values.")},{label:"oklch relative",func:"oklch(from $color $lightness $chroma $hue)",insertText:"oklch(from ${1:color} ${2:l} ${3:c} ${4:h})",desc:x("Creates a Color from the lightness, chroma, and hue values of another Color.")},{label:"color",func:"color($color-space $red $green $blue)",insertText:"color(${1|srgb,srgb-linear,display-p3,a98-rgb,prophoto-rgb,rec2020,xyx,xyz-d50,xyz-d65|} ${2:red} ${3:green} ${4:blue})",desc:x("Creates a Color in a specific color space from red, green, and blue values.")},{label:"color relative",func:"color(from $color $color-space $red $green $blue)",insertText:"color(from ${1:color} ${2|srgb,srgb-linear,display-p3,a98-rgb,prophoto-rgb,rec2020,xyx,xyz-d50,xyz-d65|} ${3:r} ${4:g} ${5:b})",desc:x("Creates a Color in a specific color space from the red, green, and blue values of another Color.")},{label:"color-mix",func:"color-mix(in $color-space, $color $percentage, $color $percentage)",insertText:"color-mix(in ${1|srgb,srgb-linear,lab,oklab,xyz,xyz-d50,xyz-d65|}, ${3:color} ${4:percentage}, ${5:color} ${6:percentage})",desc:x("Mix two colors together in a rectangular color space.")},{label:"color-mix hue",func:"color-mix(in $color-space $interpolation-method hue, $color $percentage, $color $percentage)",insertText:"color-mix(in ${1|hsl,hwb,lch,oklch|} ${2|shorter hue,longer hue,increasing hue,decreasing hue|}, ${3:color} ${4:percentage}, ${5:color} ${6:percentage})",desc:x("Mix two colors together in a polar color space.")}],ln=/^(rgb|rgba|hsl|hsla|hwb)$/i,cn={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgrey:"#a9a9a9",darkgreen:"#006400",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",gold:"#ffd700",goldenrod:"#daa520",gray:"#808080",grey:"#808080",green:"#008000",greenyellow:"#adff2f",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavender:"#e6e6fa",lavenderblush:"#fff0f5",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgrey:"#d3d3d3",lightgreen:"#90ee90",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370d8",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#d87093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",red:"#ff0000",rebeccapurple:"#663399",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"},dn=new RegExp(`^(${Object.keys(cn).join("|")})$`,"i"),hn={currentColor:"The value of the 'color' property. The computed value of the 'currentColor' keyword is the computed value of the 'color' property. If the 'currentColor' keyword is set on the 'color' property itself, it is treated as 'color:inherit' at parse time.",transparent:"Fully transparent. This keyword can be considered a shorthand for rgba(0,0,0,0) which is its computed value."},pn=new RegExp(`^(${Object.keys(hn).join("|")})$`,"i");function mn(e,t){e=e.getText().match(/^([-+]?[0-9]*\.?[0-9]+)(%?)$/);if(e){e[2]&&(t=100);e=parseFloat(e[1])/t;if(0<=e&&e<=1)return e}throw new Error}function un(e){let t=e.getText(),n=t.match(/^([-+]?[0-9]*\.?[0-9]+)(deg|rad|grad|turn)?$/);if(n)switch(n[2]){case"deg":return parseFloat(t)%360;case"rad":return 180*parseFloat(t)/Math.PI%360;case"grad":return.9*parseFloat(t)%360;case"turn":return 360*parseFloat(t)%360;default:if("u"<typeof n[2])return parseFloat(t)%360}throw new Error}function fn(e){return an.test(e)||dn.test(e)||pn.test(e)}function n(e){return e<48?0:e<=57?e-48:(e<97&&(e+=32),97<=e&&e<=102?e-97+10:0)}function gn(e){if("#"!==e[0])return null;switch(e.length){case 4:return{red:17*n(e.charCodeAt(1))/255,green:17*n(e.charCodeAt(2))/255,blue:17*n(e.charCodeAt(3))/255,alpha:1};case 5:return{red:17*n(e.charCodeAt(1))/255,green:17*n(e.charCodeAt(2))/255,blue:17*n(e.charCodeAt(3))/255,alpha:17*n(e.charCodeAt(4))/255};case 7:return{red:(16*n(e.charCodeAt(1))+n(e.charCodeAt(2)))/255,green:(16*n(e.charCodeAt(3))+n(e.charCodeAt(4)))/255,blue:(16*n(e.charCodeAt(5))+n(e.charCodeAt(6)))/255,alpha:1};case 9:return{red:(16*n(e.charCodeAt(1))+n(e.charCodeAt(2)))/255,green:(16*n(e.charCodeAt(3))+n(e.charCodeAt(4)))/255,blue:(16*n(e.charCodeAt(5))+n(e.charCodeAt(6)))/255,alpha:(16*n(e.charCodeAt(7))+n(e.charCodeAt(8)))/255}}return null}function bn(e,t,n,r=1){if(0===t)return{red:n,green:n,blue:n,alpha:r};var i=(e,t,n)=>{for(;n<0;)n+=6;for(;6<=n;)n-=6;return n<1?(t-e)*n+e:n<3?t:n<4?(t-e)*(4-n)+e:e},t=n<=.5?n*(t+1):n+t-n*t,n=2*n-t;return{red:i(n,t,(e/=60)+2),green:i(n,t,e),blue:i(n,t,e-2),alpha:r}}function vn(e){let t=e.red,n=e.green,r=e.blue,i=e.alpha,s=Math.max(t,n,r),a=Math.min(t,n,r),o=0,l=0,c=(a+s)/2,d=s-a;if(0<d){switch(l=Math.min(c<=.5?d/(2*c):d/(2-2*c),1),s){case t:o=(n-r)/d+(n<r?6:0);break;case n:o=(r-t)/d+2;break;case r:o=(t-n)/d+4}o*=60,o=Math.round(o)}return{h:o,s:l,l:c,a:i}}function wn(n){if(n.type===u.HexColorValue)return gn(n.getText());if(n.type===u.Function){let e=n,t=e.getName(),i=e.getArguments().getChildren();if(1===i.length){let e=i[0].getChildren();if(1===e.length&&e[0].type===u.Expression&&3===(i=e[0].getChildren()).length){let r=i[2];if(r instanceof Be){let e=r.getLeft(),t=r.getRight(),n=r.getOperator();e&&t&&n&&n.matches("/")&&(i=[i[0],i[1],e,t])}}}if(!t||i.length<3||4<i.length)return null;try{var r=4===i.length?mn(i[3],1):1;if("rgb"===t||"rgba"===t)return{red:mn(i[0],255),green:mn(i[1],255),blue:mn(i[2],255),alpha:r};if("hsl"===t||"hsla"===t)return bn(un(i[0]),mn(i[1],100),mn(i[2],100),r);if("hwb"===t){var s=un(i[0]),a=mn(i[1],100),o=mn(i[2],100),[l,c,d,h=1]=[s,a,o,r];if(1<=c+d)return{red:m=c/(c+d),green:m,blue:m,alpha:h};var l=(m=bn(l,1,.5,h)).red,p=m.green,m=m.blue;return{red:l*(1-c-d)+c,green:p*(1-c-d)+c,blue:m*(1-c-d)+c,alpha:h}}}catch{return null}}else if(n.type===u.Identifier){if(n.parent&&n.parent.type!==u.Term)return null;s=n.parent;if(s&&s.parent&&s.parent.type===u.BinaryExpression){a=s.parent;if(a.parent&&a.parent.type===u.ListEntry&&a.parent.key===a)return null}o=n.getText().toLowerCase();if("none"===o)return null;r=cn[o];if(r)return gn(r)}return null}var yn={bottom:"Computes to ‘100%’ for the vertical position if one or two values are given, otherwise specifies the bottom edge as the origin for the next offset.",center:"Computes to ‘50%’ (‘left 50%’) for the horizontal position if the horizontal position is not otherwise specified, or ‘50%’ (‘top 50%’) for the vertical position if it is.",left:"Computes to ‘0%’ for the horizontal position if one or two values are given, otherwise specifies the left edge as the origin for the next offset.",right:"Computes to ‘100%’ for the horizontal position if one or two values are given, otherwise specifies the right edge as the origin for the next offset.",top:"Computes to ‘0%’ for the vertical position if one or two values are given, otherwise specifies the top edge as the origin for the next offset."},xn={"no-repeat":"Placed once and not repeated in this direction.",repeat:"Repeated in this direction as often as needed to cover the background painting area.","repeat-x":"Computes to ‘repeat no-repeat’.","repeat-y":"Computes to ‘no-repeat repeat’.",round:"Repeated as often as will fit within the background positioning area. If it doesn’t fit a whole number of times, it is rescaled so that it does.",space:"Repeated as often as will fit within the background positioning area without being clipped and then the images are spaced out to fill the area."},Sn={dashed:"A series of square-ended dashes.",dotted:"A series of round dots.",double:"Two parallel solid lines with some space between them.",groove:"Looks as if it were carved in the canvas.",hidden:"Same as ‘none’, but has different behavior in the border conflict resolution rules for border-collapsed tables.",inset:"Looks as if the content on the inside of the border is sunken into the canvas.",none:"No border. Color and width are ignored.",outset:"Looks as if the content on the inside of the border is coming out of the canvas.",ridge:"Looks as if it were coming out of the canvas.",solid:"A single line segment."},Cn=["medium","thick","thin"],kn={"border-box":"The background is painted within (clipped to) the border box.","content-box":"The background is painted within (clipped to) the content box.","padding-box":"The background is painted within (clipped to) the padding box."},Fn={"margin-box":"Uses the margin box as reference box.","fill-box":"Uses the object bounding box as reference box.","stroke-box":"Uses the stroke bounding box as reference box.","view-box":"Uses the nearest SVG viewport as reference box."},En={initial:"Represents the value specified as the property’s initial value.",inherit:"Represents the computed value of the property on the element’s parent.",unset:"Acts as either `inherit` or `initial`, depending on whether the property is inherited or not."},_n={"var()":"Evaluates the value of a custom variable.","calc()":"Evaluates an mathematical expression. The following operators can be used: + - * /."},In={"url()":"Reference an image file by URL","image()":"Provide image fallbacks and annotations.","-webkit-image-set()":"Provide multiple resolutions. Remember to use unprefixed image-set() in addition.","image-set()":"Provide multiple resolutions of an image and const the UA decide which is most appropriate in a given situation.","-moz-element()":"Use an element in the document as an image. Remember to use unprefixed element() in addition.","element()":"Use an element in the document as an image.","cross-fade()":"Indicates the two images to be combined and how far along in the transition the combination is.","-webkit-gradient()":"Deprecated. Use modern linear-gradient() or radial-gradient() instead.","-webkit-linear-gradient()":"Linear gradient. Remember to use unprefixed version in addition.","-moz-linear-gradient()":"Linear gradient. Remember to use unprefixed version in addition.","-o-linear-gradient()":"Linear gradient. Remember to use unprefixed version in addition.","linear-gradient()":"A linear gradient is created by specifying a straight gradient line, and then several colors placed along that line.","-webkit-repeating-linear-gradient()":"Repeating Linear gradient. Remember to use unprefixed version in addition.","-moz-repeating-linear-gradient()":"Repeating Linear gradient. Remember to use unprefixed version in addition.","-o-repeating-linear-gradient()":"Repeating Linear gradient. Remember to use unprefixed version in addition.","repeating-linear-gradient()":"Same as linear-gradient, except the color-stops are repeated infinitely in both directions, with their positions shifted by multiples of the difference between the last specified color-stop’s position and the first specified color-stop’s position.","-webkit-radial-gradient()":"Radial gradient. Remember to use unprefixed version in addition.","-moz-radial-gradient()":"Radial gradient. Remember to use unprefixed version in addition.","radial-gradient()":"Colors emerge from a single point and smoothly spread outward in a circular or elliptical shape.","-webkit-repeating-radial-gradient()":"Repeating radial gradient. Remember to use unprefixed version in addition.","-moz-repeating-radial-gradient()":"Repeating radial gradient. Remember to use unprefixed version in addition.","repeating-radial-gradient()":"Same as radial-gradient, except the color-stops are repeated infinitely in both directions, with their positions shifted by multiples of the difference between the last specified color-stop’s position and the first specified color-stop’s position."},zn={ease:"Equivalent to cubic-bezier(0.25, 0.1, 0.25, 1.0).","ease-in":"Equivalent to cubic-bezier(0.42, 0, 1.0, 1.0).","ease-in-out":"Equivalent to cubic-bezier(0.42, 0, 0.58, 1.0).","ease-out":"Equivalent to cubic-bezier(0, 0, 0.58, 1.0).",linear:"Equivalent to cubic-bezier(0.0, 0.0, 1.0, 1.0).","step-end":"Equivalent to steps(1, end).","step-start":"Equivalent to steps(1, start).","steps()":"The first parameter specifies the number of intervals in the function. The second parameter, which is optional, is either the value “start” or “end”.","cubic-bezier()":"Specifies a cubic-bezier curve. The four values specify points P1 and P2  of the curve as (x1, y1, x2, y2).","cubic-bezier(0.6, -0.28, 0.735, 0.045)":"Ease-in Back. Overshoots.","cubic-bezier(0.68, -0.55, 0.265, 1.55)":"Ease-in-out Back. Overshoots.","cubic-bezier(0.175, 0.885, 0.32, 1.275)":"Ease-out Back. Overshoots.","cubic-bezier(0.6, 0.04, 0.98, 0.335)":"Ease-in Circular. Based on half circle.","cubic-bezier(0.785, 0.135, 0.15, 0.86)":"Ease-in-out Circular. Based on half circle.","cubic-bezier(0.075, 0.82, 0.165, 1)":"Ease-out Circular. Based on half circle.","cubic-bezier(0.55, 0.055, 0.675, 0.19)":"Ease-in Cubic. Based on power of three.","cubic-bezier(0.645, 0.045, 0.355, 1)":"Ease-in-out Cubic. Based on power of three.","cubic-bezier(0.215, 0.610, 0.355, 1)":"Ease-out Cubic. Based on power of three.","cubic-bezier(0.95, 0.05, 0.795, 0.035)":"Ease-in Exponential. Based on two to the power ten.","cubic-bezier(1, 0, 0, 1)":"Ease-in-out Exponential. Based on two to the power ten.","cubic-bezier(0.19, 1, 0.22, 1)":"Ease-out Exponential. Based on two to the power ten.","cubic-bezier(0.47, 0, 0.745, 0.715)":"Ease-in Sine.","cubic-bezier(0.445, 0.05, 0.55, 0.95)":"Ease-in-out Sine.","cubic-bezier(0.39, 0.575, 0.565, 1)":"Ease-out Sine.","cubic-bezier(0.55, 0.085, 0.68, 0.53)":"Ease-in Quadratic. Based on power of two.","cubic-bezier(0.455, 0.03, 0.515, 0.955)":"Ease-in-out Quadratic. Based on power of two.","cubic-bezier(0.25, 0.46, 0.45, 0.94)":"Ease-out Quadratic. Based on power of two.","cubic-bezier(0.895, 0.03, 0.685, 0.22)":"Ease-in Quartic. Based on power of four.","cubic-bezier(0.77, 0, 0.175, 1)":"Ease-in-out Quartic. Based on power of four.","cubic-bezier(0.165, 0.84, 0.44, 1)":"Ease-out Quartic. Based on power of four.","cubic-bezier(0.755, 0.05, 0.855, 0.06)":"Ease-in Quintic. Based on power of five.","cubic-bezier(0.86, 0, 0.07, 1)":"Ease-in-out Quintic. Based on power of five.","cubic-bezier(0.23, 1, 0.320, 1)":"Ease-out Quintic. Based on power of five."},Dn={"circle()":"Defines a circle.","ellipse()":"Defines an ellipse.","inset()":"Defines an inset rectangle.","polygon()":"Defines a polygon."},Rn={length:["cap","ch","cm","cqb","cqh","cqi","cqmax","cqmin","cqw","dvb","dvh","dvi","dvw","em","ex","ic","in","lh","lvb","lvh","lvi","lvw","mm","pc","pt","px","q","rcap","rch","rem","rex","ric","rlh","svb","svh","svi","svw","vb","vh","vi","vmax","vmin","vw"],angle:["deg","rad","grad","turn"],time:["ms","s"],frequency:["Hz","kHz"],resolution:["dpi","dpcm","dppx"],percentage:["%","fr"]},Tn=["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rb","rp","rt","rtc","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","title","tr","track","u","ul","const","video","wbr"],Mn=["circle","clipPath","cursor","defs","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","filter","foreignObject","g","hatch","hatchpath","image","line","linearGradient","marker","mask","mesh","meshpatch","meshrow","metadata","mpath","path","pattern","polygon","polyline","radialGradient","rect","set","solidcolor","stop","svg","switch","symbol","text","textPath","tspan","use","view"],Nn=["@bottom-center","@bottom-left","@bottom-left-corner","@bottom-right","@bottom-right-corner","@left-bottom","@left-middle","@left-top","@right-bottom","@right-middle","@right-top","@top-center","@top-left","@top-left-corner","@top-right","@top-right-corner"];function On(t){return Object.keys(t).map(e=>t[e])}function E(e){return typeof e<"u"}var Pn=class{constructor(e=new J){this.keyframeRegex=/^@(\-(webkit|ms|moz|o)\-)?keyframes$/i,this.scanner=e,this.token={type:d.EOF,offset:-1,len:0,text:""},this.prevToken=void 0}peekIdent(e){return d.Ident===this.token.type&&e.length===this.token.text.length&&e===this.token.text.toLowerCase()}peekKeyword(e){return d.AtKeyword===this.token.type&&e.length===this.token.text.length&&e===this.token.text.toLowerCase()}peekDelim(e){return d.Delim===this.token.type&&e===this.token.text}peek(e){return e===this.token.type}peekOne(...e){return-1!==e.indexOf(this.token.type)}peekRegExp(e,t){return e===this.token.type&&t.test(this.token.text)}hasWhitespace(){return!!this.prevToken&&this.prevToken.offset+this.prevToken.len!==this.token.offset}consumeToken(){this.prevToken=this.token,this.token=this.scanner.scan()}acceptUnicodeRange(){var e=this.scanner.tryScanUnicode();return!!e&&(this.prevToken=e,this.token=this.scanner.scan(),!0)}mark(){return{prev:this.prevToken,curr:this.token,pos:this.scanner.pos()}}restoreAtMark(e){this.prevToken=e.prev,this.token=e.curr,this.scanner.goBackTo(e.pos)}try(e){var t=this.mark();return e()||(this.restoreAtMark(t),null)}acceptOneKeyword(e){if(d.AtKeyword===this.token.type)for(var t of e)if(t.length===this.token.text.length&&t===this.token.text.toLowerCase())return this.consumeToken(),!0;return!1}accept(e){return e===this.token.type&&(this.consumeToken(),!0)}acceptIdent(e){return!!this.peekIdent(e)&&(this.consumeToken(),!0)}acceptKeyword(e){return!!this.peekKeyword(e)&&(this.consumeToken(),!0)}acceptDelim(e){return!!this.peekDelim(e)&&(this.consumeToken(),!0)}acceptRegexp(e){return!!e.test(this.token.text)&&(this.consumeToken(),!0)}_parseRegexp(e){for(var t=this.createNode(u.Identifier);this.acceptRegexp(e););return this.finish(t)}acceptUnquotedString(){var e=this.scanner.pos(),t=(this.scanner.goBackTo(this.token.offset),this.scanner.scanUnquotedString());return t?(this.token=t,this.consumeToken(),!0):(this.scanner.goBackTo(e),!1)}resync(e,t){for(;;){if(e&&-1!==e.indexOf(this.token.type))return this.consumeToken(),!0;if(t&&-1!==t.indexOf(this.token.type))return!0;if(this.token.type===d.EOF)return!1;this.token=this.scanner.scan()}}createNode(e){return new p(this.token.offset,this.token.len,e)}create(e){return new e(this.token.offset,this.token.len)}finish(e,t,n,r){return e instanceof l||(t&&this.markError(e,t,n,r),!this.prevToken)||(t=this.prevToken.offset+this.prevToken.len,e.length=t>e.offset?t-e.offset:0),e}markError(e,t,n,r){this.token!==this.lastErrorToken&&(e.addIssue(new ct(e,t,a.Error,void 0,this.token.offset,this.token.len)),this.lastErrorToken=this.token),(n||r)&&this.resync(n,r)}parseStylesheet(n){let r=n.version,i=n.getText();return this.internalParse(i,this._parseStylesheet,(e,t)=>{if(n.version!==r)throw new Error("Underlying model has changed, AST is no longer valid");return i.substr(e,t)})}internalParse(n,e,t){this.scanner.setSource(n),this.token=this.scanner.scan();let r=e.bind(this)();return r&&(r.textProvider=t||((e,t)=>n.substr(e,t))),r}_parseStylesheet(){let t=this.create(te);for(;t.addChild(this._parseStylesheetStart()););let n=!1;do{let e=!1;do{e=!1;var r=this._parseStylesheetStatement();for(r&&(t.addChild(r),e=!0,n=!1,this.peek(d.EOF)||!this._needsSemicolonAfter(r)||this.accept(d.SemiColon)||this.markError(t,F.SemiColonExpected));this.accept(d.SemiColon)||this.accept(d.CDO)||this.accept(d.CDC);)e=!0,n=!1}while(e)}while(!this.peek(d.EOF)&&(n||(this.peek(d.AtKeyword)?this.markError(t,F.UnknownAtRule):this.markError(t,F.RuleOrSelectorExpected),n=!0),this.consumeToken(),!this.peek(d.EOF)));return this.finish(t)}_parseStylesheetStart(){return this._parseCharset()}_parseStylesheetStatement(e=!1){return this.peek(d.AtKeyword)?this._parseStylesheetAtStatement(e):this._parseRuleset(e)}_parseStylesheetAtStatement(e=!1){return this._parseImport()||this._parseMedia(e)||this._parsePage()||this._parseFontFace()||this._parseKeyframe()||this._parseSupports(e)||this._parseLayer(e)||this._parsePropertyAtRule()||this._parseViewPort()||this._parseNamespace()||this._parseDocument()||this._parseContainer(e)||this._parseUnknownAtRule()}_tryParseRuleset(e){var t=this.mark();if(this._parseSelector(e)){for(;this.accept(d.Comma)&&this._parseSelector(e););if(this.accept(d.CurlyL))return this.restoreAtMark(t),this._parseRuleset(e)}return this.restoreAtMark(t),null}_parseRuleset(e=!1){let t=this.create(re),n=t.getSelectors();if(!n.addChild(this._parseSelector(e)))return null;for(;this.accept(d.Comma);)if(!n.addChild(this._parseSelector(e)))return this.finish(t,F.SelectorExpected);return this._parseBody(t,this._parseRuleSetDeclaration.bind(this))}_parseRuleSetDeclarationAtStatement(){return this._parseMedia(!0)||this._parseSupports(!0)||this._parseLayer(!0)||this._parseContainer(!0)||this._parseUnknownAtRule()}_parseRuleSetDeclaration(){return this.peek(d.AtKeyword)?this._parseRuleSetDeclarationAtStatement():this.peek(d.Ident)?this._tryParseRuleset(!0)||this._parseDeclaration():this._parseRuleset(!0)}_needsSemicolonAfter(e){switch(e.type){case u.Keyframe:case u.ViewPort:case u.Media:case u.Ruleset:case u.Namespace:case u.If:case u.For:case u.Each:case u.While:case u.MixinDeclaration:case u.FunctionDeclaration:case u.MixinContentDeclaration:return!1;case u.ExtendsReference:case u.MixinContentReference:case u.ReturnStatement:case u.MediaQuery:case u.Debug:case u.Import:case u.AtApplyRule:case u.CustomPropertyDeclaration:return!0;case u.VariableDeclaration:return e.needsSemicolon;case u.MixinReference:return!e.getContent();case u.Declaration:return!e.getNestedProperties()}return!1}_parseDeclarations(e){let t=this.create(ne);if(!this.accept(d.CurlyL))return null;let n=e();for(;t.addChild(n)&&!this.peek(d.CurlyR);){if(this._needsSemicolonAfter(n)&&!this.accept(d.SemiColon))return this.finish(t,F.SemiColonExpected,[d.SemiColon,d.CurlyR]);for(n&&this.prevToken&&this.prevToken.type===d.SemiColon&&(n.semicolonPosition=this.prevToken.offset);this.accept(d.SemiColon););n=e()}return this.accept(d.CurlyR)?this.finish(t):this.finish(t,F.RightCurlyExpected,[d.CurlyR,d.SemiColon])}_parseBody(e,t){return e.setDeclarations(this._parseDeclarations(t))?this.finish(e):this.finish(e,F.LeftCurlyExpected,[d.CurlyR,d.SemiColon])}_parseSelector(e){let t=this.create(ie),n=!1;for(e&&(n=t.addChild(this._parseCombinator()));t.addChild(this._parseSimpleSelector());)n=!0,t.addChild(this._parseCombinator());return n?this.finish(t):null}_parseDeclaration(e){var t=this._tryParseCustomPropertyDeclaration(e);if(t)return t;let n=this.create(y);return n.setProperty(this._parseProperty())?this.accept(d.Colon)?(this.prevToken&&(n.colonPosition=this.prevToken.offset),n.setValue(this._parseExpr())?(n.addChild(this._parsePrio()),this.peek(d.SemiColon)&&(n.semicolonPosition=this.token.offset),this.finish(n)):this.finish(n,F.PropertyValueExpected)):this.finish(n,F.ColonExpected,[d.Colon],e||[d.SemiColon]):null}_tryParseCustomPropertyDeclaration(e){if(!this.peekRegExp(d.Ident,/^--/))return null;let n=this.create(le);if(!n.setProperty(this._parseProperty()))return null;if(!this.accept(d.Colon))return this.finish(n,F.ColonExpected,[d.Colon]);this.prevToken&&(n.colonPosition=this.prevToken.offset);var r=this.mark();if(this.peek(d.CurlyL)){let e=this.create(oe),t=this._parseDeclarations(this._parseRuleSetDeclaration.bind(this));if(e.setDeclarations(t)&&!t.isErroneous(!0)&&(e.addChild(this._parsePrio()),this.peek(d.SemiColon)))return this.finish(e),n.setPropertySet(e),n.semicolonPosition=this.token.offset,this.finish(n);this.restoreAtMark(r)}let t=this._parseExpr();return t&&!t.isErroneous(!0)&&(this._parsePrio(),this.peekOne(...e||[],d.SemiColon,d.EOF))?(n.setValue(t),this.peek(d.SemiColon)&&(n.semicolonPosition=this.token.offset),this.finish(n)):(this.restoreAtMark(r),n.addChild(this._parseCustomPropertyValue(e)),n.addChild(this._parsePrio()),E(n.colonPosition)&&this.token.offset===n.colonPosition+1?this.finish(n,F.PropertyValueExpected):this.finish(n))}_parseCustomPropertyValue(e=[d.CurlyR]){let t=this.create(p),n=()=>0===i&&0===s&&0===a,r=()=>-1!==e.indexOf(this.token.type),i=0,s=0,a=0;e:for(;;){switch(this.token.type){case d.SemiColon:case d.Exclamation:if(n())break e;break;case d.CurlyL:i++;break;case d.CurlyR:if(--i<0){if(r()&&0===s&&0===a)break e;return this.finish(t,F.LeftCurlyExpected)}break;case d.ParenthesisL:s++;break;case d.ParenthesisR:if(--s<0){if(r()&&0===a&&0===i)break e;return this.finish(t,F.LeftParenthesisExpected)}break;case d.BracketL:a++;break;case d.BracketR:if(--a<0)return this.finish(t,F.LeftSquareBracketExpected);break;case d.BadString:break e;case d.EOF:let e=F.RightCurlyExpected;return 0<a?e=F.RightSquareBracketExpected:0<s&&(e=F.RightParenthesisExpected),this.finish(t,e)}this.consumeToken()}return this.finish(t)}_tryToParseDeclaration(e){var t=this.mark();return this._parseProperty()&&this.accept(d.Colon)?(this.restoreAtMark(t),this._parseDeclaration(e)):(this.restoreAtMark(t),null)}_parseProperty(){let e=this.create(ce),t=this.mark();return(this.acceptDelim("*")||this.acceptDelim("_"))&&this.hasWhitespace()?(this.restoreAtMark(t),null):e.setIdentifier(this._parsePropertyIdentifier())?this.finish(e):null}_parsePropertyIdentifier(){return this._parseIdent()}_parseCharset(){if(!this.peek(d.Charset))return null;var e=this.create(p);return this.consumeToken(),this.accept(d.String)?this.accept(d.SemiColon)?this.finish(e):this.finish(e,F.SemiColonExpected):this.finish(e,F.IdentifierExpected)}_parseImport(){if(!this.peekKeyword("@import"))return null;let e=this.create(ke);return this.consumeToken(),e.addChild(this._parseURILiteral())||e.addChild(this._parseStringLiteral())?this._completeParseImport(e):this.finish(e,F.URIOrStringExpected)}_completeParseImport(e){if(this.acceptIdent("layer")&&this.accept(d.ParenthesisL)){if(!e.addChild(this._parseLayerName()))return this.finish(e,F.IdentifierExpected,[d.SemiColon]);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[d.ParenthesisR],[])}return this.acceptIdent("supports")&&this.accept(d.ParenthesisL)&&(e.addChild(this._tryToParseDeclaration()||this._parseSupportsCondition()),!this.accept(d.ParenthesisR))?this.finish(e,F.RightParenthesisExpected,[d.ParenthesisR],[]):(this.peek(d.SemiColon)||this.peek(d.EOF)||e.setMedialist(this._parseMediaQueryList()),this.finish(e))}_parseNamespace(){if(!this.peekKeyword("@namespace"))return null;let e=this.create(ze);return this.consumeToken(),e.addChild(this._parseURILiteral())||(e.addChild(this._parseIdent()),e.addChild(this._parseURILiteral())||e.addChild(this._parseStringLiteral()))?this.accept(d.SemiColon)?this.finish(e):this.finish(e,F.SemiColonExpected):this.finish(e,F.URIExpected,[d.SemiColon])}_parseFontFace(){if(!this.peekKeyword("@font-face"))return null;var e=this.create(ye);return this.consumeToken(),this._parseBody(e,this._parseRuleSetDeclaration.bind(this))}_parseViewPort(){if(!this.peekKeyword("@-ms-viewport")&&!this.peekKeyword("@-o-viewport")&&!this.peekKeyword("@viewport"))return null;var e=this.create(we);return this.consumeToken(),this._parseBody(e,this._parseRuleSetDeclaration.bind(this))}_parseKeyframe(){if(!this.peekRegExp(d.AtKeyword,this.keyframeRegex))return null;let e=this.create(Se),t=this.create(p);return this.consumeToken(),e.setKeyword(this.finish(t)),t.matches("@-ms-keyframes")&&this.markError(t,F.UnknownKeyword),e.setIdentifier(this._parseKeyframeIdent())?this._parseBody(e,this._parseKeyframeSelector.bind(this)):this.finish(e,F.IdentifierExpected,[d.CurlyR])}_parseKeyframeIdent(){return this._parseIdent([o.Keyframe])}_parseKeyframeSelector(){let e=this.create(Ce),t=!1;if(e.addChild(this._parseIdent())&&(t=!0),!(t=this.accept(d.Percentage)?!0:t))return null;for(;this.accept(d.Comma);)if(t=!1,e.addChild(this._parseIdent())&&(t=!0),!(t=this.accept(d.Percentage)?!0:t))return this.finish(e,F.PercentageExpected);return this._parseBody(e,this._parseRuleSetDeclaration.bind(this))}_tryParseKeyframeSelector(){let e=this.create(Ce),t=this.mark(),n=!1;if(e.addChild(this._parseIdent())&&(n=!0),!(n=this.accept(d.Percentage)?!0:n))return null;for(;this.accept(d.Comma);)if(n=!1,e.addChild(this._parseIdent())&&(n=!0),!(n=this.accept(d.Percentage)?!0:n))return this.restoreAtMark(t),null;return this.peek(d.CurlyL)?this._parseBody(e,this._parseRuleSetDeclaration.bind(this)):(this.restoreAtMark(t),null)}_parsePropertyAtRule(){if(!this.peekKeyword("@property"))return null;let e=this.create(Me);return this.consumeToken(),this.peekRegExp(d.Ident,/^--/)&&e.setName(this._parseIdent([o.Property]))?this._parseBody(e,this._parseDeclaration.bind(this)):this.finish(e,F.IdentifierExpected)}_parseLayer(e=!1){if(!this.peekKeyword("@layer"))return null;let t=this.create(Te),n=(this.consumeToken(),this._parseLayerNameList());return n&&t.setNames(n),n&&1!==n.getChildren().length||!this.peek(d.CurlyL)?this.accept(d.SemiColon)?this.finish(t):this.finish(t,F.SemiColonExpected):this._parseBody(t,this._parseLayerDeclaration.bind(this,e))}_parseLayerDeclaration(e=!1){return e?this._tryParseRuleset(!0)||this._tryToParseDeclaration()||this._parseStylesheetStatement(!0):this._parseStylesheetStatement(!1)}_parseLayerNameList(){let e=this.createNode(u.LayerNameList);if(!e.addChild(this._parseLayerName()))return null;for(;this.accept(d.Comma);)if(!e.addChild(this._parseLayerName()))return this.finish(e,F.IdentifierExpected);return this.finish(e)}_parseLayerName(){let e=this.createNode(u.LayerName);if(!e.addChild(this._parseIdent()))return null;for(;!this.hasWhitespace()&&this.acceptDelim(".");)if(this.hasWhitespace()||!e.addChild(this._parseIdent()))return this.finish(e,F.IdentifierExpected);return this.finish(e)}_parseSupports(e=!1){if(!this.peekKeyword("@supports"))return null;let t=this.create(Re);return this.consumeToken(),t.addChild(this._parseSupportsCondition()),this._parseBody(t,this._parseSupportsDeclaration.bind(this,e))}_parseSupportsDeclaration(e=!1){return e?this._tryParseRuleset(!0)||this._tryToParseDeclaration()||this._parseStylesheetStatement(!0):this._parseStylesheetStatement(!1)}_parseSupportsCondition(){let e=this.create($e);if(this.acceptIdent("not"))e.addChild(this._parseSupportsConditionInParens());else if(e.addChild(this._parseSupportsConditionInParens()),this.peekRegExp(d.Ident,/^(and|or)$/i))for(var t=this.token.text.toLowerCase();this.acceptIdent(t);)e.addChild(this._parseSupportsConditionInParens());return this.finish(e)}_parseSupportsConditionInParens(){let t=this.create($e);if(this.accept(d.ParenthesisL))return this.prevToken&&(t.lParent=this.prevToken.offset),t.addChild(this._tryToParseDeclaration([d.ParenthesisR]))||this._parseSupportsCondition()?this.accept(d.ParenthesisR)?(this.prevToken&&(t.rParent=this.prevToken.offset),this.finish(t)):this.finish(t,F.RightParenthesisExpected,[d.ParenthesisR],[]):this.finish(t,F.ConditionExpected);if(this.peek(d.Ident)){var e=this.mark();if(this.consumeToken(),!this.hasWhitespace()&&this.accept(d.ParenthesisL)){let e=1;for(;this.token.type!==d.EOF&&0!==e;)this.token.type===d.ParenthesisL?e++:this.token.type===d.ParenthesisR&&e--,this.consumeToken();return this.finish(t)}this.restoreAtMark(e)}return this.finish(t,F.LeftParenthesisExpected,[],[d.ParenthesisL])}_parseMediaDeclaration(e=!1){return e?this._tryParseRuleset(!0)||this._tryToParseDeclaration()||this._parseStylesheetStatement(!0):this._parseStylesheetStatement(!1)}_parseMedia(e=!1){if(!this.peekKeyword("@media"))return null;let t=this.create(De);return this.consumeToken(),t.addChild(this._parseMediaQueryList())?this._parseBody(t,this._parseMediaDeclaration.bind(this,e)):this.finish(t,F.MediaQueryExpected)}_parseMediaQueryList(){let e=this.create(Pe);if(!e.addChild(this._parseMediaQuery()))return this.finish(e,F.MediaQueryExpected);for(;this.accept(d.Comma);)if(!e.addChild(this._parseMediaQuery()))return this.finish(e,F.MediaQueryExpected);return this.finish(e)}_parseMediaQuery(){let e=this.create(Ae),t=this.mark();if(this.acceptIdent("not"),this.peek(d.ParenthesisL))this.restoreAtMark(t),e.addChild(this._parseMediaCondition());else{if(this.acceptIdent("only"),!e.addChild(this._parseIdent()))return null;this.acceptIdent("and")&&e.addChild(this._parseMediaCondition())}return this.finish(e)}_parseRatio(){var e=this.mark(),t=this.create(Je);return this._parseNumeric()?this.acceptDelim("/")?this._parseNumeric()?this.finish(t):this.finish(t,F.NumberExpected):(this.restoreAtMark(e),null):null}_parseMediaCondition(){let e=this.create(We),t=(this.acceptIdent("not"),!0);for(;t;){if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[],[d.CurlyL]);if(this.peek(d.ParenthesisL)||this.peekIdent("not")?e.addChild(this._parseMediaCondition()):e.addChild(this._parseMediaFeature()),!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[],[d.CurlyL]);t=this.acceptIdent("and")||this.acceptIdent("or")}return this.finish(e)}_parseMediaFeature(){let e=[d.ParenthesisR],t=this.create(Le);if(t.addChild(this._parseMediaFeatureName())){if(this.accept(d.Colon)){if(!t.addChild(this._parseMediaFeatureValue()))return this.finish(t,F.TermExpected,[],e)}else if(this._parseMediaFeatureRangeOperator()){if(!t.addChild(this._parseMediaFeatureValue()))return this.finish(t,F.TermExpected,[],e);if(this._parseMediaFeatureRangeOperator()&&!t.addChild(this._parseMediaFeatureValue()))return this.finish(t,F.TermExpected,[],e)}}else{if(!t.addChild(this._parseMediaFeatureValue()))return this.finish(t,F.IdentifierExpected,[],e);if(!this._parseMediaFeatureRangeOperator())return this.finish(t,F.OperatorExpected,[],e);if(!t.addChild(this._parseMediaFeatureName()))return this.finish(t,F.IdentifierExpected,[],e);if(this._parseMediaFeatureRangeOperator()&&!t.addChild(this._parseMediaFeatureValue()))return this.finish(t,F.TermExpected,[],e)}return this.finish(t)}_parseMediaFeatureRangeOperator(){return this.acceptDelim("<")||this.acceptDelim(">")?(this.hasWhitespace()||this.acceptDelim("="),!0):!!this.acceptDelim("=")}_parseMediaFeatureName(){return this._parseIdent()}_parseMediaFeatureValue(){return this._parseRatio()||this._parseTermExpression()}_parseMedium(){let e=this.create(p);return e.addChild(this._parseIdent())?this.finish(e):null}_parsePageDeclaration(){return this._parsePageMarginBox()||this._parseRuleSetDeclaration()}_parsePage(){if(!this.peekKeyword("@page"))return null;let e=this.create(Ue);if(this.consumeToken(),e.addChild(this._parsePageSelector()))for(;this.accept(d.Comma);)if(!e.addChild(this._parsePageSelector()))return this.finish(e,F.IdentifierExpected);return this._parseBody(e,this._parsePageDeclaration.bind(this))}_parsePageMarginBox(){if(!this.peek(d.AtKeyword))return null;var e=this.create(Ve);return this.acceptOneKeyword(Nn)||this.markError(e,F.UnknownAtRule,[],[d.CurlyL]),this._parseBody(e,this._parseRuleSetDeclaration.bind(this))}_parsePageSelector(){if(!this.peek(d.Ident)&&!this.peek(d.Colon))return null;let e=this.create(p);return e.addChild(this._parseIdent()),this.accept(d.Colon)&&!e.addChild(this._parseIdent())?this.finish(e,F.IdentifierExpected):this.finish(e)}_parseDocument(){if(!this.peekKeyword("@-moz-document"))return null;var e=this.create(Ne);return this.consumeToken(),this.resync([],[d.CurlyL]),this._parseBody(e,this._parseStylesheetStatement.bind(this))}_parseContainerDeclaration(e=!1){return e?this._tryParseRuleset(!0)||this._tryToParseDeclaration()||this._parseStylesheetStatement(!0):this._parseStylesheetStatement(!1)}_parseContainer(e=!1){if(!this.peekKeyword("@container"))return null;let t=this.create(Oe);return this.consumeToken(),t.addChild(this._parseIdent()),t.addChild(this._parseContainerQuery()),this._parseBody(t,this._parseContainerDeclaration.bind(this,e))}_parseContainerQuery(){let e=this.create(p);if(this.acceptIdent("not"))e.addChild(this._parseContainerQueryInParens());else if(e.addChild(this._parseContainerQueryInParens()),this.peekIdent("and"))for(;this.acceptIdent("and");)e.addChild(this._parseContainerQueryInParens());else if(this.peekIdent("or"))for(;this.acceptIdent("or");)e.addChild(this._parseContainerQueryInParens());return this.finish(e)}_parseContainerQueryInParens(){let e=this.create(p);if(this.accept(d.ParenthesisL)){if(this.peekIdent("not")||this.peek(d.ParenthesisL)?e.addChild(this._parseContainerQuery()):e.addChild(this._parseMediaFeature()),!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[],[d.CurlyL])}else{if(!this.acceptIdent("style"))return this.finish(e,F.LeftParenthesisExpected,[],[d.CurlyL]);if(this.hasWhitespace()||!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[],[d.CurlyL]);if(e.addChild(this._parseStyleQuery()),!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[],[d.CurlyL])}return this.finish(e)}_parseStyleQuery(){let e=this.create(p);if(this.acceptIdent("not"))e.addChild(this._parseStyleInParens());else if(this.peek(d.ParenthesisL)){if(e.addChild(this._parseStyleInParens()),this.peekIdent("and"))for(;this.acceptIdent("and");)e.addChild(this._parseStyleInParens());else if(this.peekIdent("or"))for(;this.acceptIdent("or");)e.addChild(this._parseStyleInParens())}else e.addChild(this._parseDeclaration([d.ParenthesisR]));return this.finish(e)}_parseStyleInParens(){let e=this.create(p);return this.accept(d.ParenthesisL)?(e.addChild(this._parseStyleQuery()),this.accept(d.ParenthesisR)?this.finish(e):this.finish(e,F.RightParenthesisExpected,[],[d.CurlyL])):this.finish(e,F.LeftParenthesisExpected,[],[d.CurlyL])}_parseUnknownAtRule(){if(!this.peek(d.AtKeyword))return null;let e=this.create(it),t=(e.addChild(this._parseUnknownAtRuleName()),0),n=0,r=0,i=0;e:for(;;){switch(this.token.type){case d.SemiColon:if(0===n&&0===r&&0===i)break e;break;case d.EOF:return 0<n?this.finish(e,F.RightCurlyExpected):0<i?this.finish(e,F.RightSquareBracketExpected):0<r?this.finish(e,F.RightParenthesisExpected):this.finish(e);case d.CurlyL:t++,n++;break;case d.CurlyR:if(n--,0<t&&0===n){if(this.consumeToken(),0<i)return this.finish(e,F.RightSquareBracketExpected);if(0<r)return this.finish(e,F.RightParenthesisExpected);break e}if(n<0){if(0===r&&0===i)break e;return this.finish(e,F.LeftCurlyExpected)}break;case d.ParenthesisL:r++;break;case d.ParenthesisR:if(--r<0)return this.finish(e,F.LeftParenthesisExpected);break;case d.BracketL:i++;break;case d.BracketR:if(--i<0)return this.finish(e,F.LeftSquareBracketExpected)}this.consumeToken()}return e}_parseUnknownAtRuleName(){var e=this.create(p);return this.accept(d.AtKeyword)?this.finish(e):e}_parseOperator(){var e;return this.peekDelim("/")||this.peekDelim("*")||this.peekDelim("+")||this.peekDelim("-")||this.peek(d.Dashmatch)||this.peek(d.Includes)||this.peek(d.SubstringOperator)||this.peek(d.PrefixOperator)||this.peek(d.SuffixOperator)||this.peekDelim("=")?(e=this.createNode(u.Operator),this.consumeToken(),this.finish(e)):null}_parseUnaryOperator(){if(!this.peekDelim("+")&&!this.peekDelim("-"))return null;var e=this.create(p);return this.consumeToken(),this.finish(e)}_parseCombinator(){if(this.peekDelim(">")){let e=this.create(p);this.consumeToken();var t=this.mark();if(!this.hasWhitespace()&&this.acceptDelim(">")){if(!this.hasWhitespace()&&this.acceptDelim(">"))return e.type=u.SelectorCombinatorShadowPiercingDescendant,this.finish(e);this.restoreAtMark(t)}return e.type=u.SelectorCombinatorParent,this.finish(e)}if(this.peekDelim("+")){let e=this.create(p);return this.consumeToken(),e.type=u.SelectorCombinatorSibling,this.finish(e)}if(this.peekDelim("~")){let e=this.create(p);return this.consumeToken(),e.type=u.SelectorCombinatorAllSiblings,this.finish(e)}if(this.peekDelim("/")){let e=this.create(p);this.consumeToken();t=this.mark();if(!this.hasWhitespace()&&this.acceptIdent("deep")&&!this.hasWhitespace()&&this.acceptDelim("/"))return e.type=u.SelectorCombinatorShadowPiercingDescendant,this.finish(e);this.restoreAtMark(t)}return null}_parseSimpleSelector(){let e=this.create(se),t=0;for(e.addChild(this._parseElementName()||this._parseNestingSelector())&&t++;(0===t||!this.hasWhitespace())&&e.addChild(this._parseSimpleSelectorBody());)t++;return 0<t?this.finish(e):null}_parseNestingSelector(){var e;return this.peekDelim("&")?(e=this.createNode(u.SelectorCombinator),this.consumeToken(),this.finish(e)):null}_parseSimpleSelectorBody(){return this._parsePseudo()||this._parseHash()||this._parseClass()||this._parseAttrib()}_parseSelectorIdent(){return this._parseIdent()}_parseHash(){if(!this.peek(d.Hash)&&!this.peekDelim("#"))return null;let e=this.createNode(u.IdentifierSelector);if(this.acceptDelim("#")){if(this.hasWhitespace()||!e.addChild(this._parseSelectorIdent()))return this.finish(e,F.IdentifierExpected)}else this.consumeToken();return this.finish(e)}_parseClass(){if(!this.peekDelim("."))return null;let e=this.createNode(u.ClassSelector);return this.consumeToken(),this.hasWhitespace()||!e.addChild(this._parseSelectorIdent())?this.finish(e,F.IdentifierExpected):this.finish(e)}_parseElementName(){let e=this.mark(),t=this.createNode(u.ElementNameSelector);return t.addChild(this._parseNamespacePrefix()),t.addChild(this._parseSelectorIdent())||this.acceptDelim("*")?this.finish(t):(this.restoreAtMark(e),null)}_parseNamespacePrefix(){let e=this.mark(),t=this.createNode(u.NamespacePrefix);return t.addChild(this._parseIdent())||this.acceptDelim("*"),this.acceptDelim("|")?this.finish(t):(this.restoreAtMark(e),null)}_parseAttrib(){if(!this.peek(d.BracketL))return null;let e=this.create(Ke);return this.consumeToken(),e.setNamespacePrefix(this._parseNamespacePrefix()),e.setIdentifier(this._parseIdent())?(e.setOperator(this._parseOperator())&&(e.setValue(this._parseBinaryExpr()),this.acceptIdent("i"),this.acceptIdent("s")),this.accept(d.BracketR)?this.finish(e):this.finish(e,F.RightSquareBracketExpected)):this.finish(e,F.IdentifierExpected)}_parsePseudo(){let e=this._tryParsePseudoIdentifier();if(e){if(!this.hasWhitespace()&&this.accept(d.ParenthesisL)){var t=()=>{let e=this.create(p);if(!e.addChild(this._parseSelector(!0)))return null;for(;this.accept(d.Comma)&&e.addChild(this._parseSelector(!0)););return this.peek(d.ParenthesisR)?this.finish(e):null};if(!e.addChild(this.try(t))&&e.addChild(this._parseBinaryExpr())&&this.acceptIdent("of")&&!e.addChild(this.try(t)))return this.finish(e,F.SelectorExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected)}return this.finish(e)}return null}_tryParsePseudoIdentifier(){if(!this.peek(d.Colon))return null;let e=this.mark(),t=this.createNode(u.PseudoSelector);return this.consumeToken(),this.hasWhitespace()?(this.restoreAtMark(e),null):(this.accept(d.Colon),this.hasWhitespace()||!t.addChild(this._parseIdent())?this.finish(t,F.IdentifierExpected):this.finish(t))}_tryParsePrio(){var e=this.mark();return this._parsePrio()||(this.restoreAtMark(e),null)}_parsePrio(){if(!this.peek(d.Exclamation))return null;var e=this.createNode(u.Prio);return this.accept(d.Exclamation)&&this.acceptIdent("important")?this.finish(e):null}_parseExpr(e=!1){let t=this.create(je);if(!t.addChild(this._parseBinaryExpr()))return null;for(;;){if(this.peek(d.Comma)){if(e)return this.finish(t);this.consumeToken()}if(!t.addChild(this._parseBinaryExpr()))break}return this.finish(t)}_parseUnicodeRange(){if(!this.peekIdent("u"))return null;var e=this.create(ee);return this.acceptUnicodeRange()?this.finish(e):null}_parseNamedLine(){if(!this.peek(d.BracketL))return null;let e=this.createNode(u.GridLine);for(this.consumeToken();e.addChild(this._parseIdent()););return this.accept(d.BracketR)?this.finish(e):this.finish(e,F.RightSquareBracketExpected)}_parseBinaryExpr(e,t){let n=this.create(Be);if(!n.setLeft(e||this._parseTerm()))return null;if(!n.setOperator(t||this._parseOperator()))return this.finish(n);if(!n.setRight(this._parseTerm()))return this.finish(n,F.TermExpected);n=this.finish(n);e=this._parseOperator();return e&&(n=this._parseBinaryExpr(n,e)),this.finish(n)}_parseTerm(){let e=this.create(qe);return e.setOperator(this._parseUnaryOperator()),e.setExpression(this._parseTermExpression())?this.finish(e):null}_parseTermExpression(){return this._parseURILiteral()||this._parseUnicodeRange()||this._parseFunction()||this._parseIdent()||this._parseStringLiteral()||this._parseNumeric()||this._parseHexColor()||this._parseOperation()||this._parseNamedLine()}_parseOperation(){if(!this.peek(d.ParenthesisL))return null;let e=this.create(p);return this.consumeToken(),e.addChild(this._parseExpr()),this.accept(d.ParenthesisR)?this.finish(e):this.finish(e,F.RightParenthesisExpected)}_parseNumeric(){var e;return this.peek(d.Num)||this.peek(d.Percentage)||this.peek(d.Resolution)||this.peek(d.Length)||this.peek(d.EMS)||this.peek(d.EXS)||this.peek(d.Angle)||this.peek(d.Time)||this.peek(d.Dimension)||this.peek(d.ContainerQueryLength)||this.peek(d.Freq)?(e=this.create(He),this.consumeToken(),this.finish(e)):null}_parseStringLiteral(){if(!this.peek(d.String)&&!this.peek(d.BadString))return null;var e=this.createNode(u.StringLiteral);return this.consumeToken(),this.finish(e)}_parseURILiteral(){if(!this.peekRegExp(d.Ident,/^url(-prefix)?$/i))return null;let e=this.mark(),t=this.createNode(u.URILiteral);return this.accept(d.Ident),this.hasWhitespace()||!this.peek(d.ParenthesisL)?(this.restoreAtMark(e),null):(this.scanner.inURL=!0,this.consumeToken(),t.addChild(this._parseURLArgument()),this.scanner.inURL=!1,this.accept(d.ParenthesisR)?this.finish(t):this.finish(t,F.RightParenthesisExpected))}_parseURLArgument(){var e=this.create(p);return this.accept(d.String)||this.accept(d.BadString)||this.acceptUnquotedString()?this.finish(e):null}_parseIdent(e){if(!this.peek(d.Ident))return null;let t=this.create(c);return e&&(t.referenceTypes=e),t.isCustomProperty=this.peekRegExp(d.Ident,/^--/),this.consumeToken(),this.finish(t)}_parseFunction(){let e=this.mark(),t=this.create(de);if(!t.setIdentifier(this._parseFunctionIdentifier()))return null;if(this.hasWhitespace()||!this.accept(d.ParenthesisL))return this.restoreAtMark(e),null;if(t.getArguments().addChild(this._parseFunctionArgument()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)t.getArguments().addChild(this._parseFunctionArgument())||this.markError(t,F.ExpressionExpected);return this.accept(d.ParenthesisR)?this.finish(t):this.finish(t,F.RightParenthesisExpected)}_parseFunctionIdentifier(){if(!this.peek(d.Ident))return null;let e=this.create(c);if(e.referenceTypes=[o.Function],this.acceptIdent("progid")){if(this.accept(d.Colon))for(;this.accept(d.Ident)&&this.acceptDelim("."););return this.finish(e)}return this.consumeToken(),this.finish(e)}_parseFunctionArgument(){let e=this.create(pe);return e.setValue(this._parseExpr(!0))?this.finish(e):null}_parseHexColor(){var e;return this.peekRegExp(d.Hash,/^#([A-Fa-f0-9]{3}|[A-Fa-f0-9]{4}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{8})$/g)?(e=this.create(Ge),this.consumeToken(),this.finish(e)):null}};function An(e,t){return-1!==e.indexOf(t)}function Wn(...e){let t=[];for(var n of e)for(var r of n)An(t,r)||t.push(r);return t}var Ln=class{constructor(e,t){this.offset=e,this.length=t,this.symbols=[],this.parent=null,this.children=[]}addChild(e){this.children.push(e),e.setParent(this)}setParent(e){this.parent=e}findScope(e,t=0){return this.offset<=e&&this.offset+this.length>e+t||this.offset===e&&this.length===t?this.findInScope(e,t):null}findInScope(e,t=0){let n=e+t,r=function(e,t){let n=0,r=e.length;if(0===r)return 0;for(;n<r;){var i=Math.floor((n+r)/2);t(e[i])?r=i:n=i+1}return n}(this.children,e=>e.offset>n);if(0===r)return this;let i=this.children[r-1];return i.offset<=e&&i.offset+i.length>=e+t?i.findInScope(e,t):this}addSymbol(e){this.symbols.push(e)}getSymbol(t,n){for(let e=0;e<this.symbols.length;e++){var r=this.symbols[e];if(r.name===t&&r.type===n)return r}return null}getSymbols(){return this.symbols}},$n=class extends Ln{constructor(){super(0,Number.MAX_VALUE)}},Un=class{constructor(e,t,n,r){this.name=e,this.value=t,this.node=n,this.type=r}},Vn=class{constructor(e){this.scope=e}addSymbol(t,n,r,i){if(-1!==t.offset){let e=this.scope.findScope(t.offset,t.length);e&&e.addSymbol(new Un(n,r,t,i))}}addScope(t){if(-1===t.offset)return null;{let e=this.scope.findScope(t.offset,t.length);return!e||e.offset===t.offset&&e.length===t.length?e:(t=new Ln(t.offset,t.length),e.addChild(t),t)}}addSymbolToChildScope(t,n,r,i,s){if(t&&-1!==t.offset){let e=this.addScope(t);e&&e.addSymbol(new Un(r,i,n,s))}}visitNode(n){switch(n.type){case u.Keyframe:return this.addSymbol(n,n.getName(),void 0,o.Keyframe),!0;case u.CustomPropertyDeclaration:return this.visitCustomPropertyDeclarationNode(n);case u.VariableDeclaration:return this.visitVariableDeclarationNode(n);case u.Ruleset:return this.visitRuleSet(n);case u.MixinDeclaration:return this.addSymbol(n,n.getName(),void 0,o.Mixin),!0;case u.FunctionDeclaration:return this.addSymbol(n,n.getName(),void 0,o.Function),!0;case u.FunctionParameter:return this.visitFunctionParameterNode(n);case u.Declarations:return this.addScope(n),!0;case u.For:let e=n,t=e.getDeclarations();return t&&e.variable&&this.addSymbolToChildScope(t,e.variable,e.variable.getName(),void 0,o.Variable),!0;case u.Each:{let e=n,t=e.getDeclarations();var r;if(t)for(r of e.getVariables().getChildren())this.addSymbolToChildScope(t,r,r.getName(),void 0,o.Variable);return!0}}return!0}visitRuleSet(e){let t=this.scope.findScope(e.offset,e.length);if(t)for(var n of e.getSelectors().getChildren())n instanceof ie&&1===n.getChildren().length&&t.addSymbol(new Un(n.getChild(0).getText(),void 0,n,o.Rule));return!0}visitVariableDeclarationNode(e){var t=e.getValue()?e.getValue().getText():void 0;return this.addSymbol(e,e.getName(),t,o.Variable),!0}visitFunctionParameterNode(n){var r=n.getParent().getDeclarations();if(r){let e=n.getDefaultValue(),t=e?e.getText():void 0;this.addSymbolToChildScope(r,n,n.getName(),t,o.Variable)}return!0}visitCustomPropertyDeclarationNode(e){var t=e.getValue()?e.getValue().getText():"";return this.addCSSVariable(e.getProperty(),e.getProperty().getName(),t,o.Variable),!0}addCSSVariable(e,t,n,r){-1!==e.offset&&this.scope.addSymbol(new Un(t,n,e,r))}},jn=class{constructor(e){this.global=new $n,e.acceptVisitor(new Vn(this.global))}findSymbolsAtOffset(e,t){let n=this.global.findScope(e,0),r=[],i={};for(;n;){var s=n.getSymbols();for(let e=0;e<s.length;e++){var a=s[e];a.type!==t||i[a.name]||(r.push(a),i[a.name]=!0)}n=n.parent}return r}internalFindSymbol(e,t){let n=e;if(e.parent instanceof he&&e.parent.getParent()instanceof h&&(n=e.parent.getParent().getDeclarations()),e.parent instanceof pe&&e.parent.getParent()instanceof de){var r=e.parent.getParent().getIdentifier();if(r){let e=this.internalFindSymbol(r,[o.Function]);e&&(n=e.node.getDeclarations())}}if(!n)return null;let i=e.getText(),s=this.global.findScope(n.offset,n.length);for(;s;){for(let e=0;e<t.length;e++){var a=t[e],a=s.getSymbol(i,a);if(a)return a}s=s.parent}return null}evaluateReferenceTypes(t){if(t instanceof c){var n=t.referenceTypes;if(n)return n;{if(t.isCustomProperty)return[o.Variable];let e=function(e){let t=e.findParent(u.Declaration),n=t&&t.getValue();return n&&n.encloses(e)?t:null}(t);if(e){n=e.getNonPrefixedPropertyName();if(("animation"===n||"animation-name"===n)&&e.getValue()&&e.getValue().offset===t.offset)return[o.Keyframe]}}}else if(t instanceof Qe)return[o.Variable];return t.findAParent(u.Selector,u.ExtendsReference)?[o.Rule]:null}findSymbolFromNode(e){if(!e)return null;for(;e.type===u.Interpolation;)e=e.getParent();var t=this.evaluateReferenceTypes(e);return t?this.internalFindSymbol(e,t):null}matchesSymbol(e,t){if(!e)return!1;for(;e.type===u.Interpolation;)e=e.getParent();if(!e.matches(t.name))return!1;let n=this.evaluateReferenceTypes(e);return!(!n||-1===n.indexOf(t.type))&&this.internalFindSymbol(e,n)===t}findSymbol(e,t,n){let r=this.global.findScope(n);for(;r;){var i=r.getSymbol(e,t);if(i)return i;r=r.parent}return null}},Bn={470:e=>{function p(e){if("string"!=typeof e)throw new TypeError("Path must be a string. Received "+JSON.stringify(e))}function s(e,t){for(var n,r="",i=0,s=-1,a=0,o=0;o<=e.length;++o){if(o<e.length)n=e.charCodeAt(o);else{if(47===n)break;n=47}if(47===n){if(s!==o-1&&1!==a)if(s!==o-1&&2===a){if(r.length<2||2!==i||46!==r.charCodeAt(r.length-1)||46!==r.charCodeAt(r.length-2))if(2<r.length){var l=r.lastIndexOf("/");if(l!==r.length-1){i=-1===l?(r="",0):(r=r.slice(0,l)).length-1-r.lastIndexOf("/"),s=o,a=0;continue}}else if(2===r.length||1===r.length){r="",s=o,a=i=0;continue}t&&(0<r.length?r+="/..":r="..",i=2)}else 0<r.length?r+="/"+e.slice(s+1,o):r=e.slice(s+1,o),i=o-s-1;s=o,a=0}else 46===n&&-1!==a?++a:a=-1}return r}var m={resolve:function(){for(var e,t="",n=!1,r=arguments.length-1;-1<=r&&!n;r--){var i=0<=r?arguments[r]:e=void 0===e?process.cwd():e;p(i),0!==i.length&&(t=i+"/"+t,n=47===i.charCodeAt(0))}return t=s(t,!n),n?0<t.length?"/"+t:"/":0<t.length?t:"."},normalize:function(e){if(p(e),0===e.length)return".";var t=47===e.charCodeAt(0),n=47===e.charCodeAt(e.length-1);return 0<(e=0!==(e=s(e,!t)).length||t?e:".").length&&n&&(e+="/"),t?"/"+e:e},isAbsolute:function(e){return p(e),0<e.length&&47===e.charCodeAt(0)},join:function(){if(0===arguments.length)return".";for(var e,t=0;t<arguments.length;++t){var n=arguments[t];p(n),0<n.length&&(void 0===e?e=n:e+="/"+n)}return void 0===e?".":m.normalize(e)},relative:function(e,t){if(p(e),p(t),e===t||(e=m.resolve(e))===(t=m.resolve(t)))return"";for(var n=1;n<e.length&&47===e.charCodeAt(n);++n);for(var r=e.length,i=r-n,s=1;s<t.length&&47===t.charCodeAt(s);++s);for(var a=t.length-s,o=i<a?i:a,l=-1,c=0;c<=o;++c){if(c===o){if(o<a){if(47===t.charCodeAt(s+c))return t.slice(s+c+1);if(0===c)return t.slice(s+c)}else o<i&&(47===e.charCodeAt(n+c)?l=c:0===c&&(l=0));break}var d=e.charCodeAt(n+c);if(d!==t.charCodeAt(s+c))break;47===d&&(l=c)}for(var h="",c=n+l+1;c<=r;++c)c!==r&&47!==e.charCodeAt(c)||(0===h.length?h+="..":h+="/..");return 0<h.length?h+t.slice(s+l):(47===t.charCodeAt(s+=l)&&++s,t.slice(s))},_makeLong:function(e){return e},dirname:function(e){if(p(e),0===e.length)return".";for(var t=47===e.charCodeAt(0),n=-1,r=!0,i=e.length-1;1<=i;--i)if(47===e.charCodeAt(i)){if(!r){n=i;break}}else r=!1;return-1===n?t?"/":".":t&&1===n?"//":e.slice(0,n)},basename:function(e,t){if(void 0!==t&&"string"!=typeof t)throw new TypeError('"ext" argument must be a string');p(e);var n=0,r=-1,i=!0;if(void 0!==t&&0<t.length&&t.length<=e.length){if(t.length===e.length&&t===e)return"";for(var s=t.length-1,a=-1,o=e.length-1;0<=o;--o){var l=e.charCodeAt(o);if(47===l){if(!i){n=o+1;break}}else-1===a&&(i=!1,a=o+1),0<=s&&(l===t.charCodeAt(s)?-1==--s&&(r=o):(s=-1,r=a))}return n===r?r=a:-1===r&&(r=e.length),e.slice(n,r)}for(o=e.length-1;0<=o;--o)if(47===e.charCodeAt(o)){if(!i){n=o+1;break}}else-1===r&&(i=!1,r=o+1);return-1===r?"":e.slice(n,r)},extname:function(e){p(e);for(var t=-1,n=0,r=-1,i=!0,s=0,a=e.length-1;0<=a;--a){var o=e.charCodeAt(a);if(47!==o)-1===r&&(i=!1,r=a+1),46===o?-1===t?t=a:1!==s&&(s=1):-1!==t&&(s=-1);else if(!i){n=a+1;break}}return-1===t||-1===r||0===s||1===s&&t===r-1&&t===n+1?"":e.slice(t,r)},format:function(e){if(null===e||"object"!=typeof e)throw new TypeError('The "pathObject" argument must be of type Object. Received type '+typeof e);return t=e.dir||e.root,n=e.base||(e.name||"")+(e.ext||""),t?t===e.root?t+n:t+"/"+n:n;var t,n},parse:function(e){p(e);var t={root:"",dir:"",base:"",ext:"",name:""};if(0===e.length)return t;for(var n,r=47===e.charCodeAt(0),i=r?(t.root="/",1):0,s=-1,a=0,o=-1,l=!0,c=e.length-1,d=0;i<=c;--c)if(47!==(n=e.charCodeAt(c)))-1===o&&(l=!1,o=c+1),46===n?-1===s?s=c:1!==d&&(d=1):-1!==s&&(d=-1);else if(!l){a=c+1;break}return-1===s||-1===o||0===d||1===d&&s===o-1&&s===a+1?-1!==o&&(t.base=t.name=0===a&&r?e.slice(1,o):e.slice(a,o)):(0===a&&r?(t.name=e.slice(1,s),t.base=e.slice(1,o)):(t.name=e.slice(a,s),t.base=e.slice(a,o)),t.ext=e.slice(s,o)),0<a?t.dir=e.slice(0,a-1):r&&(t.dir="/"),t},sep:"/",delimiter:":",win32:null,posix:null};m.posix=m,e.exports=m}},qn={};function Kn(e){var t=qn[e];if(void 0!==t)return t.exports;t=qn[e]={exports:{}};return Bn[e](t,t.exports,Kn),t.exports}Kn.d=(e,t)=>{for(var n in t)Kn.o(t,n)&&!Kn.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},Kn.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),Kn.r=e=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var Gn={};{let r,n=(Kn.r(Gn),Kn.d(Gn,{URI:()=>Bi,Utils:()=>er}),"object"==typeof process?r="win32"===process.platform:"object"==typeof navigator&&(r=0<=navigator.userAgent.indexOf("Windows")),/^\w[\w\d+.-]*$/),i=/^\//,s=/^\/\//;function Jn(e,t){if(!e.scheme&&t)throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);if(e.scheme&&!n.test(e.scheme))throw new Error("[UriError]: Scheme contains illegal characters.");if(e.path)if(e.authority){if(!i.test(e.path))throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')}else if(s.test(e.path))throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')}let c="/",a=/^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;class Bi{static isUri(e){return e instanceof Bi||!!e&&"string"==typeof e.authority&&"string"==typeof e.fragment&&"string"==typeof e.path&&"string"==typeof e.query&&"string"==typeof e.scheme&&"string"==typeof e.fsPath&&"function"==typeof e.with&&"function"==typeof e.toString}scheme;authority;path;query;fragment;constructor(e,t,n,r,i,s=!1){"object"==typeof e?(this.scheme=e.scheme||"",this.authority=e.authority||"",this.path=e.path||"",this.query=e.query||"",this.fragment=e.fragment||""):(this.scheme=e||s?e:"file",this.authority=t||"",this.path=function(e,t){switch(e){case"https":case"http":case"file":t?t[0]!==c&&(t=c+t):t=c}return t}(this.scheme,n||""),this.query=r||"",this.fragment=i||"",Jn(this,s))}get fsPath(){return Yn(this,!1)}with(e){if(!e)return this;let{scheme:t,authority:n,path:r,query:i,fragment:s}=e;return void 0===t?t=this.scheme:null===t&&(t=""),void 0===n?n=this.authority:null===n&&(n=""),void 0===r?r=this.path:null===r&&(r=""),void 0===i?i=this.query:null===i&&(i=""),void 0===s?s=this.fragment:null===s&&(s=""),t===this.scheme&&n===this.authority&&r===this.path&&i===this.query&&s===this.fragment?this:new qi(t,n,r,i,s)}static parse(e,t=!1){e=a.exec(e);return e?new qi(e[2]||"",Zn(e[4]||""),Zn(e[5]||""),Zn(e[7]||""),Zn(e[9]||""),t):new qi("","","","","")}static file(e){let t="";var n;return(e=r?e.replace(/\\/g,c):e)[0]===c&&e[1]===c&&(e=-1===(n=e.indexOf(c,2))?(t=e.substring(2),c):(t=e.substring(2,n),e.substring(n)||c)),new qi("file",t,e,"","")}static from(e){e=new qi(e.scheme,e.authority,e.path,e.query,e.fragment);return Jn(e,!0),e}toString(e=!1){return Qn(this,e)}toJSON(){return this}static revive(t){if(t){if(t instanceof Bi)return t;{let e=new qi(t);return e._formatted=t.external,e._fsPath=t._sep===o?t.fsPath:null,e}}return t}}let o=r?1:void 0;class qi extends Bi{_formatted=null;_fsPath=null;get fsPath(){return this._fsPath||(this._fsPath=Yn(this,!1)),this._fsPath}toString(e=!1){return e?Qn(this,!0):(this._formatted||(this._formatted=Qn(this,!1)),this._formatted)}toJSON(){let e={$mid:1};return this._fsPath&&(e.fsPath=this._fsPath,e._sep=o),this._formatted&&(e.external=this._formatted),this.path&&(e.path=this.path),this.scheme&&(e.scheme=this.scheme),this.authority&&(e.authority=this.authority),this.query&&(e.query=this.query),this.fragment&&(e.fragment=this.fragment),e}}let l={58:"%3A",47:"%2F",63:"%3F",35:"%23",91:"%5B",93:"%5D",64:"%40",33:"%21",36:"%24",38:"%26",39:"%27",40:"%28",41:"%29",42:"%2A",43:"%2B",44:"%2C",59:"%3B",61:"%3D",32:"%20"};function Hn(t,n,r){let i,s=-1;for(let e=0;e<t.length;e++){var a=t.charCodeAt(e);97<=a&&a<=122||65<=a&&a<=90||48<=a&&a<=57||45===a||46===a||95===a||126===a||n&&47===a||r&&91===a||r&&93===a||r&&58===a?(-1!==s&&(i+=encodeURIComponent(t.substring(s,e)),s=-1),void 0!==i&&(i+=t.charAt(e))):(void 0===i&&(i=t.substr(0,e)),void 0!==(a=l[a])?(-1!==s&&(i+=encodeURIComponent(t.substring(s,e)),s=-1),i+=a):-1===s&&(s=e))}return-1!==s&&(i+=encodeURIComponent(t.substring(s))),void 0!==i?i:t}function Xn(t){let n;for(let e=0;e<t.length;e++){var r=t.charCodeAt(e);35===r||63===r?(void 0===n&&(n=t.substr(0,e)),n+=l[r]):void 0!==n&&(n+=t[e])}return void 0!==n?n:t}function Yn(e,t){let n;return n=e.authority&&1<e.path.length&&"file"===e.scheme?"//"+e.authority+e.path:47===e.path.charCodeAt(0)&&(65<=e.path.charCodeAt(1)&&e.path.charCodeAt(1)<=90||97<=e.path.charCodeAt(1)&&e.path.charCodeAt(1)<=122)&&58===e.path.charCodeAt(2)?t?e.path.substr(1):e.path[1].toLowerCase()+e.path.substr(2):e.path,n=r?n.replace(/\//g,"\\"):n}function Qn(e,t){let n=t?Xn:Hn,r="",{scheme:i,authority:s,path:a,query:o,fragment:l}=e;if(i&&(r=r+i+":"),!s&&"file"!==i||(r=(r+=c)+c),s){let t=s.indexOf("@");if(-1!==t){let e=s.substr(0,t);s=s.substr(t+1),-1===(t=e.lastIndexOf(":"))?r+=n(e,!1,!1):r=(r=r+n(e.substr(0,t),!1,!1)+":")+n(e.substr(t+1),!1,!0),r+="@"}s=s.toLowerCase(),-1===(t=s.lastIndexOf(":"))?r+=n(s,!1,!0):r=(r+=n(s.substr(0,t),!1,!0))+s.substr(t)}return a&&(3<=a.length&&47===a.charCodeAt(0)&&58===a.charCodeAt(2)?65<=(e=a.charCodeAt(1))&&e<=90&&(a=`/${String.fromCharCode(e+32)}:`+a.substr(3)):2<=a.length&&58===a.charCodeAt(1)&&(65<=(e=a.charCodeAt(0))&&e<=90&&(a=String.fromCharCode(e+32)+":"+a.substr(2))),r+=n(a,!0,!1)),o&&(r=(r+="?")+n(o,!1,!1)),r=l?(r+="#")+(t?l:Hn(l,!1,!1)):r}let t=/(%[0-9A-Za-z][0-9A-Za-z])+/g;function Zn(e){return e.match(t)?e.replace(t,e=>function e(t){try{return decodeURIComponent(t)}catch{return 3<t.length?t.substr(0,3)+e(t.substr(3)):t}}(e)):e}var er,_=Kn(470);let d=_.posix||_;(_=er=er||{}).joinPath=function(e,...t){return e.with({path:d.join(e.path,...t)})},_.resolvePath=function(e,...t){let n=e.path,r=!1,i=("/"!==n[0]&&(n="/"+n,r=!0),d.resolve(n,...t));return r&&"/"===i[0]&&!e.authority&&(i=i.substring(1)),e.with({path:i})},_.dirname=function(e){if(0===e.path.length||"/"===e.path)return e;let t=d.dirname(e.path);return 1===t.length&&46===t.charCodeAt(0)&&(t=""),e.with({path:t})},_.basename=function(e){return d.basename(e.path)},_.extname=function(e){return d.extname(e.path)}}var{URI:tr,Utils:nr}=Gn;function rr(e){return nr.dirname(tr.parse(e)).toString(!0)}function ir(e,...t){return nr.joinPath(tr.parse(e),...t).toString(!0)}var sr=class{constructor(e){this.readDirectory=e,this.literalCompletions=[],this.importCompletions=[]}onCssURILiteralValue(e){this.literalCompletions.push(e)}onCssImportPath(e){this.importCompletions.push(e)}async computeCompletions(t,n){let r={items:[],isIncomplete:!1};for(var e of this.literalCompletions){var i,s=e.uriValue,a=or(s);if("."===a||".."===a)r.isIncomplete=!0;else for(i of await this.providePathSuggestions(s,e.position,e.range,t,n))r.items.push(i)}for(var o of this.importCompletions){var l=o.pathValue,c=or(l);if("."===c||".."===c)r.isIncomplete=!0;else{let e=await this.providePathSuggestions(l,o.position,o.range,t,n);"scss"===t.languageId&&e.forEach(e=>{v(e.label,"_")&&H(e.label,".scss")&&(e.textEdit?e.textEdit.newText=e.label.slice(1,-5):e.label=e.label.slice(1,-5))});for(var d of e)r.items.push(d)}}return r}async providePathSuggestions(e,t,n,r,i){let s=or(e),a=v(e,"'")||v(e,'"'),o=a?s.slice(0,t.character-(n.start.character+1)):s.slice(0,t.character-n.start.character),l=r.uri,c=a?function(e,t,n){t=cr(e.start,t),e=cr(e.end,n);return w.create(t,e)}(n,1,-1):n,d=function(e,i,s){let a,o=e.lastIndexOf("/");if(-1===o)a=s;else{let e=i.slice(o+1),t=cr(s.end,-e.length),n=e.indexOf(" "),r;r=-1!==n?cr(t,n):s.end,a=w.create(t,r)}return a}(o,s,c),h=o.substring(0,o.lastIndexOf("/")+1),p=i.resolveReference(h||".",l);if(p)try{let e=[],t=await this.readDirectory(p);for(var[m,u]of t)m.charCodeAt(0)===ar||u!==Jt.Directory&&ir(p,m)===l||e.push((f=m,g=u===Jt.Directory,b=d,g?{label:lr(f+="/"),kind:C.Folder,textEdit:S.replace(b,lr(f)),command:{title:"Suggest",command:"editor.action.triggerSuggest"}}:{label:lr(f),kind:C.File,textEdit:S.replace(b,lr(f))}));return e}catch{}var f,g,b;return[]}},ar=46;function or(e){return v(e,"'")||v(e,'"')?e.slice(1,-1):e}function lr(e){return e.replace(/(\s|\(|\)|,|"|')/g,"\\$1")}function cr(e,t){return m.create(e.line,e.character+t)}var I,dr,hr=g.Snippet,pr={title:"Suggest",command:"editor.action.triggerSuggest"},mr=((dr=I=I||{}).Enums=" ",dr.Normal="d",dr.VendorPrefixed="x",dr.Term="y",dr.Variable="z",class{constructor(e=null,t,n){this.variablePrefix=e,this.lsOptions=t,this.cssDataManager=n,this.completionParticipants=[]}configure(e){this.defaultSettings=e}getSymbolContext(){return this.symbolContext||(this.symbolContext=new jn(this.styleSheet)),this.symbolContext}setCompletionParticipants(e){this.completionParticipants=e||[]}async doComplete2(t,n,e,r,i=this.defaultSettings){if(!this.lsOptions.fileSystemProvider||!this.lsOptions.fileSystemProvider.readDirectory)return this.doComplete(t,n,e,i);let s=new sr(this.lsOptions.fileSystemProvider.readDirectory),a=this.completionParticipants;this.completionParticipants=[s].concat(a);n=this.doComplete(t,n,e,i);try{let e=await s.computeCompletions(t,r);return{isIncomplete:n.isIncomplete||e.isIncomplete,itemDefaults:n.itemDefaults,items:e.items.concat(n.items)}}finally{this.completionParticipants=a}}doComplete(e,t,n,r){this.offset=e.offsetAt(t),this.position=t,this.currentWord=function(e,t){let n=t-1,r=e.getText();for(;0<=n&&-1===` 	
\r":{[()]},*>+`.indexOf(r.charAt(n));)n--;return r.substring(n+1,t)}(e,this.offset),this.defaultReplaceRange=w.create(m.create(this.position.line,this.position.character-this.currentWord.length),this.position),this.textDocument=e,this.styleSheet=n,this.documentSettings=r;try{var i={isIncomplete:!1,itemDefaults:{editRange:{start:{line:t.line,character:t.character-this.currentWord.length},end:t}},items:[]};this.nodePath=Z(this.styleSheet,this.offset);for(let t=this.nodePath.length-1;0<=t;t--){let e=this.nodePath[t];if(e instanceof ce)this.getCompletionsForDeclarationProperty(e.getParent(),i);else if(e instanceof je)e.parent instanceof Ye?this.getVariableProposals(null,i):this.getCompletionsForExpression(e,i);else if(e instanceof se){var s=e.findAParent(u.ExtendsReference,u.Ruleset);if(s)if(s.type===u.ExtendsReference)this.getCompletionsForExtendsReference(s,e,i);else{let e=s;this.getCompletionsForSelector(e,e&&e.isNested(),i)}}else if(e instanceof pe)this.getCompletionsForFunctionArgument(e,e.getParent(),i);else if(e instanceof ne)this.getCompletionsForDeclarations(e,i);else if(e instanceof Xe)this.getCompletionsForVariableDeclaration(e,i);else if(e instanceof re)this.getCompletionsForRuleSet(e,i);else if(e instanceof Ye)this.getCompletionsForInterpolation(e,i);else if(e instanceof ve)this.getCompletionsForFunctionDeclaration(e,i);else if(e instanceof nt)this.getCompletionsForMixinReference(e,i);else if(e instanceof de)this.getCompletionsForFunctionArgument(null,e,i);else if(e instanceof Re)this.getCompletionsForSupports(e,i);else if(e instanceof $e)this.getCompletionsForSupportsCondition(e,i);else if(e instanceof Ze)this.getCompletionsForExtendsReference(e,null,i);else if(e.type===u.URILiteral)this.getCompletionForUriLiteralValue(e,i);else if(null===e.parent)this.getCompletionForTopLevel(i);else{if(e.type!==u.StringLiteral||!this.isImportPathParent(e.parent.type))continue;this.getCompletionForImportPath(e,i)}if(0<i.items.length||this.offset>e.offset)return this.finalize(i)}return this.getCompletionsForStylesheet(i),0===i.items.length&&this.variablePrefix&&0===this.currentWord.indexOf(this.variablePrefix)&&this.getVariableProposals(null,i),this.finalize(i)}finally{this.position=null,this.currentWord=null,this.textDocument=null,this.styleSheet=null,this.symbolContext=null,this.defaultReplaceRange=null,this.nodePath=null}}isImportPathParent(e){return e===u.Import}finalize(e){return e}findInNodePath(...t){for(let e=this.nodePath.length-1;0<=e;e--){var n=this.nodePath[e];if(-1!==t.indexOf(n.type))return n}return null}getCompletionsForDeclarationProperty(e,t){return this.getPropertyProposals(e,t)}getPropertyProposals(a,o){let l=this.isTriggerPropertyValueCompletionEnabled,c=this.isCompletePropertyWithSemicolonEnabled;return this.cssDataManager.getProperties().forEach(e=>{let t,n,r=!1,i=(a?(t=this.getCompletionRange(a.getProperty()),n=e.name,E(a.colonPosition)||(n+=": ",r=!0)):(t=this.getCompletionRange(null),n=e.name+": ",r=!0),!a&&c&&(n+="$0;"),a&&!a.semicolonPosition&&c&&this.offset>=this.textDocument.offsetAt(t.end)&&(n+="$0;"),{label:e.name,documentation:nn(e,this.doesSupportMarkdown()),tags:ur(e)?[Rt.Deprecated]:[],textEdit:S.replace(t,n),insertTextFormat:g.Snippet,kind:C.Property});e.restrictions||(r=!1),l&&r&&(i.command=pr);var s=(255-("number"==typeof e.relevance?Math.min(Math.max(e.relevance,0),99):50)).toString(16),e=v(e.name,"-")?I.VendorPrefixed:I.Normal;i.sortText=e+"_"+s,o.items.push(i)}),this.completionParticipants.forEach(e=>{e.onCssProperty&&e.onCssProperty({propertyName:this.currentWord,range:this.defaultReplaceRange})}),o}get isTriggerPropertyValueCompletionEnabled(){return this.documentSettings?.triggerPropertyValueCompletion??!0}get isCompletePropertyWithSemicolonEnabled(){return this.documentSettings?.completePropertyWithSemicolon??!0}getCompletionsForDeclarationValue(t,n){let r=t.getFullPropertyName(),e=this.cssDataManager.getProperty(r),i=t.getValue()||null;for(;i&&i.hasChildren();)i=i.findChildAtOffset(this.offset,!1);if(this.completionParticipants.forEach(e=>{e.onCssPropertyValue&&e.onCssPropertyValue({propertyName:r,propertyValue:this.currentWord,range:this.getCompletionRange(i)})}),e){if(e.restrictions)for(var s of e.restrictions)switch(s){case"color":this.getColorProposals(e,i,n);break;case"position":this.getPositionProposals(e,i,n);break;case"repeat":this.getRepeatStyleProposals(e,i,n);break;case"line-style":this.getLineStyleProposals(e,i,n);break;case"line-width":this.getLineWidthProposals(e,i,n);break;case"geometry-box":this.getGeometryBoxProposals(e,i,n);break;case"box":this.getBoxProposals(e,i,n);break;case"image":this.getImageProposals(e,i,n);break;case"timing-function":this.getTimingFunctionProposals(e,i,n);break;case"shape":this.getBasicShapeProposals(e,i,n)}this.getValueEnumProposals(e,i,n),this.getCSSWideKeywordProposals(e,i,n),this.getUnitProposals(e,i,n)}else{let e=function(e,n){let r=n.getFullPropertyName(),t=new fr;function i(e){return(e instanceof c||e instanceof He||e instanceof Ge)&&t.add(e.getText()),!0}return e.accept(function(t){if(t instanceof y&&t!==n&&(e=(e=t).getFullPropertyName(),r===e)){let e=t.getValue();e&&e.accept(i)}var e;return!0}),t}(this.styleSheet,t);for(var a of e.getEntries())n.items.push({label:a,textEdit:S.replace(this.getCompletionRange(i),a),kind:C.Value})}return this.getVariableProposals(i,n),this.getTermProposals(e,i,n),n}getValueEnumProposals(r,i,s){if(r.values)for(var a of r.values){let e=a.name,t;!H(e,")")||-1!==(o=e.lastIndexOf("("))&&(e=e.substring(0,o+1)+"$1"+e.substring(o+1),t=hr);let n=I.Enums;v(a.name,"-")&&(n+=I.VendorPrefixed);var o={label:a.name,documentation:nn(a,this.doesSupportMarkdown()),tags:ur(r)?[Rt.Deprecated]:[],textEdit:S.replace(this.getCompletionRange(i),e),sortText:n,kind:C.Value,insertTextFormat:t};s.items.push(o)}return s}getCSSWideKeywordProposals(e,t,n){for(var r in En)n.items.push({label:r,documentation:En[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});for(var i in _n){var s=gr(i);n.items.push({label:i,documentation:_n[i],textEdit:S.replace(this.getCompletionRange(t),s),kind:C.Function,insertTextFormat:hr,command:v(i,"var")?pr:void 0})}return n}getCompletionsForInterpolation(e,t){return this.offset>=e.offset+2&&this.getVariableProposals(null,t),t}getVariableProposals(n,r){var i;for(i of this.getSymbolContext().findSymbolsAtOffset(this.offset,o.Variable)){let e=v(i.name,"--")?`var(${i.name})`:i.name,t={label:i.name,documentation:i.value&&X(i.value),textEdit:S.replace(this.getCompletionRange(n),e),kind:C.Variable,sortText:I.Variable};if("string"==typeof t.documentation&&fn(t.documentation)&&(t.kind=C.Color),i.node.type===u.FunctionParameter){let e=i.node.getParent();e.type===u.MixinDeclaration&&(t.detail=x("argument from '{0}'",e.getName()))}r.items.push(t)}return r}getVariableProposalsForCSSVarFunction(t){let e=new fr;var n,r,i;this.styleSheet.acceptVisitor(new vr(e,this.offset));for(n of this.getSymbolContext().findSymbolsAtOffset(this.offset,o.Variable)){if(v(n.name,"--")){let e={label:n.name,documentation:n.value&&X(n.value),textEdit:S.replace(this.getCompletionRange(null),n.name),kind:C.Variable};"string"==typeof e.documentation&&fn(e.documentation)&&(e.kind=C.Color),t.items.push(e)}e.remove(n.name)}for(r of e.getEntries())v(r,"--")&&(i={label:r,textEdit:S.replace(this.getCompletionRange(null),r),kind:C.Variable},t.items.push(i));return t}getUnitProposals(e,t,n){let r="0";var i;if(0<this.currentWord.length?(i=this.currentWord.match(/^-?\d[\.\d+]*/))&&(r=i[0],n.isIncomplete=r.length===this.currentWord.length):0===this.currentWord.length&&(n.isIncomplete=!0),t&&t.parent&&t.parent.type===u.Term&&(t=t.getParent()),e.restrictions)for(var s of e.restrictions){s=Rn[s];if(s)for(var a of s){a=r+a;n.items.push({label:a,textEdit:S.replace(this.getCompletionRange(t),a),kind:C.Unit})}}return n}getCompletionRange(e){if(e&&e.offset<=this.offset&&this.offset<=e.end){var t=-1!==e.end?this.textDocument.positionAt(e.end):this.position,e=this.textDocument.positionAt(e.offset);if(e.line===t.line)return w.create(e,t)}return this.defaultReplaceRange}getColorProposals(e,t,n){for(var r in cn)n.items.push({label:r,documentation:cn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Color});for(var i in hn)n.items.push({label:i,documentation:hn[i],textEdit:S.replace(this.getCompletionRange(t),i),kind:C.Value});let s=new fr;this.styleSheet.acceptVisitor(new br(s,this.offset));for(var a of s.getEntries())n.items.push({label:a,textEdit:S.replace(this.getCompletionRange(t),a),kind:C.Color});for(var o of on)n.items.push({label:o.label,detail:o.func,documentation:o.desc,textEdit:S.replace(this.getCompletionRange(t),o.insertText),insertTextFormat:hr,kind:C.Function});return n}getPositionProposals(e,t,n){for(var r in yn)n.items.push({label:r,documentation:yn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getRepeatStyleProposals(e,t,n){for(var r in xn)n.items.push({label:r,documentation:xn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getLineStyleProposals(e,t,n){for(var r in Sn)n.items.push({label:r,documentation:Sn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getLineWidthProposals(e,t,n){for(var r of Cn)n.items.push({label:r,textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getGeometryBoxProposals(e,t,n){for(var r in Fn)n.items.push({label:r,documentation:Fn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getBoxProposals(e,t,n){for(var r in kn)n.items.push({label:r,documentation:kn[r],textEdit:S.replace(this.getCompletionRange(t),r),kind:C.Value});return n}getImageProposals(e,t,n){for(var r in In){var i=gr(r);n.items.push({label:r,documentation:In[r],textEdit:S.replace(this.getCompletionRange(t),i),kind:C.Function,insertTextFormat:r!==i?hr:void 0})}return n}getTimingFunctionProposals(e,t,n){for(var r in zn){var i=gr(r);n.items.push({label:r,documentation:zn[r],textEdit:S.replace(this.getCompletionRange(t),i),kind:C.Function,insertTextFormat:r!==i?hr:void 0})}return n}getBasicShapeProposals(e,t,n){for(var r in Dn){var i=gr(r);n.items.push({label:r,documentation:Dn[r],textEdit:S.replace(this.getCompletionRange(t),i),kind:C.Function,insertTextFormat:r!==i?hr:void 0})}return n}getCompletionsForStylesheet(e){var t=this.styleSheet.findFirstChildBeforeOffset(this.offset);return t?t instanceof re?this.getCompletionsForRuleSet(t,e):t instanceof Re?this.getCompletionsForSupports(t,e):e:this.getCompletionForTopLevel(e)}getCompletionForTopLevel(t){return this.cssDataManager.getAtDirectives().forEach(e=>{t.items.push({label:e.name,textEdit:S.replace(this.getCompletionRange(null),e.name),documentation:nn(e,this.doesSupportMarkdown()),tags:ur(e)?[Rt.Deprecated]:[],kind:C.Keyword})}),this.getCompletionsForSelector(null,!1,t),t}getCompletionsForRuleSet(e,t){let n=e.getDeclarations();return n&&n.endsWith("}")&&this.offset>=n.end?this.getCompletionForTopLevel(t):!n||this.offset<=n.offset?this.getCompletionsForSelector(e,e.isNested(),t):this.getCompletionsForDeclarations(e.getDeclarations(),t)}getCompletionsForSelector(e,t,r){let i=this.findInNodePath(u.PseudoSelector,u.IdentifierSelector,u.ClassSelector,u.ElementNameSelector);if(!i&&this.hasCharacterAtPosition(this.offset-this.currentWord.length-1,":")&&(this.currentWord=":"+this.currentWord,this.hasCharacterAtPosition(this.offset-this.currentWord.length-1,":")&&(this.currentWord=":"+this.currentWord),this.defaultReplaceRange=w.create(m.create(this.position.line,this.position.character-this.currentWord.length),this.position)),this.cssDataManager.getPseudoClasses().forEach(e=>{let t=gr(e.name),n={label:e.name,textEdit:S.replace(this.getCompletionRange(i),t),documentation:nn(e,this.doesSupportMarkdown()),tags:ur(e)?[Rt.Deprecated]:[],kind:C.Function,insertTextFormat:e.name!==t?hr:void 0};v(e.name,":-")&&(n.sortText=I.VendorPrefixed),r.items.push(n)}),this.cssDataManager.getPseudoElements().forEach(e=>{let t=gr(e.name),n={label:e.name,textEdit:S.replace(this.getCompletionRange(i),t),documentation:nn(e,this.doesSupportMarkdown()),tags:ur(e)?[Rt.Deprecated]:[],kind:C.Function,insertTextFormat:e.name!==t?hr:void 0};v(e.name,"::-")&&(n.sortText=I.VendorPrefixed),r.items.push(n)}),!t){for(var n of Tn)r.items.push({label:n,textEdit:S.replace(this.getCompletionRange(i),n),kind:C.Keyword});for(var s of Mn)r.items.push({label:s,textEdit:S.replace(this.getCompletionRange(i),s),kind:C.Keyword})}let a={},o=(a[this.currentWord]=!0,this.textDocument.getText());return this.styleSheet.accept(t=>{if(t.type===u.SimpleSelector&&0<t.length){let e=o.substr(t.offset,t.length);return"."!==e.charAt(0)||a[e]||(a[e]=!0,r.items.push({label:e,textEdit:S.replace(this.getCompletionRange(i),e),kind:C.Keyword})),!1}return!0}),e&&e.isNested()&&(t=e.getSelectors().findFirstChildBeforeOffset(this.offset))&&0===e.getSelectors().getChildren().indexOf(t)&&this.getPropertyProposals(null,r),r}getCompletionsForDeclarations(e,t){if(!e||this.offset===e.offset)return t;e=e.findFirstChildBeforeOffset(this.offset);if(!e)return this.getCompletionsForDeclarationProperty(null,t);if(e instanceof ae){var n=e;if(!E(n.colonPosition)||this.offset<=n.colonPosition)return this.getCompletionsForDeclarationProperty(n,t);if(E(n.semicolonPosition)&&n.semicolonPosition<this.offset)return this.offset===n.semicolonPosition+1?t:this.getCompletionsForDeclarationProperty(null,t);if(n instanceof y)return this.getCompletionsForDeclarationValue(n,t)}else e instanceof Ze?this.getCompletionsForExtendsReference(e,null,t):(this.currentWord&&"@"===this.currentWord[0]||e instanceof re)&&this.getCompletionsForDeclarationProperty(null,t);return t}getCompletionsForVariableDeclaration(e,t){return this.offset&&E(e.colonPosition)&&this.offset>e.colonPosition&&this.getVariableProposals(e.getValue()||null,t),t}getCompletionsForExpression(e,t){let n=e.getParent();if(n instanceof pe)return this.getCompletionsForFunctionArgument(n,n.getParent(),t),t;var r=e.findParent(u.Declaration);if(!r)return this.getTermProposals(void 0,null,t),t;e=e.findChildAtOffset(this.offset,!0);return!e||e instanceof He||e instanceof c?this.getCompletionsForDeclarationValue(r,t):t}getCompletionsForFunctionArgument(e,t,n){let r=t.getIdentifier();return!r||!r.matches("var")||t.getArguments().hasChildren()&&t.getArguments().getChild(0)!==e||this.getVariableProposalsForCSSVarFunction(n),n}getCompletionsForFunctionDeclaration(e,t){e=e.getDeclarations();return e&&this.offset>e.offset&&this.offset<e.end&&this.getTermProposals(void 0,null,t),t}getCompletionsForMixinReference(e,t){var n;for(n of this.getSymbolContext().findSymbolsAtOffset(this.offset,o.Mixin))n.node instanceof rt&&t.items.push(this.makeTermProposal(n,n.node.getParameters(),null));let r=e.getIdentifier()||null;return this.completionParticipants.forEach(e=>{e.onCssMixinReference&&e.onCssMixinReference({mixinName:this.currentWord,range:this.getCompletionRange(r)})}),t}getTermProposals(e,t,n){var r;for(r of this.getSymbolContext().findSymbolsAtOffset(this.offset,o.Function))r.node instanceof ve&&n.items.push(this.makeTermProposal(r,r.node.getParameters(),t));return n}makeTermProposal(e,t,n){e.node;let r=t.getChildren().map(e=>e instanceof he?e.getName():e.getText()),i=e.name+"("+r.map((e,t)=>"${"+(t+1)+":"+e+"}").join(", ")+")";return{label:e.name,detail:e.name+"("+r.join(", ")+")",textEdit:S.replace(this.getCompletionRange(n),i),insertTextFormat:hr,kind:C.Function,sortText:I.Term}}getCompletionsForSupportsCondition(e,t){var n=e.findFirstChildBeforeOffset(this.offset);if(n){if(n instanceof y)return!E(n.colonPosition)||this.offset<=n.colonPosition?this.getCompletionsForDeclarationProperty(n,t):this.getCompletionsForDeclarationValue(n,t);if(n instanceof $e)return this.getCompletionsForSupportsCondition(n,t)}return E(e.lParent)&&this.offset>e.lParent&&(!E(e.rParent)||this.offset<=e.rParent)?this.getCompletionsForDeclarationProperty(null,t):t}getCompletionsForSupports(e,t){var n=e.getDeclarations();return!n||this.offset<=n.offset?(n=e.findFirstChildBeforeOffset(this.offset))instanceof $e?this.getCompletionsForSupportsCondition(n,t):t:this.getCompletionForTopLevel(t)}getCompletionsForExtendsReference(e,t,n){return n}getCompletionForUriLiteralValue(t,e){let n,r,i;if(t.hasChildren()){let e=t.getChild(0);n=e.getText(),r=this.position,i=this.getCompletionRange(e)}else{n="",r=this.position;t=this.textDocument.positionAt(t.offset+4);i=w.create(t,t)}return this.completionParticipants.forEach(e=>{e.onCssURILiteralValue&&e.onCssURILiteralValue({uriValue:n,position:r,range:i})}),e}getCompletionForImportPath(t,e){return this.completionParticipants.forEach(e=>{e.onCssImportPath&&e.onCssImportPath({pathValue:t.getText(),position:this.position,range:this.getCompletionRange(t)})}),e}hasCharacterAtPosition(e,t){let n=this.textDocument.getText();return 0<=e&&e<n.length&&n.charAt(e)===t}doesSupportMarkdown(){if(!E(this.supportsMarkdown)){if(!E(this.lsOptions.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;let e=this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;this.supportsMarkdown=Array.isArray(e)&&-1!==e.indexOf(f.Markdown)}return this.supportsMarkdown}});function ur(e){return e.status&&("nonstandard"===e.status||"obsolete"===e.status)}var fr=class{constructor(){this.entries={}}add(e){this.entries[e]=!0}remove(e){delete this.entries[e]}getEntries(){return Object.keys(this.entries)}};function gr(e){return e.replace(/\(\)$/,"($1)")}var br=class{constructor(e,t){this.entries=e,this.currentOffset=t}visitNode(e){return(e instanceof Ge||e instanceof de&&((t=(t=e).getName())&&ln.test(t)))&&(this.currentOffset<e.offset||e.end<this.currentOffset)&&this.entries.add(e.getText()),!0;var t}},vr=class{constructor(e,t){this.entries=e,this.currentOffset=t}visitNode(e){return e instanceof c&&e.isCustomProperty&&(this.currentOffset<e.offset||e.end<this.currentOffset)&&this.entries.add(e.getText()),!0}};var wr,r,yr=class Ki{constructor(){this.parent=null,this.children=null,this.attributes=null}findAttribute(e){if(this.attributes)for(var t of this.attributes)if(t.name===e)return t.value;return null}addChild(e){e instanceof Ki&&(e.parent=this),this.children||(this.children=[]),this.children.push(e)}append(t){if(this.attributes){let e=this.attributes[this.attributes.length-1];e.value=e.value+t}}prepend(t){if(this.attributes){let e=this.attributes[0];e.value=t+e.value}}findRoot(){let e=this;for(;e.parent&&!(e.parent instanceof xr);)e=e.parent;return e}removeChild(e){if(this.children){e=this.children.indexOf(e);if(-1!==e)return this.children.splice(e,1),!0}return!1}addAttr(e,t){this.attributes||(this.attributes=[]);for(var n of this.attributes)if(n.name===e)return void(n.value+=" "+t);this.attributes.push({name:e,value:t})}clone(e=!0){let t=new Ki;if(this.attributes){t.attributes=[];for(var n of this.attributes)t.addAttr(n.name,n.value)}if(e&&this.children){t.children=[];for(let e=0;e<this.children.length;e++)t.addChild(this.children[e].clone())}return t}cloneWithParent(){var e=this.clone(!1);return!this.parent||this.parent instanceof xr||this.parent.cloneWithParent().addChild(e),e}},xr=class extends yr{},Sr=class extends yr{constructor(e){super(),this.addAttr("name",e)}},Cr=class{constructor(e){this.quote=e,this.result=[]}print(e,t){this.result=[],e instanceof xr?e.children&&this.doPrint(e.children,0):this.doPrint([e],0);let n;return[{language:"html",value:n=t?t.text+`
 … `+this.result.join(`
`):this.result.join(`
`)}]}doPrint(e,t){for(var n of e)this.doPrintElement(n,t),n.children&&this.doPrint(n.children,t+1)}writeLine(e,t){e=new Array(e+1).join("  ");this.result.push(e+t)}doPrintElement(t,n){var r=t.findAttribute("name");if(t instanceof Sr||"…"===r)this.writeLine(n,r);else{let e=["<"];if(r?e.push(r):e.push("element"),t.attributes)for(var i of t.attributes)"name"!==i.name&&(e.push(" "),e.push(i.name),(i=i.value)&&(e.push("="),e.push(wr.ensure(i,this.quote))));e.push(">"),this.writeLine(n,e.join(""))}}};function kr(e){var t=e.match(/^['"](.*)["']$/);return t?t[1]:e}(r=wr=wr||{}).ensure=function(e,t){return t+kr(e)+t},r.remove=kr;var Fr=class{constructor(){this.id=0,this.attr=0,this.tag=0}};function Er(e,t){let s=new yr;for(var n of e.getChildren())switch(n.type){case u.SelectorCombinator:if(t){var a=n.getText().split("&");if(1===a.length){s.addAttr("name",a[0]);break}s=t.cloneWithParent(),a[0]&&s.findRoot().prepend(a[0]);for(let e=1;e<a.length;e++){if(1<e){let e=t.cloneWithParent();s.addChild(e.findRoot()),s=e}s.append(a[e])}}break;case u.SelectorPlaceholder:if(n.matches("@at-root"))return s;case u.ElementNameSelector:var o=n.getText();s.addAttr("name","*"===o?"element":z(o));break;case u.ClassSelector:s.addAttr("class",z(n.getText().substring(1)));break;case u.IdentifierSelector:s.addAttr("id",z(n.getText().substring(1)));break;case u.MixinDeclaration:s.addAttr("class",n.getName());break;case u.PseudoSelector:s.addAttr(z(n.getText()),"");break;case u.AttributeSelector:let r=n,i=r.getIdentifier();if(i){let e=r.getValue(),t=r.getOperator(),n;if(e&&t)switch(z(t.getText())){case"|=":n=wr.remove(z(e.getText()))+"-…";break;case"^=":n=wr.remove(z(e.getText()))+"…";break;case"$=":n="…"+wr.remove(z(e.getText()));break;case"~=":n=` … ${wr.remove(z(e.getText()))} … `;break;case"*=":n=`…${wr.remove(z(e.getText()))}…`;break;default:n=wr.remove(z(e.getText()))}s.addAttr(z(i.getText()),n)}}return s}function z(e){let t=new J;t.setSource(e);var n=t.scanUnquotedString();return n?n.text:e}var _r=class{constructor(e){this.cssDataManager=e}selectorToMarkedString(t,n){var r=function(e){if(e.matches("@at-root"))return null;let t=new xr,n=[],r=e.getParent();if(r instanceof re){let e=r.getParent();for(;e&&!function(e){switch(e.type){case u.MixinDeclaration:case u.Stylesheet:return 1}return}(e);){if(e instanceof re){if(e.getSelectors().matches("@at-root"))break;n.push(e)}e=e.getParent()}}let i=new Ir(t);for(let e=n.length-1;0<=e;e--){var s=n[e].getSelectors().getChild(0);s&&i.processSelector(s)}return i.processSelector(e),t}(t);if(r){let e=new Cr('"').print(r,n);return e.push(this.selectorToSpecificityMarkedString(t)),e}return[]}simpleSelectorToMarkedString(e){let t=Er(e),n=new Cr('"').print(t);return n.push(this.selectorToSpecificityMarkedString(e)),n}isPseudoElementIdentifier(e){e=e.match(/^::?([\w-]+)/);return!!e&&!!this.cssDataManager.getPseudoElement("::"+e[1])}selectorToSpecificityMarkedString(e){let c=e=>{let t=new Fr,n=new Fr;for(var r of e)for(var i of r.getChildren()){i=d(i);i.id>n.id?n=i:i.id<n.id||(i.attr>n.attr?n=i:i.attr<n.attr||i.tag>n.tag&&(n=i))}return t.id+=n.id,t.attr+=n.attr,t.tag+=n.tag,t},d=e=>{let i=new Fr;for(var n of e.getChildren()){switch(n.type){case u.IdentifierSelector:i.id++;break;case u.ClassSelector:case u.AttributeSelector:i.attr++;break;case u.ElementNameSelector:if(n.matches("*"))break;i.tag++;break;case u.PseudoSelector:let e=n.getText(),t=n.getChildren();if(this.isPseudoElementIdentifier(e)){if(e.match(/^::slotted/i)&&0<t.length){i.tag++;var r=c(t);i.id+=r.id,i.attr+=r.attr,i.tag+=r.tag;continue}i.tag++;continue}if(e.match(/^:where/i))continue;if(e.match(/^:(?:not|has|is)/i)&&0<t.length){r=c(t);i.id+=r.id,i.attr+=r.attr,i.tag+=r.tag;continue}if(e.match(/^:(?:host|host-context)/i)&&0<t.length){i.attr++;var s=c(t);i.id+=s.id,i.attr+=s.attr,i.tag+=s.tag;continue}if(e.match(/^:(?:nth-child|nth-last-child)/i)&&0<t.length){if(i.attr++,3===t.length&&23===t[1].type){s=c(t[2].getChildren());i.id+=s.id,i.attr+=s.attr,i.tag+=s.tag;continue}let n=new Pn,r=t[1].getText();n.scanner.setSource(r);var a=n.scanner.scan(),o=n.scanner.scan();if("n"===a.text||"-n"===a.text&&"of"===o.text){let e=[],t=r.slice(o.offset+2).split(",");for(var l of t){l=n.internalParse(l,n._parseSelector);l&&e.push(l)}a=c(e);i.id+=a.id,i.attr+=a.attr,i.tag+=a.tag;continue}continue}i.attr++;continue}var t;0<n.getChildren().length&&(t=d(n),i.id+=t.id,i.attr+=t.attr,i.tag+=t.tag)}return i},t=d(e);return`[${x("Selector Specificity")}](https://developer.mozilla.org/docs/Web/CSS/Specificity): (${t.id}, ${t.attr}, ${t.tag})`}},Ir=class{constructor(e){this.prev=null,this.element=e}processSelector(e){let n=null;var t,r,i;this.element instanceof xr||!e.getChildren().some(e=>e.hasChildren()&&e.getChild(0).type===u.SelectorCombinator)||(t=this.element.findRoot()).parent instanceof xr&&(n=this.element,this.element=t.parent,this.element.removeChild(t),this.prev=null);for(r of e.getChildren()){if(r instanceof se){this.prev instanceof se?(i=new Sr("…"),this.element.addChild(i),this.element=i):this.prev&&(this.prev.matches("+")||this.prev.matches("~"))&&this.element.parent&&(this.element=this.element.parent),this.prev&&this.prev.matches("~")&&this.element.addChild(new Sr("⋮"));let e=Er(r,n),t=e.findRoot();this.element.addChild(t),this.element=e}(r instanceof se||r.type===u.SelectorCombinatorParent||r.type===u.SelectorCombinatorShadowPiercingDescendant||r.type===u.SelectorCombinatorSibling||r.type===u.SelectorCombinatorAllSiblings)&&(this.prev=r)}}};var zr=class{constructor(e,t){this.clientCapabilities=e,this.cssDataManager=t,this.selectorPrinting=new _r(t)}configure(e){this.defaultSettings=e}doHover(t,e,n,r=this.defaultSettings){function i(e){return w.create(t.positionAt(e.offset),t.positionAt(e.end))}let s=t.offsetAt(e),a=Z(n,s),o=null,l;for(let e=0;e<a.length;e++){let n=a[e];if(n instanceof De&&(c=/@media[^\{]+/g,l={isMedia:!0,text:n.getText().match(c)?.[0]}),n instanceof ie){o={contents:this.selectorPrinting.selectorToMarkedString(n,l),range:i(n)};break}if(n instanceof se){v(n.getText(),"@")||(o={contents:this.selectorPrinting.simpleSelectorToMarkedString(n),range:i(n)});break}if(n instanceof y){var c=n.getFullPropertyName(),d=this.cssDataManager.getProperty(c);d&&(d=nn(d,this.doesSupportMarkdown(),r),o=d?{contents:d,range:i(n)}:null)}else if(n instanceof it){var d=n.getText(),h=this.cssDataManager.getAtDirective(d);h&&(h=nn(h,this.doesSupportMarkdown(),r),o=h?{contents:h,range:i(n)}:null)}else if(n instanceof p&&n.type===u.PseudoSelector){let e=n.getText(),t="::"===e.slice(0,2)?this.cssDataManager.getPseudoElement(e):this.cssDataManager.getPseudoClass(e);t&&(h=nn(t,this.doesSupportMarkdown(),r),o=h?{contents:h,range:i(n)}:null)}}return o&&(o.contents=this.convertContents(o.contents)),o}convertContents(e){return this.doesSupportMarkdown()||"string"==typeof e?e:"kind"in e?{kind:"plaintext",value:e.value}:Array.isArray(e)?e.map(e=>"string"==typeof e?e:e.value):e.value}doesSupportMarkdown(){if(!E(this.supportsMarkdown)){if(!E(this.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;let e=this.clientCapabilities.textDocument&&this.clientCapabilities.textDocument.hover;this.supportsMarkdown=e&&e.contentFormat&&Array.isArray(e.contentFormat)&&-1!==e.contentFormat.indexOf(f.Markdown)}return this.supportsMarkdown}},Dr=/^\w+:\/\//,Rr=/^data:/,Tr=class{constructor(e,t){this.fileSystemProvider=e,this.resolveModuleReferences=t}configure(e){this.defaultSettings=e}findDefinition(e,t,n){let r=new jn(n),i=e.offsetAt(t),s=Q(n,i);if(!s)return null;t=r.findSymbolFromNode(s);return t?{uri:e.uri,range:Mr(t.node,e)}:null}findReferences(t,e,n){return this.findDocumentHighlights(t,e,n).map(e=>({uri:t.uri,range:e.range}))}getHighlightNode(e,t,n){let r=e.offsetAt(t),i=Q(n,r);if(i&&i.type!==u.Stylesheet&&i.type!==u.Declarations)return i=i.type===u.Identifier&&i.parent&&i.parent.type===u.ClassSelector?i.parent:i}findDocumentHighlights(t,e,n){let r=[],i=this.getHighlightNode(t,e,n);if(!i)return r;let s=new jn(n),a=s.findSymbolFromNode(i),o=i.getText();return n.accept(e=>{if(a){if(s.matchesSymbol(e,a))return r.push({kind:Or(e),range:Mr(e,t)}),!1}else i&&i.type===e.type&&e.matches(o)&&r.push({kind:Or(e),range:Mr(e,t)});return!0}),r}isRawStringDocumentLinkNode(e){return e.type===u.Import}findDocumentLinks(n,e,r){let t=this.findUnresolvedLinks(n,e),i=[];for(var s of t){let e=s.link,t=e.target;t&&!Rr.test(t)&&(Dr.test(t)||(s=r.resolveReference(t,n.uri))&&(e.target=s),i.push(e))}return i}async findDocumentLinks2(n,e,r){let t=this.findUnresolvedLinks(n,e),i=[];for(var s of t){let e=s.link,t=e.target;t&&!Rr.test(t)&&(Dr.test(t)?i.push(e):void 0!==(s=await this.resolveReference(t,n.uri,r,s.isRawLink))&&(e.target=s,i.push(e)))}return i}findUnresolvedLinks(r,e){let i=[],n=e=>{let t=e.getText(),n=Mr(e,r);n.start.line===n.end.line&&n.start.character===n.end.character||((v(t,"'")||v(t,'"'))&&(t=t.slice(1,-1)),e=!!e.parent&&this.isRawStringDocumentLinkNode(e.parent),i.push({link:{target:t,range:n},isRawLink:e}))};return e.accept(e=>{var t;return e.type===u.URILiteral?((t=e.getChild(0))&&n(t),!1):!e.parent||!this.isRawStringDocumentLinkNode(e.parent)||((v(t=e.getText(),"'")||v(t,'"'))&&n(e),!1)}),i}findSymbolInformations(r,e){let i=[];return this.collectDocumentSymbols(r,e,(e,t,n)=>{n=n instanceof p?Mr(n,r):n,e={name:e||x("<undefined>"),kind:t,location:gt.create(r.uri,n)};i.push(e)}),i}findDocumentSymbols(c,e){let d=[],h=[];return this.collectDocumentSymbols(c,e,(e,t,n,r,i)=>{let s=n instanceof p?Mr(n,c):n,a=r instanceof p?Mr(r,c):r,o=(a&&Nr(s,a)||(a=w.create(s.start,s.start)),{name:e||x("<undefined>"),kind:t,range:s,selectionRange:a}),l=h.pop();for(;l&&!Nr(l[1],s);)l=h.pop();if(l){let e=l[0];e.children||(e.children=[]),e.children.push(o),h.push(l)}else d.push(o);i&&h.push([o,Mr(i,c)])}),d}collectDocumentSymbols(i,e,s){e.accept(t=>{if(t instanceof re)for(var e of t.getSelectors().getChildren()){var n;e instanceof ie&&(n=w.create(i.positionAt(e.offset),i.positionAt(t.end)),s(e.getText(),b.Class,n,e,t.getDeclarations()))}else if(t instanceof Xe)s(t.getName(),b.Variable,t,t.getVariable(),void 0);else if(t instanceof rt)s(t.getName(),b.Method,t,t.getIdentifier(),t.getDeclarations());else if(t instanceof ve)s(t.getName(),b.Function,t,t.getIdentifier(),t.getDeclarations());else if(t instanceof Se){var r=x("@keyframes {0}",t.getName());s(r,b.Class,t,t.getIdentifier(),t.getDeclarations())}else if(t instanceof ye){r=x("@font-face");s(r,b.Class,t,void 0,t.getDeclarations())}else if(t instanceof De){let e=t.getChild(0);e instanceof Pe&&(r="@media "+e.getText(),s(r,b.Module,t,e,t.getDeclarations()))}return!0})}findDocumentColors(t,e){let n=[];return e.accept(e=>{e=function(e,t){var n=wn(e);if(n)return e=Mr(e,t),{color:n,range:e};return null}(e,t);return e&&n.push(e),!0}),n}getColorPresentations(e,t,n,r){let i=[],s=Math.round(255*n.red),a=Math.round(255*n.green),o=Math.round(255*n.blue),l;l=1===n.alpha?`rgb(${s}, ${a}, ${o})`:`rgba(${s}, ${a}, ${o}, ${n.alpha})`,i.push({label:l,textEdit:S.replace(r,l)}),l=1===n.alpha?"#"+Pr(s)+Pr(a)+Pr(o):"#"+Pr(s)+Pr(a)+Pr(o)+Pr(Math.round(255*n.alpha)),i.push({label:l,textEdit:S.replace(r,l)});var c=vn(n),d=(l=1===c.a?`hsl(${c.h}, ${Math.round(100*c.s)}%, ${Math.round(100*c.l)}%)`:`hsla(${c.h}, ${Math.round(100*c.s)}%, ${Math.round(100*c.l)}%, ${c.a})`,i.push({label:l,textEdit:S.replace(r,l)}),n=vn(c=n),d=Math.min(c.red,c.green,c.blue),c=1-Math.max(c.red,c.green,c.blue),{h:n.h,w:d,b:c,a:n.a});return l=1===d.a?`hwb(${d.h} ${Math.round(100*d.w)}% ${Math.round(100*d.b)}%)`:`hwb(${d.h} ${Math.round(100*d.w)}% ${Math.round(100*d.b)}% / ${d.a})`,i.push({label:l,textEdit:S.replace(r,l)}),i}prepareRename(e,t,n){t=this.getHighlightNode(e,t,n);if(t)return w.create(e.positionAt(t.offset),e.positionAt(t.end))}doRename(e,t,n,r){t=this.findDocumentHighlights(e,t,r).map(e=>S.replace(e.range,n));return{changes:{[e.uri]:t}}}async resolveModuleReference(e,t,n){if(v(t,"file://")){var r=function(e){var t=e.indexOf("/");if(-1===t)return"";if("@"!==e[0])return e.substring(0,t);{t=e.indexOf("/",t+1);return-1===t?e:e.substring(0,t)}}(e);if(r&&"."!==r&&".."!==r){n=n.resolveReference("/",t),t=rr(t),t=await this.resolvePathToModule(r,t,n);if(t)return ir(t,e.substring(r.length+1))}}}async mapReference(e,t){return e}async resolveReference(e,t,n,r=!1,i=this.defaultSettings){if("~"===e[0]&&"/"!==e[1]&&this.fileSystemProvider)return e=e.substring(1),this.mapReference(await this.resolveModuleReference(e,t,n),r);var s=await this.mapReference(n.resolveReference(e,t),r);if(this.resolveModuleReferences){if(s&&await this.fileExists(s))return s;var a=await this.mapReference(await this.resolveModuleReference(e,t,n),r);if(a)return a}if(s&&!await this.fileExists(s)){a=n.resolveReference("/",t);if(i&&a){if(e in i)return this.mapReference(ir(a,i[e]),r);var n=e.indexOf("/"),t=e.substring(0,n)+"/";if(t in i)return n=ir(a,i[t].slice(0,-1)),this.mapReference(n=ir(n,e.substring(t.length-1)),r)}}return s}async resolvePathToModule(e,t,n){var r=ir(t,"node_modules",e,"package.json");return await this.fileExists(r)?rr(r):n&&t.startsWith(n)&&t.length!==n.length?this.resolvePathToModule(e,rr(t),n):void 0}async fileExists(e){if(!this.fileSystemProvider)return!1;try{var t=await this.fileSystemProvider.stat(e);return!(t.type===Jt.Unknown&&-1===t.size)}catch{return!1}}};function Mr(e,t){return w.create(t.positionAt(e.offset),t.positionAt(e.end))}function Nr(e,t){var n=t.start.line,r=t.end.line,i=e.start.line,s=e.end.line;return!(n<i||r<i||s<n||s<r||n===i&&t.start.character<e.start.character||r===s&&t.end.character>e.end.character)}function Or(e){if(e.type===u.Selector)return Mt.Write;if(e instanceof c&&e.parent&&e.parent instanceof ce&&e.isCustomProperty)return Mt.Write;if(e.parent)switch(e.parent.type){case u.FunctionDeclaration:case u.MixinDeclaration:case u.Keyframe:case u.VariableDeclaration:case u.FunctionParameter:return Mt.Write}return Mt.Read}function Pr(e){e=e.toString(16);return 2!==e.length?"0"+e:e}var Ar=a.Warning,Wr=a.Error,e=a.Ignore,D=class{constructor(e,t,n){this.id=e,this.message=t,this.defaultValue=n}},R={AllVendorPrefixes:new D("compatibleVendorPrefixes",x("When using a vendor-specific prefix make sure to also include all other vendor-specific properties"),e),IncludeStandardPropertyWhenUsingVendorPrefix:new D("vendorPrefix",x("When using a vendor-specific prefix also include the standard property"),Ar),DuplicateDeclarations:new D("duplicateProperties",x("Do not use duplicate style definitions"),e),EmptyRuleSet:new D("emptyRules",x("Do not use empty rulesets"),Ar),ImportStatemement:new D("importStatement",x("Import statements do not load in parallel"),e),BewareOfBoxModelSize:new D("boxModel",x("Do not use width or height when using padding or border"),e),UniversalSelector:new D("universalSelector",x("The universal selector (*) is known to be slow"),e),ZeroWithUnit:new D("zeroUnits",x("No unit for zero needed"),e),RequiredPropertiesForFontFace:new D("fontFaceProperties",x("@font-face rule must define 'src' and 'font-family' properties"),Ar),HexColorLength:new D("hexColorLength",x("Hex colors must consist of three, four, six or eight hex numbers"),Wr),ArgsInColorFunction:new D("argumentsInColorFunction",x("Invalid number of parameters"),Wr),UnknownProperty:new D("unknownProperties",x("Unknown property."),Ar),UnknownAtRules:new D("unknownAtRules",x("Unknown at-rule."),Ar),IEStarHack:new D("ieHack",x("IE hacks are only necessary when supporting IE7 and older"),e),UnknownVendorSpecificProperty:new D("unknownVendorSpecificProperties",x("Unknown vendor specific property."),e),PropertyIgnoredDueToDisplay:new D("propertyIgnoredDueToDisplay",x("Property is ignored due to the display."),Ar),AvoidImportant:new D("important",x("Avoid using !important. It is an indication that the specificity of the entire CSS has gotten out of control and needs to be refactored."),e),AvoidFloat:new D("float",x("Avoid using 'float'. Floats lead to fragile CSS that is easy to break if one aspect of the layout changes."),e),AvoidIdSelector:new D("idSelector",x("Selectors should not contain IDs because these rules are too tightly coupled with the HTML."),e)},Lr={ValidProperties:new class{constructor(e,t,n){this.id=e,this.message=t,this.defaultValue=n}}("validProperties",x("A list of properties that are not validated against the `unknownProperties` rule."),[])},$r=class{constructor(e={}){this.conf=e}getRule(e){if(this.conf.hasOwnProperty(e.id)){var t=function(e){switch(e){case"ignore":return a.Ignore;case"warning":return a.Warning;case"error":return a.Error}return null}(this.conf[e.id]);if(t)return t}return e.defaultValue}getSetting(e){return this.conf[e.id]}};var Ur=class{constructor(e){this.cssDataManager=e}doCodeActions(n,e,t,r){return this.doCodeActions2(n,e,t,r).map(e=>{var t=e.edit&&e.edit.documentChanges&&e.edit.documentChanges[0];return yt.create(e.title,"_css.applyCodeAction",n.uri,n.version,t&&t.edits)})}doCodeActions2(e,t,n,r){var i=[];if(n.diagnostics)for(var s of n.diagnostics)this.appendFixesForMarker(e,r,s,i);return i}getFixesForUnknownProperty(a,e,o,l){let n=e.getName(),r=[],c=(this.cssDataManager.getProperties().forEach(e=>{var t=function(e,t,n=4){var r=Math.abs(e.length-t.length);if(n<r)return 0;let i=[],s=[],a,o;for(a=0;a<t.length+1;++a)s.push(0);for(a=0;a<e.length+1;++a)i.push(s);for(a=1;a<e.length+1;++a)for(o=1;o<t.length+1;++o)e[a-1]===t[o-1]?i[a][o]=i[a-1][o-1]+1:i[a][o]=Math.max(i[a-1][o],i[a][o-1]);return i[e.length][t.length]-Math.sqrt(r)}(n,e.name);t>=n.length/2&&r.push({property:e.name,score:t})}),r.sort((e,t)=>t.score-e.score||e.property.localeCompare(t.property)),3);for(var d of r){let e=d.property,t=x("Rename to '{0}'",e),n=S.replace(o.range,e),r=_t.create(a.uri,a.version),i={documentChanges:[St.create(r,[n])]},s=Ot.create(t,i,Nt.QuickFix);if(s.diagnostics=[o],l.push(s),--c<=0)return}}appendFixesForMarker(n,e,r,i){if(r.code===R.UnknownProperty.id){var s=n.offsetAt(r.range.start),a=n.offsetAt(r.range.end),o=Z(e,s);for(let t=o.length-1;0<=t;t--){let e=o[t];if(e instanceof y){var l=e.getProperty();if(l&&l.offset===s&&l.end===a)return void this.getFixesForUnknownProperty(n,l,r,i)}}}}},Vr=class{constructor(e){this.fullPropertyName=e.getFullPropertyName().toLowerCase(),this.node=e}};function jr(e,t,n,r){let i=e[t];(i.value=n)&&!An(i.properties,r)&&i.properties.push(r)}function T(e,t,n,r){"top"===t||"right"===t||"bottom"===t||"left"===t?jr(e,t,n,r):(jr(t=e,"top",e=n,n=r),jr(t,"right",e,n),jr(t,"bottom",e,n),jr(t,"left",e,n))}function Br(e,t,n){switch(t.length){case 1:T(e,void 0,t[0],n);break;case 2:T(e,"top",t[0],n),T(e,"bottom",t[0],n),T(e,"right",t[1],n),T(e,"left",t[1],n);break;case 3:T(e,"top",t[0],n),T(e,"right",t[1],n),T(e,"left",t[1],n),T(e,"bottom",t[2],n);break;case 4:T(e,"top",t[0],n),T(e,"right",t[1],n),T(e,"bottom",t[2],n),T(e,"left",t[3],n)}}function qr(e,t){for(var n of t)if(e.matches(n))return 1}function Kr(e,t=!0){return(!t||!qr(e,["initial","unset"]))&&0!==parseFloat(e.getText())}function Gr(e,t=!0){return e.map(e=>Kr(e,t))}function Jr(e,t=!0){return!(qr(e,["none","hidden"])||t&&qr(e,["initial","unset"]))}function Hr(e){let t={top:{value:!1,properties:[]},right:{value:!1,properties:[]},bottom:{value:!1,properties:[]},left:{value:!1,properties:[]}};for(var n of e){let e=n.node.value;if(!("u"<typeof e))switch(n.fullPropertyName){case"box-sizing":return{top:{value:!1,properties:[]},right:{value:!1,properties:[]},bottom:{value:!1,properties:[]},left:{value:!1,properties:[]}};case"width":t.width=n;break;case"height":t.height=n;break;default:var r=n.fullPropertyName.split("-");switch(r[0]){case"border":switch(r[1]){case void 0:case"top":case"right":case"bottom":case"left":switch(r[2]){case void 0:T(t,r[1],function(e){var t,n;if(1===(e=e.getChildren()).length)return Kr(t=e[0])&&Jr(t);for(n of e){var r=n;if(!Kr(r,!1)||!Jr(r,!1))return!1}return!0}(e),n);break;case"width":T(t,r[1],Kr(e,!1),n);break;case"style":T(t,r[1],Jr(e,!0),n)}break;case"width":Br(t,Gr(e.getChildren(),!1),n);break;case"style":Br(t,function(e,t){return e.map(e=>Jr(e,t))}(e.getChildren(),!0),n)}break;case"padding":1===r.length?Br(t,Gr(e.getChildren(),!0),n):T(t,r[1],Kr(e,!0),n)}}}return t}var Xr=class{constructor(){this.data={}}add(e,t,n){let r=this.data[e];r||(r={nodes:[],names:[]},this.data[e]=r),r.names.push(t),n&&r.nodes.push(n)}},Yr=class Gi{static entries(e,t,n,r,i){let s=new Gi(t,n,r);return e.acceptVisitor(s),s.completeValidations(),s.getEntries(i)}constructor(e,t,n){this.cssDataManager=n,this.warnings=[],this.settings=t,this.documentText=e.getText(),this.keyframes=new Xr,this.validProperties={};let r=t.getSetting(Lr.ValidProperties);Array.isArray(r)&&r.forEach(e=>{"string"==typeof e&&(e=e.trim().toLowerCase()).length&&(this.validProperties[e]=!0)})}isValidPropertyDeclaration(e){e=e.fullPropertyName;return this.validProperties[e]}fetch(e,t){let n=[];for(var r of e)r.fullPropertyName===t&&n.push(r);return n}fetchWithValue(e,t,n){let r=[];for(var i of e){var s;i.fullPropertyName!==t||(s=i.node.getValue())&&this.findValueInExpression(s,n)&&r.push(i)}return r}findValueInExpression(e,t){let n=!1;return e.accept(e=>!(n=e.type===u.Identifier&&e.matches(t)?!0:n)),n}getEntries(t=a.Warning|a.Error){return this.warnings.filter(e=>0!=(e.getLevel()&t))}addEntry(e,t,n){e=new ct(e,t,this.settings.getRule(t),n);this.warnings.push(e)}getMissingNames(e,t){let n=e.slice(0);for(let e=0;e<t.length;e++){var r=n.indexOf(t[e]);-1!==r&&(n[r]=null)}let i=null;for(let e=0;e<n.length;e++){var s=n[e];s&&(i=null===i?x("'{0}'",s):x("{0}, '{1}'",i,s))}return i}visitNode(e){switch(e.type){case u.UnknownAtRule:return this.visitUnknownAtRule(e);case u.Keyframe:return this.visitKeyframe(e);case u.FontFace:return this.visitFontFace(e);case u.Ruleset:return this.visitRuleSet(e);case u.SimpleSelector:return this.visitSimpleSelector(e);case u.Function:return this.visitFunction(e);case u.NumericValue:return this.visitNumericValue(e);case u.Import:return this.visitImport(e);case u.HexColorValue:return this.visitHexColorValue(e);case u.Prio:return this.visitPrio(e);case u.IdentifierSelector:return this.visitIdentifierSelector(e)}return!0}completeValidations(){this.validateKeyframes()}visitUnknownAtRule(e){let t=e.getChild(0);return!(!t||this.cssDataManager.getAtDirective(t.getText()))&&(this.addEntry(t,R.UnknownAtRules,"Unknown at rule "+t.getText()),!0)}visitKeyframe(e){let t=e.getKeyword();if(!t)return!1;var n=t.getText();return this.keyframes.add(e.getName(),n,"@keyframes"!==n?t:null),!0}validateKeyframes(){var n,r=["@-webkit-keyframes","@-moz-keyframes","@-o-keyframes"];for(n in this.keyframes.data){let e=this.keyframes.data[n].names,t=-1===e.indexOf("@keyframes");if(t||1!==e.length){var i,s=this.getMissingNames(r,e);if(s||t)for(var a of this.keyframes.data[n].nodes)t&&(i=x("Always define standard rule '@keyframes' when defining keyframes."),this.addEntry(a,R.IncludeStandardPropertyWhenUsingVendorPrefix,i)),s&&(i=x("Always include all vendor specific rules: Missing: {0}",s),this.addEntry(a,R.AllVendorPrefixes,i))}}return!0}visitSimpleSelector(e){var t=this.documentText.charAt(e.offset);return 1===e.length&&"*"===t&&this.addEntry(e,R.UniversalSelector),!0}visitIdentifierSelector(e){return this.addEntry(e,R.AvoidIdSelector),!0}visitImport(e){return this.addEntry(e,R.ImportStatemement),!0}visitRuleSet(s){let e=s.getDeclarations();if(!e)return!1;e.hasChildren()||this.addEntry(s.getSelectors(),R.EmptyRuleSet);let i=[];for(var t of e.getChildren())t instanceof y&&i.push(new Vr(t));var n=Hr(i);if(n.width){let e=[];if(n.right.value&&(e=Wn(e,n.right.properties)),0!==(e=n.left.value?Wn(e,n.left.properties):e).length){for(var r of e)this.addEntry(r.node,R.BewareOfBoxModelSize);this.addEntry(n.width.node,R.BewareOfBoxModelSize)}}if(n.height){let e=[];if(n.top.value&&(e=Wn(e,n.top.properties)),0!==(e=n.bottom.value?Wn(e,n.bottom.properties):e).length){for(var a of e)this.addEntry(a.node,R.BewareOfBoxModelSize);this.addEntry(n.height.node,R.BewareOfBoxModelSize)}}if(0<this.fetchWithValue(i,"display","inline-block").length){var o=this.fetch(i,"float");for(let n=0;n<o.length;n++){let e=o[n].node,t=e.getValue();t&&!t.matches("none")&&this.addEntry(e,R.PropertyIgnoredDueToDisplay,x("inline-block is ignored due to the float. If 'float' has a value other than 'none', the box is floated and 'display' is treated as 'block'"))}}if(0<this.fetchWithValue(i,"display","block").length){var l=this.fetch(i,"vertical-align");for(let e=0;e<l.length;e++)this.addEntry(l[e].node,R.PropertyIgnoredDueToDisplay,x("Property is ignored due to the display. With 'display: block', vertical-align should not be used."))}var c=this.fetch(i,"float");for(let e=0;e<c.length;e++){var d=c[e];this.isValidPropertyDeclaration(d)||this.addEntry(d.node,R.AvoidFloat)}for(let e=0;e<i.length;e++){let n=i[e];if("background"!==n.fullPropertyName&&!this.validProperties[n.fullPropertyName]){var h=n.node.getValue();if(h&&"-"!==this.documentText.charAt(h.offset)){let t=this.fetch(i,n.fullPropertyName);if(1<t.length)for(let e=0;e<t.length;e++){var p=t[e].node.getValue();p&&"-"!==this.documentText.charAt(p.offset)&&t[e]!==n&&this.addEntry(n.node,R.DuplicateDeclarations)}}}}if(!s.getSelectors().matches(":export")){let r=new Xr,e=!1;for(var m of i){let n=m.node;if(this.isCSSDeclaration(n)){let e=m.fullPropertyName,t=e.charAt(0);"-"===t?"-"!==e.charAt(1)&&(this.cssDataManager.isKnownProperty(e)||this.validProperties[e]||this.addEntry(n.getProperty(),R.UnknownVendorSpecificProperty),m=n.getNonPrefixedPropertyName(),r.add(m,e,n.getProperty())):(m=e,"*"!==t&&"_"!==t||(this.addEntry(n.getProperty(),R.IEStarHack),e=e.substr(1)),this.cssDataManager.isKnownProperty(m)||this.cssDataManager.isKnownProperty(e)||this.validProperties[e]||this.addEntry(n.getProperty(),R.UnknownProperty,x("Unknown property: '{0}'",n.getFullPropertyName())),r.add(e,e,null))}else e=!0}if(!e)for(var u in r.data){let e=r.data[u],t=e.names,i=this.cssDataManager.isStandardProperty(u)&&-1===t.indexOf(u);if(i||1!==t.length){let r=new Set(i?e.nodes:[]);if(i){let n=this.getContextualVendorSpecificPseudoElements(s);for(var f of e.nodes){let e=f.getName(),t=e.substring(0,e.length-u.length);n.some(e=>e.startsWith(t))&&r.delete(f)}}let n=[];for(let e=0,t=Gi.prefixes.length;e<t;e++){var g=Gi.prefixes[e];this.cssDataManager.isStandardProperty(g+u)&&n.push(g+u)}var b,v=this.getMissingNames(n,t);if(v||i)for(var w of e.nodes)i&&r.has(w)&&(b=x("Also define the standard property '{0}' for compatibility",u),this.addEntry(w,R.IncludeStandardPropertyWhenUsingVendorPrefix,b)),v&&(b=x("Always include all vendor specific properties: Missing: {0}",v),this.addEntry(w,R.AllVendorPrefixes,b))}}}return!0}getContextualVendorSpecificPseudoElements(e){var t=new Set;return function e(t,n){if(n.type===u.Ruleset)for(var r of n.getSelectors().getChildren())!function e(t,n){for(var r of n.getChildren()){var i;r.type===u.PseudoSelector&&(i=r.getChildren()[0]?.getText())&&t.add(i),e(t,r)}}(t,r);return n.parent?e(t,n.parent):void 0}(t,e),Array.from(t)}visitPrio(e){return this.addEntry(e,R.AvoidImportant),!0}visitNumericValue(t){let e=t.findParent(u.Function);if(e&&"calc"===e.getName())return!0;let n=t.findParent(u.Declaration);if(n&&n.getValue()){let e=t.getValue();if(!e.unit||-1===Rn.length.indexOf(e.unit.toLowerCase()))return!0;0===parseFloat(e.value)&&e.unit&&!this.validProperties[n.getFullPropertyName()]&&this.addEntry(t,R.ZeroWithUnit)}return!0}visitFontFace(e){let t=e.getDeclarations();if(!t)return!1;let n=!1,r=!1,i=!1;for(var s of t.getChildren())this.isCSSDeclaration(s)?("src"===(s=s.getProperty().getName().toLowerCase())&&(n=!0),"font-family"===s&&(r=!0)):i=!0;return i||n&&r||this.addEntry(e,R.RequiredPropertiesForFontFace),!0}isCSSDeclaration(n){if(n instanceof y){if(!n.getValue())return!1;let e=n.getProperty();if(!e)return!1;let t=e.getIdentifier();return!(!t||t.containsInterpolation())}return!1}visitHexColorValue(e){var t=e.length;return 9!==t&&7!==t&&5!==t&&4!==t&&this.addEntry(e,R.HexColorLength),!1}visitFunction(e){let t=e.getName().toLowerCase(),n=-1,r=0;switch(t){case"rgb(":case"hsl(":n=3;break;case"rgba(":case"hsla(":n=4}return-1!==n&&(e.getArguments().accept(e=>!(e instanceof Be)||(r+=1,!1)),r!==n&&this.addEntry(e,R.ArgsInColorFunction)),!0}},Qr=(Yr.prefixes=["-ms-","-moz-","-o-","-webkit-"],class{constructor(e){this.cssDataManager=e}configure(e){this.settings=e}doValidation(r,e,t=this.settings){if(t&&!1===t.validate)return[];let n=[],i=(n.push.apply(n,dt.entries(e)),n.push.apply(n,Yr.entries(e,r,new $r(t&&t.lint),this.cssDataManager)),[]);for(var s in R)i.push(R[s].id);return n.filter(e=>e.getLevel()!==a.Ignore).map(function(e){var t=w.create(r.positionAt(e.getOffset()),r.positionAt(e.getOffset()+e.getLength())),n=r.languageId;return{code:e.getRule().id,source:n,message:e.getMessage(),severity:e.getLevel()===a.Warning?vt.Warning:vt.Error,range:t}})}}),M=d.CustomToken,Zr=M++,ei=M++,ti=(M++,M++),ni=M++,ri=M++,ii=M++,si=M++,ai=class extends J{scanNext(t){if(this.stream.advanceIfChar(36)){let e=["$"];if(this.ident(e))return this.finishToken(t,Zr,e.join(""));this.stream.goBackTo(t)}return this.stream.advanceIfChars([35,123])?this.finishToken(t,ei):this.stream.advanceIfChars([61,61])?this.finishToken(t,ti):this.stream.advanceIfChars([33,61])?this.finishToken(t,ni):this.stream.advanceIfChar(60)?this.stream.advanceIfChar(61)?this.finishToken(t,ii):this.finishToken(t,d.Delim):this.stream.advanceIfChar(62)?this.stream.advanceIfChar(61)?this.finishToken(t,ri):this.finishToken(t,d.Delim):this.stream.advanceIfChars([46,46,46])?this.finishToken(t,si):super.scanNext(t)}comment(){return!!super.comment()||!(this.inURL||!this.stream.advanceIfChars([47,47]))&&(this.stream.advanceWhileChar(e=>{switch(e){case 10:case 13:case 12:return!1;default:return!0}}),!0)}},oi=class{constructor(e,t){this.id=e,this.message=t}},li={FromExpected:new oi("scss-fromexpected",x("'from' expected")),ThroughOrToExpected:new oi("scss-throughexpected",x("'through' or 'to' expected")),InExpected:new oi("scss-fromexpected",x("'in' expected"))},ci=class extends Pn{constructor(){super(new ai)}_parseStylesheetStatement(e=!1){return this.peek(d.AtKeyword)?this._parseWarnAndDebug()||this._parseControlStatement()||this._parseMixinDeclaration()||this._parseMixinContent()||this._parseMixinReference()||this._parseFunctionDeclaration()||this._parseForward()||this._parseUse()||this._parseRuleset(e)||super._parseStylesheetAtStatement(e):this._parseRuleset(!0)||this._parseVariableDeclaration()}_parseImport(){if(!this.peekKeyword("@import"))return null;let e=this.create(ke);if(this.consumeToken(),!e.addChild(this._parseURILiteral())&&!e.addChild(this._parseStringLiteral()))return this.finish(e,F.URIOrStringExpected);for(;this.accept(d.Comma);)if(!e.addChild(this._parseURILiteral())&&!e.addChild(this._parseStringLiteral()))return this.finish(e,F.URIOrStringExpected);return this._completeParseImport(e)}_parseVariableDeclaration(e=[]){if(!this.peek(Zr))return null;let t=this.create(Xe);if(!t.setVariable(this._parseVariable()))return null;if(!this.accept(d.Colon))return this.finish(t,F.ColonExpected);if(this.prevToken&&(t.colonPosition=this.prevToken.offset),!t.setValue(this._parseExpr()))return this.finish(t,F.VariableValueExpected,[],e);for(;this.peek(d.Exclamation);)if(!t.addChild(this._tryParsePrio())){if(this.consumeToken(),!this.peekRegExp(d.Ident,/^(default|global)$/))return this.finish(t,F.UnknownKeyword);this.consumeToken()}return this.peek(d.SemiColon)&&(t.semicolonPosition=this.token.offset),this.finish(t)}_parseMediaCondition(){return this._parseInterpolation()||super._parseMediaCondition()}_parseMediaFeatureRangeOperator(){return this.accept(ii)||this.accept(ri)||super._parseMediaFeatureRangeOperator()}_parseMediaFeatureName(){return this._parseModuleMember()||this._parseFunction()||this._parseIdent()||this._parseVariable()}_parseKeyframeSelector(){return this._tryParseKeyframeSelector()||this._parseControlStatement(this._parseKeyframeSelector.bind(this))||this._parseWarnAndDebug()||this._parseMixinReference()||this._parseFunctionDeclaration()||this._parseVariableDeclaration()||this._parseMixinContent()}_parseVariable(){if(!this.peek(Zr))return null;var e=this.create(Qe);return this.consumeToken(),e}_parseModuleMember(){let e=this.mark(),t=this.create(lt);return t.setIdentifier(this._parseIdent([o.Module]))?this.hasWhitespace()||!this.acceptDelim(".")||this.hasWhitespace()?(this.restoreAtMark(e),null):t.addChild(this._parseVariable()||this._parseFunction())?t:this.finish(t,F.IdentifierOrVariableExpected):null}_parseIdent(e){if(!this.peek(d.Ident)&&!this.peek(ei)&&!this.peekDelim("-"))return null;let t=this.create(c),n=(t.referenceTypes=e,t.isCustomProperty=this.peekRegExp(d.Ident,/^--/),!1),r=()=>{var e=this.mark();return this.acceptDelim("-")&&(this.hasWhitespace()||this.acceptDelim("-"),this.hasWhitespace())?(this.restoreAtMark(e),null):this._parseInterpolation()};for(;(this.accept(d.Ident)||t.addChild(r())||n&&this.acceptRegexp(/^[\w-]/))&&(n=!0,!this.hasWhitespace()););return n?this.finish(t):null}_parseTermExpression(){return this._parseModuleMember()||this._parseVariable()||this._parseNestingSelector()||super._parseTermExpression()}_parseInterpolation(){if(this.peek(ei)){let e=this.create(Ye);return this.consumeToken(),e.addChild(this._parseExpr())||this._parseNestingSelector()?this.accept(d.CurlyR)?this.finish(e):this.finish(e,F.RightCurlyExpected):this.accept(d.CurlyR)?this.finish(e):this.finish(e,F.ExpressionExpected)}return null}_parseOperator(){var e;return this.peek(ti)||this.peek(ni)||this.peek(ri)||this.peek(ii)||this.peekDelim(">")||this.peekDelim("<")||this.peekIdent("and")||this.peekIdent("or")||this.peekDelim("%")?(e=this.createNode(u.Operator),this.consumeToken(),this.finish(e)):super._parseOperator()}_parseUnaryOperator(){var e;return this.peekIdent("not")?(e=this.create(p),this.consumeToken(),this.finish(e)):super._parseUnaryOperator()}_parseRuleSetDeclaration(){return this.peek(d.AtKeyword)?this._parseKeyframe()||this._parseImport()||this._parseMedia(!0)||this._parseFontFace()||this._parseWarnAndDebug()||this._parseControlStatement()||this._parseFunctionDeclaration()||this._parseExtends()||this._parseMixinReference()||this._parseMixinContent()||this._parseMixinDeclaration()||this._parseRuleset(!0)||this._parseSupports(!0)||this._parseLayer()||this._parsePropertyAtRule()||this._parseContainer(!0)||this._parseRuleSetDeclarationAtStatement():this._parseVariableDeclaration()||this._tryParseRuleset(!0)||this._parseDeclaration()}_parseDeclaration(e){var t=this._tryParseCustomPropertyDeclaration(e);if(t)return t;let n=this.create(y);if(!n.setProperty(this._parseProperty()))return null;if(!this.accept(d.Colon))return this.finish(n,F.ColonExpected,[d.Colon],e||[d.SemiColon]);this.prevToken&&(n.colonPosition=this.prevToken.offset);let r=!1;if(n.setValue(this._parseExpr())&&(r=!0,n.addChild(this._parsePrio())),this.peek(d.CurlyL))n.setNestedProperties(this._parseNestedProperties());else if(!r)return this.finish(n,F.PropertyValueExpected);return this.peek(d.SemiColon)&&(n.semicolonPosition=this.token.offset),this.finish(n)}_parseNestedProperties(){var e=this.create(xe);return this._parseBody(e,this._parseDeclaration.bind(this))}_parseExtends(){if(this.peekKeyword("@extend")){let e=this.create(Ze);if(this.consumeToken(),!e.getSelectors().addChild(this._parseSimpleSelector()))return this.finish(e,F.SelectorExpected);for(;this.accept(d.Comma);)e.getSelectors().addChild(this._parseSimpleSelector());return this.accept(d.Exclamation)&&!this.acceptIdent("optional")?this.finish(e,F.UnknownKeyword):this.finish(e)}return null}_parseSimpleSelectorBody(){return this._parseSelectorPlaceholder()||super._parseSimpleSelectorBody()}_parseNestingSelector(){if(this.peekDelim("&")){let e=this.createNode(u.SelectorCombinator);for(this.consumeToken();!this.hasWhitespace()&&(this.acceptDelim("-")||this.accept(d.Num)||this.accept(d.Dimension)||e.addChild(this._parseIdent())||this.acceptDelim("&")););return this.finish(e)}return null}_parseSelectorPlaceholder(){var e;if(this.peekDelim("%"))return e=this.createNode(u.SelectorPlaceholder),this.consumeToken(),this._parseIdent(),this.finish(e);if(this.peekKeyword("@at-root")){let e=this.createNode(u.SelectorPlaceholder);if(this.consumeToken(),this.accept(d.ParenthesisL)){if(!this.acceptIdent("with")&&!this.acceptIdent("without"))return this.finish(e,F.IdentifierExpected);if(!this.accept(d.Colon))return this.finish(e,F.ColonExpected);if(!e.addChild(this._parseIdent()))return this.finish(e,F.IdentifierExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[d.CurlyR])}return this.finish(e)}return null}_parseElementName(){var e=this.mark(),t=super._parseElementName();return t&&!this.hasWhitespace()&&this.peek(d.ParenthesisL)?(this.restoreAtMark(e),null):t}_tryParsePseudoIdentifier(){return this._parseInterpolation()||super._tryParsePseudoIdentifier()}_parseWarnAndDebug(){if(!this.peekKeyword("@debug")&&!this.peekKeyword("@warn")&&!this.peekKeyword("@error"))return null;let e=this.createNode(u.Debug);return this.consumeToken(),e.addChild(this._parseExpr()),this.finish(e)}_parseControlStatement(e=this._parseRuleSetDeclaration.bind(this)){return this.peek(d.AtKeyword)?this._parseIfStatement(e)||this._parseForStatement(e)||this._parseEachStatement(e)||this._parseWhileStatement(e):null}_parseIfStatement(e){return this.peekKeyword("@if")?this._internalParseIfStatement(e):null}_internalParseIfStatement(e){let t=this.create(me);return this.consumeToken(),t.setExpression(this._parseExpr(!0))?(this._parseBody(t,e),this.acceptKeyword("@else")&&(this.peekIdent("if")?t.setElseClause(this._internalParseIfStatement(e)):this.peek(d.CurlyL)&&(n=this.create(be),this._parseBody(n,e),t.setElseClause(n))),this.finish(t)):this.finish(t,F.ExpressionExpected);var n}_parseForStatement(e){if(!this.peekKeyword("@for"))return null;let t=this.create(ue);return this.consumeToken(),t.setVariable(this._parseVariable())?this.acceptIdent("from")?t.addChild(this._parseBinaryExpr())?this.acceptIdent("to")||this.acceptIdent("through")?t.addChild(this._parseBinaryExpr())?this._parseBody(t,e):this.finish(t,F.ExpressionExpected,[d.CurlyR]):this.finish(t,li.ThroughOrToExpected,[d.CurlyR]):this.finish(t,F.ExpressionExpected,[d.CurlyR]):this.finish(t,li.FromExpected,[d.CurlyR]):this.finish(t,F.VariableNameExpected,[d.CurlyR])}_parseEachStatement(e){if(!this.peekKeyword("@each"))return null;let t=this.create(fe),n=(this.consumeToken(),t.getVariables());if(!n.addChild(this._parseVariable()))return this.finish(t,F.VariableNameExpected,[d.CurlyR]);for(;this.accept(d.Comma);)if(!n.addChild(this._parseVariable()))return this.finish(t,F.VariableNameExpected,[d.CurlyR]);return this.finish(n),this.acceptIdent("in")?t.addChild(this._parseExpr())?this._parseBody(t,e):this.finish(t,F.ExpressionExpected,[d.CurlyR]):this.finish(t,li.InExpected,[d.CurlyR])}_parseWhileStatement(e){if(!this.peekKeyword("@while"))return null;let t=this.create(ge);return this.consumeToken(),t.addChild(this._parseBinaryExpr())?this._parseBody(t,e):this.finish(t,F.ExpressionExpected,[d.CurlyR])}_parseFunctionBodyDeclaration(){return this._parseVariableDeclaration()||this._parseReturnStatement()||this._parseWarnAndDebug()||this._parseControlStatement(this._parseFunctionBodyDeclaration.bind(this))}_parseFunctionDeclaration(){if(!this.peekKeyword("@function"))return null;let e=this.create(ve);if(this.consumeToken(),!e.setIdentifier(this._parseIdent([o.Function])))return this.finish(e,F.IdentifierExpected,[d.CurlyR]);if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[d.CurlyR]);if(e.getParameters().addChild(this._parseParameterDeclaration()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getParameters().addChild(this._parseParameterDeclaration()))return this.finish(e,F.VariableNameExpected);return this.accept(d.ParenthesisR)?this._parseBody(e,this._parseFunctionBodyDeclaration.bind(this)):this.finish(e,F.RightParenthesisExpected,[d.CurlyR])}_parseReturnStatement(){if(!this.peekKeyword("@return"))return null;let e=this.createNode(u.ReturnStatement);return this.consumeToken(),e.addChild(this._parseExpr())?this.finish(e):this.finish(e,F.ExpressionExpected)}_parseMixinDeclaration(){if(!this.peekKeyword("@mixin"))return null;let e=this.create(rt);if(this.consumeToken(),!e.setIdentifier(this._parseIdent([o.Mixin])))return this.finish(e,F.IdentifierExpected,[d.CurlyR]);if(this.accept(d.ParenthesisL)){if(e.getParameters().addChild(this._parseParameterDeclaration()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getParameters().addChild(this._parseParameterDeclaration()))return this.finish(e,F.VariableNameExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[d.CurlyR])}return this._parseBody(e,this._parseRuleSetDeclaration.bind(this))}_parseParameterDeclaration(){let e=this.create(he);return e.setIdentifier(this._parseVariable())?(this.accept(si),this.accept(d.Colon)&&!e.setDefaultValue(this._parseExpr(!0))?this.finish(e,F.VariableValueExpected,[],[d.Comma,d.ParenthesisR]):this.finish(e)):null}_parseMixinContent(){if(!this.peekKeyword("@content"))return null;let e=this.create(et);if(this.consumeToken(),this.accept(d.ParenthesisL)){if(e.getArguments().addChild(this._parseFunctionArgument()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getArguments().addChild(this._parseFunctionArgument()))return this.finish(e,F.ExpressionExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected)}return this.finish(e)}_parseMixinReference(){if(!this.peekKeyword("@include"))return null;let t=this.create(nt),n=(this.consumeToken(),this._parseIdent([o.Mixin]));if(!t.setIdentifier(n))return this.finish(t,F.IdentifierExpected,[d.CurlyR]);if(!this.hasWhitespace()&&this.acceptDelim(".")&&!this.hasWhitespace()){var r=this._parseIdent([o.Mixin]);if(!r)return this.finish(t,F.IdentifierExpected,[d.CurlyR]);let e=this.create(lt);n.referenceTypes=[o.Module],e.setIdentifier(n),t.setIdentifier(r),t.addChild(e)}if(this.accept(d.ParenthesisL)){if(t.getArguments().addChild(this._parseFunctionArgument()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!t.getArguments().addChild(this._parseFunctionArgument()))return this.finish(t,F.ExpressionExpected);if(!this.accept(d.ParenthesisR))return this.finish(t,F.RightParenthesisExpected)}return(this.peekIdent("using")||this.peek(d.CurlyL))&&t.setContent(this._parseMixinContentDeclaration()),this.finish(t)}_parseMixinContentDeclaration(){let e=this.create(tt);if(this.acceptIdent("using")){if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[d.CurlyL]);if(e.getParameters().addChild(this._parseParameterDeclaration()))for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getParameters().addChild(this._parseParameterDeclaration()))return this.finish(e,F.VariableNameExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[d.CurlyL])}return this.peek(d.CurlyL)&&this._parseBody(e,this._parseMixinReferenceBodyStatement.bind(this)),this.finish(e)}_parseMixinReferenceBodyStatement(){return this._tryParseKeyframeSelector()||this._parseRuleSetDeclaration()}_parseFunctionArgument(){let e=this.create(pe),t=this.mark(),n=this._parseVariable();if(n)if(this.accept(d.Colon))e.setIdentifier(n);else{if(this.accept(si))return e.setValue(n),this.finish(e);this.restoreAtMark(t)}return e.setValue(this._parseExpr(!0))?(this.accept(si),e.addChild(this._parsePrio()),this.finish(e)):e.setValue(this._tryParsePrio())?this.finish(e):null}_parseURLArgument(){var t=this.mark(),e=super._parseURLArgument();if(e&&this.peek(d.ParenthesisR))return e;{this.restoreAtMark(t);let e=this.create(p);return e.addChild(this._parseBinaryExpr()),this.finish(e)}}_parseOperation(){if(!this.peek(d.ParenthesisL))return null;let e=this.create(p);for(this.consumeToken();e.addChild(this._parseListElement());)this.accept(d.Comma);return this.accept(d.ParenthesisR)?this.finish(e):this.finish(e,F.RightParenthesisExpected)}_parseListElement(){let e=this.create(st),t=this._parseBinaryExpr();if(!t)return null;if(this.accept(d.Colon)){if(e.setKey(t),!e.setValue(this._parseBinaryExpr()))return this.finish(e,F.ExpressionExpected)}else e.setValue(t);return this.finish(e)}_parseUse(){if(!this.peekKeyword("@use"))return null;let e=this.create(Fe);if(this.consumeToken(),!e.addChild(this._parseStringLiteral()))return this.finish(e,F.StringLiteralExpected);if(!this.peek(d.SemiColon)&&!this.peek(d.EOF)){if(!this.peekRegExp(d.Ident,/as|with/))return this.finish(e,F.UnknownKeyword);if(this.acceptIdent("as")&&!e.setIdentifier(this._parseIdent([o.Module]))&&!this.acceptDelim("*"))return this.finish(e,F.IdentifierOrWildcardExpected);if(this.acceptIdent("with")){if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[d.ParenthesisR]);if(!e.getParameters().addChild(this._parseModuleConfigDeclaration()))return this.finish(e,F.VariableNameExpected);for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getParameters().addChild(this._parseModuleConfigDeclaration()))return this.finish(e,F.VariableNameExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected)}}return this.accept(d.SemiColon)||this.accept(d.EOF)?this.finish(e):this.finish(e,F.SemiColonExpected)}_parseModuleConfigDeclaration(){let e=this.create(Ee);return e.setIdentifier(this._parseVariable())?this.accept(d.Colon)&&e.setValue(this._parseExpr(!0))?!this.accept(d.Exclamation)||!this.hasWhitespace()&&this.acceptIdent("default")?this.finish(e):this.finish(e,F.UnknownKeyword):this.finish(e,F.VariableValueExpected,[],[d.Comma,d.ParenthesisR]):null}_parseForward(){if(!this.peekKeyword("@forward"))return null;let e=this.create(_e);if(this.consumeToken(),!e.addChild(this._parseStringLiteral()))return this.finish(e,F.StringLiteralExpected);if(this.acceptIdent("as")){var t=this._parseIdent([o.Forward]);if(!e.setIdentifier(t))return this.finish(e,F.IdentifierExpected);if(this.hasWhitespace()||!this.acceptDelim("*"))return this.finish(e,F.WildcardExpected)}if(this.acceptIdent("with")){if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected,[d.ParenthesisR]);if(!e.getParameters().addChild(this._parseModuleConfigDeclaration()))return this.finish(e,F.VariableNameExpected);for(;this.accept(d.Comma)&&!this.peek(d.ParenthesisR);)if(!e.getParameters().addChild(this._parseModuleConfigDeclaration()))return this.finish(e,F.VariableNameExpected);if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected)}else if((this.peekIdent("hide")||this.peekIdent("show"))&&!e.addChild(this._parseForwardVisibility()))return this.finish(e,F.IdentifierOrVariableExpected);return this.accept(d.SemiColon)||this.accept(d.EOF)?this.finish(e):this.finish(e,F.SemiColonExpected)}_parseForwardVisibility(){let e=this.create(Ie);for(e.setIdentifier(this._parseIdent());e.addChild(this._parseVariable()||this._parseIdent());)this.accept(d.Comma);return 1<e.getChildren().length?e:null}_parseSupportsCondition(){return this._parseInterpolation()||super._parseSupportsCondition()}},N=x("Sass documentation"),di=class O extends mr{constructor(e,t){super("$",e,t),hi(O.scssModuleLoaders),hi(O.scssModuleBuiltIns)}isImportPathParent(e){return e===u.Forward||e===u.Use||super.isImportPathParent(e)}getCompletionForImportPath(e,t){var n=e.getParent().type;if(n===u.Forward||n===u.Use)for(var r of O.scssModuleBuiltIns){r={label:r.label,documentation:r.documentation,textEdit:S.replace(this.getCompletionRange(e),`'${r.label}'`),kind:C.Module};t.items.push(r)}return super.getCompletionForImportPath(e,t)}createReplaceFunction(){let n=1;return(e,t)=>"\\"+t+": ${"+n+++":"+(O.variableDefaults[t]||"")+"}"}createFunctionProposals(e,n,r,i){for(var s of e){let e=s.func.replace(/\[?(\$\w+)\]?/g,this.createReplaceFunction()),t={label:s.func.substr(0,s.func.indexOf("(")),detail:s.func,documentation:s.desc,textEdit:S.replace(this.getCompletionRange(n),e),insertTextFormat:g.Snippet,kind:C.Function};r&&(t.sortText="z"),i.items.push(t)}return i}getCompletionsForSelector(e,t,n){return this.createFunctionProposals(O.selectorFuncs,null,!0,n),super.getCompletionsForSelector(e,t,n)}getTermProposals(t,e,n){let r=O.builtInFuncs;return t&&(r=r.filter(e=>!e.type||!t.restrictions||-1!==t.restrictions.indexOf(e.type))),this.createFunctionProposals(r,e,!0,n),super.getTermProposals(t,e,n)}getColorProposals(e,t,n){return this.createFunctionProposals(O.colorProposals,t,!1,n),super.getColorProposals(e,t,n)}getCompletionsForDeclarationProperty(e,t){return this.getCompletionForAtDirectives(t),this.getCompletionsForSelector(null,!0,t),super.getCompletionsForDeclarationProperty(e,t)}getCompletionsForExtendsReference(e,t,n){var r;for(r of this.getSymbolContext().findSymbolsAtOffset(this.offset,o.Rule)){var i={label:r.name,textEdit:S.replace(this.getCompletionRange(t),r.name),kind:C.Function};n.items.push(i)}return n}getCompletionForAtDirectives(e){return e.items.push(...O.scssAtDirectives),e}getCompletionForTopLevel(e){return this.getCompletionForAtDirectives(e),this.getCompletionForModuleLoaders(e),super.getCompletionForTopLevel(e),e}getCompletionForModuleLoaders(e){return e.items.push(...O.scssModuleLoaders),e}};function hi(e){e.forEach(t=>{if(t.documentation&&t.references&&0<t.references.length){let e="string"==typeof t.documentation?{kind:"markdown",value:t.documentation}:{kind:"markdown",value:t.documentation.value};e.value+=`

`,e.value+=t.references.map(e=>`[${e.name}](${e.url})`).join(" | "),t.documentation=e}})}di.variableDefaults={$red:"1",$green:"2",$blue:"3",$alpha:"1.0",$color:"#000000",$weight:"0.5",$hue:"0",$saturation:"0%",$lightness:"0%",$degrees:"0",$amount:"0",$string:'""',$substring:'"s"',$number:"0",$limit:"1"},di.colorProposals=[{func:"red($color)",desc:x("Gets the red component of a color.")},{func:"green($color)",desc:x("Gets the green component of a color.")},{func:"blue($color)",desc:x("Gets the blue component of a color.")},{func:"mix($color, $color, [$weight])",desc:x("Mixes two colors together.")},{func:"hue($color)",desc:x("Gets the hue component of a color.")},{func:"saturation($color)",desc:x("Gets the saturation component of a color.")},{func:"lightness($color)",desc:x("Gets the lightness component of a color.")},{func:"adjust-hue($color, $degrees)",desc:x("Changes the hue of a color.")},{func:"lighten($color, $amount)",desc:x("Makes a color lighter.")},{func:"darken($color, $amount)",desc:x("Makes a color darker.")},{func:"saturate($color, $amount)",desc:x("Makes a color more saturated.")},{func:"desaturate($color, $amount)",desc:x("Makes a color less saturated.")},{func:"grayscale($color)",desc:x("Converts a color to grayscale.")},{func:"complement($color)",desc:x("Returns the complement of a color.")},{func:"invert($color)",desc:x("Returns the inverse of a color.")},{func:"alpha($color)",desc:x("Gets the opacity component of a color.")},{func:"opacity($color)",desc:"Gets the alpha component (opacity) of a color."},{func:"rgba($color, $alpha)",desc:x("Changes the alpha component for a color.")},{func:"opacify($color, $amount)",desc:x("Makes a color more opaque.")},{func:"fade-in($color, $amount)",desc:x("Makes a color more opaque.")},{func:"transparentize($color, $amount)",desc:x("Makes a color more transparent.")},{func:"fade-out($color, $amount)",desc:x("Makes a color more transparent.")},{func:"adjust-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])",desc:x("Increases or decreases one or more components of a color.")},{func:"scale-color($color, [$red], [$green], [$blue], [$saturation], [$lightness], [$alpha])",desc:x("Fluidly scales one or more properties of a color.")},{func:"change-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])",desc:x("Changes one or more properties of a color.")},{func:"ie-hex-str($color)",desc:x("Converts a color into the format understood by IE filters.")}],di.selectorFuncs=[{func:"selector-nest($selectors…)",desc:x("Nests selector beneath one another like they would be nested in the stylesheet.")},{func:"selector-append($selectors…)",desc:x("Appends selectors to one another without spaces in between.")},{func:"selector-extend($selector, $extendee, $extender)",desc:x("Extends $extendee with $extender within $selector.")},{func:"selector-replace($selector, $original, $replacement)",desc:x("Replaces $original with $replacement within $selector.")},{func:"selector-unify($selector1, $selector2)",desc:x("Unifies two selectors to produce a selector that matches elements matched by both.")},{func:"is-superselector($super, $sub)",desc:x("Returns whether $super matches all the elements $sub does, and possibly more.")},{func:"simple-selectors($selector)",desc:x("Returns the simple selectors that comprise a compound selector.")},{func:"selector-parse($selector)",desc:x("Parses a selector into the format returned by &.")}],di.builtInFuncs=[{func:"unquote($string)",desc:x("Removes quotes from a string.")},{func:"quote($string)",desc:x("Adds quotes to a string.")},{func:"str-length($string)",desc:x("Returns the number of characters in a string.")},{func:"str-insert($string, $insert, $index)",desc:x("Inserts $insert into $string at $index.")},{func:"str-index($string, $substring)",desc:x("Returns the index of the first occurance of $substring in $string.")},{func:"str-slice($string, $start-at, [$end-at])",desc:x("Extracts a substring from $string.")},{func:"to-upper-case($string)",desc:x("Converts a string to upper case.")},{func:"to-lower-case($string)",desc:x("Converts a string to lower case.")},{func:"percentage($number)",desc:x("Converts a unitless number to a percentage."),type:"percentage"},{func:"round($number)",desc:x("Rounds a number to the nearest whole number.")},{func:"ceil($number)",desc:x("Rounds a number up to the next whole number.")},{func:"floor($number)",desc:x("Rounds a number down to the previous whole number.")},{func:"abs($number)",desc:x("Returns the absolute value of a number.")},{func:"min($numbers)",desc:x("Finds the minimum of several numbers.")},{func:"max($numbers)",desc:x("Finds the maximum of several numbers.")},{func:"random([$limit])",desc:x("Returns a random number.")},{func:"length($list)",desc:x("Returns the length of a list.")},{func:"nth($list, $n)",desc:x("Returns a specific item in a list.")},{func:"set-nth($list, $n, $value)",desc:x("Replaces the nth item in a list.")},{func:"join($list1, $list2, [$separator])",desc:x("Joins together two lists into one.")},{func:"append($list1, $val, [$separator])",desc:x("Appends a single value onto the end of a list.")},{func:"zip($lists)",desc:x("Combines several lists into a single multidimensional list.")},{func:"index($list, $value)",desc:x("Returns the position of a value within a list.")},{func:"list-separator(#list)",desc:x("Returns the separator of a list.")},{func:"map-get($map, $key)",desc:x("Returns the value in a map associated with a given key.")},{func:"map-merge($map1, $map2)",desc:x("Merges two maps together into a new map.")},{func:"map-remove($map, $keys)",desc:x("Returns a new map with keys removed.")},{func:"map-keys($map)",desc:x("Returns a list of all keys in a map.")},{func:"map-values($map)",desc:x("Returns a list of all values in a map.")},{func:"map-has-key($map, $key)",desc:x("Returns whether a map has a value associated with a given key.")},{func:"keywords($args)",desc:x("Returns the keywords passed to a function that takes variable arguments.")},{func:"feature-exists($feature)",desc:x("Returns whether a feature exists in the current Sass runtime.")},{func:"variable-exists($name)",desc:x("Returns whether a variable with the given name exists in the current scope.")},{func:"global-variable-exists($name)",desc:x("Returns whether a variable with the given name exists in the global scope.")},{func:"function-exists($name)",desc:x("Returns whether a function with the given name exists.")},{func:"mixin-exists($name)",desc:x("Returns whether a mixin with the given name exists.")},{func:"inspect($value)",desc:x("Returns the string representation of a value as it would be represented in Sass.")},{func:"type-of($value)",desc:x("Returns the type of a value.")},{func:"unit($number)",desc:x("Returns the unit(s) associated with a number.")},{func:"unitless($number)",desc:x("Returns whether a number has units.")},{func:"comparable($number1, $number2)",desc:x("Returns whether two numbers can be added, subtracted, or compared.")},{func:"call($name, $args…)",desc:x("Dynamically calls a Sass function.")}],di.scssAtDirectives=[{label:"@extend",documentation:x("Inherits the styles of another selector."),kind:C.Keyword},{label:"@at-root",documentation:x("Causes one or more rules to be emitted at the root of the document."),kind:C.Keyword},{label:"@debug",documentation:x("Prints the value of an expression to the standard error output stream. Useful for debugging complicated Sass files."),kind:C.Keyword},{label:"@warn",documentation:x("Prints the value of an expression to the standard error output stream. Useful for libraries that need to warn users of deprecations or recovering from minor mixin usage mistakes. Warnings can be turned off with the `--quiet` command-line option or the `:quiet` Sass option."),kind:C.Keyword},{label:"@error",documentation:x("Throws the value of an expression as a fatal error with stack trace. Useful for validating arguments to mixins and functions."),kind:C.Keyword},{label:"@if",documentation:x("Includes the body if the expression does not evaluate to `false` or `null`."),insertText:`@if \${1:expr} {
	$0
}`,insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@for",documentation:x("For loop that repeatedly outputs a set of styles for each `$var` in the `from/through` or `from/to` clause."),insertText:"@for \\$${1:var} from ${2:start} ${3|to,through|} ${4:end} {\n\t$0\n}",insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@each",documentation:x("Each loop that sets `$var` to each item in the list or map, then outputs the styles it contains using that value of `$var`."),insertText:"@each \\$${1:var} in ${2:list} {\n\t$0\n}",insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@while",documentation:x("While loop that takes an expression and repeatedly outputs the nested styles until the statement evaluates to `false`."),insertText:`@while \${1:condition} {
	$0
}`,insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@mixin",documentation:x("Defines styles that can be re-used throughout the stylesheet with `@include`."),insertText:`@mixin \${1:name} {
	$0
}`,insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@include",documentation:x("Includes the styles defined by another mixin into the current rule."),kind:C.Keyword},{label:"@function",documentation:x("Defines complex operations that can be re-used throughout stylesheets."),kind:C.Keyword}],di.scssModuleLoaders=[{label:"@use",documentation:x("Loads mixins, functions, and variables from other Sass stylesheets as 'modules', and combines CSS from multiple stylesheets together."),references:[{name:N,url:"https://sass-lang.com/documentation/at-rules/use"}],insertText:"@use $0;",insertTextFormat:g.Snippet,kind:C.Keyword},{label:"@forward",documentation:x("Loads a Sass stylesheet and makes its mixins, functions, and variables available when this stylesheet is loaded with the @use rule."),references:[{name:N,url:"https://sass-lang.com/documentation/at-rules/forward"}],insertText:"@forward $0;",insertTextFormat:g.Snippet,kind:C.Keyword}],di.scssModuleBuiltIns=[{label:"sass:math",documentation:x("Provides functions that operate on numbers."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/math"}]},{label:"sass:string",documentation:x("Makes it easy to combine, search, or split apart strings."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/string"}]},{label:"sass:color",documentation:x("Generates new colors based on existing ones, making it easy to build color themes."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/color"}]},{label:"sass:list",documentation:x("Lets you access and modify values in lists."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/list"}]},{label:"sass:map",documentation:x("Makes it possible to look up the value associated with a key in a map, and much more."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/map"}]},{label:"sass:selector",documentation:x("Provides access to Sass’s powerful selector engine."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/selector"}]},{label:"sass:meta",documentation:x("Exposes the details of Sass’s inner workings."),references:[{name:N,url:"https://sass-lang.com/documentation/modules/meta"}]}];var pi,mi,ui=d.CustomToken,fi=+ui,gi=class extends J{scanNext(e){var t=this.escapedJavaScript();return null!==t?this.finishToken(e,t):this.stream.advanceIfChars([46,46,46])?this.finishToken(e,fi):super.scanNext(e)}comment(){return!!super.comment()||!(this.inURL||!this.stream.advanceIfChars([47,47]))&&(this.stream.advanceWhileChar(e=>{switch(e){case 10:case 13:case 12:return!1;default:return!0}}),!0)}escapedJavaScript(){return 96===this.stream.peekChar()?(this.stream.advance(1),this.stream.advanceWhileChar(e=>96!==e),this.stream.advanceIfChar(96)?d.EscapedJavaScript:d.BadEscapedJavaScript):null}},bi=class extends Pn{constructor(){super(new gi)}_parseStylesheetStatement(e=!1){return this.peek(d.AtKeyword)?this._parseVariableDeclaration()||this._parsePlugin()||super._parseStylesheetAtStatement(e):this._tryParseMixinDeclaration()||this._tryParseMixinReference()||this._parseFunction()||this._parseRuleset(!0)}_parseImport(){if(!this.peekKeyword("@import")&&!this.peekKeyword("@import-once"))return null;let e=this.create(ke);if(this.consumeToken(),this.accept(d.ParenthesisL)){if(!this.accept(d.Ident))return this.finish(e,F.IdentifierExpected,[d.SemiColon]);do{if(!this.accept(d.Comma))break}while(this.accept(d.Ident));if(!this.accept(d.ParenthesisR))return this.finish(e,F.RightParenthesisExpected,[d.SemiColon])}return e.addChild(this._parseURILiteral())||e.addChild(this._parseStringLiteral())?(this.peek(d.SemiColon)||this.peek(d.EOF)||e.setMedialist(this._parseMediaQueryList()),this._completeParseImport(e)):this.finish(e,F.URIOrStringExpected,[d.SemiColon])}_parsePlugin(){if(!this.peekKeyword("@plugin"))return null;let e=this.createNode(u.Plugin);return this.consumeToken(),e.addChild(this._parseStringLiteral())?this.accept(d.SemiColon)?this.finish(e):this.finish(e,F.SemiColonExpected):this.finish(e,F.StringLiteralExpected)}_parseMediaQuery(){var e=super._parseMediaQuery();if(e)return e;{let e=this.create(Ae);return e.addChild(this._parseVariable())?this.finish(e):null}}_parseMediaDeclaration(e=!1){return this._tryParseRuleset(e)||this._tryToParseDeclaration()||this._tryParseMixinDeclaration()||this._tryParseMixinReference()||this._parseDetachedRuleSetMixin()||this._parseStylesheetStatement(e)}_parseMediaFeatureName(){return this._parseIdent()||this._parseVariable()}_parseVariableDeclaration(e=[]){let t=this.create(Xe),n=this.mark();if(!t.setVariable(this._parseVariable(!0)))return null;if(!this.accept(d.Colon))return this.restoreAtMark(n),null;if(this.prevToken&&(t.colonPosition=this.prevToken.offset),t.setValue(this._parseDetachedRuleSet()))t.needsSemicolon=!1;else if(!t.setValue(this._parseExpr()))return this.finish(t,F.VariableValueExpected,[],e);return t.addChild(this._parsePrio()),this.peek(d.SemiColon)&&(t.semicolonPosition=this.token.offset),this.finish(t)}_parseDetachedRuleSet(){var t=this.mark();if(this.peekDelim("#")||this.peekDelim(".")){if(this.consumeToken(),this.hasWhitespace()||!this.accept(d.ParenthesisL))return this.restoreAtMark(t),null;{let e=this.create(rt);if(e.getParameters().addChild(this._parseMixinParameter()))for(;(this.accept(d.Comma)||this.accept(d.SemiColon))&&!this.peek(d.ParenthesisR);)e.getParameters().addChild(this._parseMixinParameter())||this.markError(e,F.IdentifierExpected,[],[d.ParenthesisR]);if(!this.accept(d.ParenthesisR))return this.restoreAtMark(t),null}}if(!this.peek(d.CurlyL))return null;t=this.create(h);return this._parseBody(t,this._parseDetachedRuleSetBody.bind(this)),this.finish(t)}_parseDetachedRuleSetBody(){return this._tryParseKeyframeSelector()||this._parseRuleSetDeclaration()}_addLookupChildren(e){if(!e.addChild(this._parseLookupValue()))return!1;let t=!1;for(;this.peek(d.BracketL)&&(t=!0),e.addChild(this._parseLookupValue());)t=!1;return!t}_parseLookupValue(){let e=this.create(p),t=this.mark();return this.accept(d.BracketL)&&((e.addChild(this._parseVariable(!1,!0))||e.addChild(this._parsePropertyIdentifier()))&&this.accept(d.BracketR)||this.accept(d.BracketR))?e:(this.restoreAtMark(t),null)}_parseVariable(e=!1,t=!1){var n=!e&&this.peekDelim("$");if(!this.peekDelim("@")&&!n&&!this.peek(d.AtKeyword))return null;for(var n=this.create(Qe),r=this.mark();this.acceptDelim("@")||!e&&this.acceptDelim("$");)if(this.hasWhitespace())return this.restoreAtMark(r),null;return(this.accept(d.AtKeyword)||this.accept(d.Ident))&&(t||!this.peek(d.BracketL)||this._addLookupChildren(n))?n:(this.restoreAtMark(r),null)}_parseTermExpression(){return this._parseVariable()||this._parseEscaped()||super._parseTermExpression()||this._tryParseMixinReference(!1)}_parseEscaped(){var e;return this.peek(d.EscapedJavaScript)||this.peek(d.BadEscapedJavaScript)?(e=this.createNode(u.EscapedValue),this.consumeToken(),this.finish(e)):this.peekDelim("~")?(e=this.createNode(u.EscapedValue),this.consumeToken(),this.accept(d.String)||this.accept(d.EscapedJavaScript)?this.finish(e):this.finish(e,F.TermExpected)):null}_parseOperator(){return this._parseGuardOperator()||super._parseOperator()}_parseGuardOperator(){var e;return this.peekDelim(">")?(e=this.createNode(u.Operator),this.consumeToken(),this.acceptDelim("="),e):this.peekDelim("=")?(e=this.createNode(u.Operator),this.consumeToken(),this.acceptDelim("<"),e):this.peekDelim("<")?(e=this.createNode(u.Operator),this.consumeToken(),this.acceptDelim("="),e):null}_parseRuleSetDeclaration(){return this.peek(d.AtKeyword)?this._parseKeyframe()||this._parseMedia(!0)||this._parseImport()||this._parseSupports(!0)||this._parseLayer()||this._parsePropertyAtRule()||this._parseContainer(!0)||this._parseDetachedRuleSetMixin()||this._parseVariableDeclaration()||this._parseRuleSetDeclarationAtStatement():this._tryParseMixinDeclaration()||this._tryParseRuleset(!0)||this._tryParseMixinReference()||this._parseFunction()||this._parseExtend()||this._parseDeclaration()}_parseKeyframeIdent(){return this._parseIdent([o.Keyframe])||this._parseVariable()}_parseKeyframeSelector(){return this._parseDetachedRuleSetMixin()||super._parseKeyframeSelector()}_parseSelector(e){let t=this.create(ie),n=!1;for(e&&(n=t.addChild(this._parseCombinator()));t.addChild(this._parseSimpleSelector());){n=!0;var r=this.mark();if(t.addChild(this._parseGuard())&&this.peek(d.CurlyL))break;this.restoreAtMark(r),t.addChild(this._parseCombinator())}return n?this.finish(t):null}_parseNestingSelector(){if(this.peekDelim("&")){let e=this.createNode(u.SelectorCombinator);for(this.consumeToken();!this.hasWhitespace()&&(this.acceptDelim("-")||this.accept(d.Num)||this.accept(d.Dimension)||e.addChild(this._parseIdent())||this.acceptDelim("&")););return this.finish(e)}return null}_parseSelectorIdent(){if(!this.peekInterpolatedIdent())return null;var e=this.createNode(u.SelectorInterpolation);return this._acceptInterpolatedIdent(e)?this.finish(e):null}_parsePropertyIdentifier(e=!1){var t=/^[\w-]+/;if(!this.peekInterpolatedIdent()&&!this.peekRegExp(this.token.type,t))return null;let n=this.mark(),r=this.create(c),i=(r.isCustomProperty=this.acceptDelim("-")&&this.acceptDelim("-"),!1);return(i=e?r.isCustomProperty?r.addChild(this._parseIdent()):r.addChild(this._parseRegexp(t)):r.isCustomProperty?this._acceptInterpolatedIdent(r):this._acceptInterpolatedIdent(r,t))?(e||this.hasWhitespace()||(this.acceptDelim("+"),this.hasWhitespace()||this.acceptIdent("_")),this.finish(r)):(this.restoreAtMark(n),null)}peekInterpolatedIdent(){return this.peek(d.Ident)||this.peekDelim("@")||this.peekDelim("$")||this.peekDelim("-")}_acceptInterpolatedIdent(e,t){let n=!1,r=()=>{var e=this.mark();return this.acceptDelim("-")&&(this.hasWhitespace()||this.acceptDelim("-"),this.hasWhitespace())?(this.restoreAtMark(e),null):this._parseInterpolation()},i=t?()=>this.acceptRegexp(t):()=>this.accept(d.Ident);for(;(i()||e.addChild(this._parseInterpolation()||this.try(r)))&&(n=!0,!this.hasWhitespace()););return n}_parseInterpolation(){var t=this.mark();if(this.peekDelim("@")||this.peekDelim("$")){let e=this.createNode(u.Interpolation);return this.consumeToken(),this.hasWhitespace()||!this.accept(d.CurlyL)?(this.restoreAtMark(t),null):e.addChild(this._parseIdent())?this.accept(d.CurlyR)?this.finish(e):this.finish(e,F.RightCurlyExpected):this.finish(e,F.IdentifierExpected)}return null}_tryParseMixinDeclaration(){let e=this.mark(),t=this.create(rt);if(!t.setIdentifier(this._parseMixinDeclarationIdentifier())||!this.accept(d.ParenthesisL))return this.restoreAtMark(e),null;if(t.getParameters().addChild(this._parseMixinParameter()))for(;(this.accept(d.Comma)||this.accept(d.SemiColon))&&!this.peek(d.ParenthesisR);)t.getParameters().addChild(this._parseMixinParameter())||this.markError(t,F.IdentifierExpected,[],[d.ParenthesisR]);return this.accept(d.ParenthesisR)?(t.setGuard(this._parseGuard()),this.peek(d.CurlyL)?this._parseBody(t,this._parseMixInBodyDeclaration.bind(this)):(this.restoreAtMark(e),null)):(this.restoreAtMark(e),null)}_parseMixInBodyDeclaration(){return this._parseFontFace()||this._parseRuleSetDeclaration()}_parseMixinDeclarationIdentifier(){let e;if(this.peekDelim("#")||this.peekDelim(".")){if(e=this.create(c),this.consumeToken(),this.hasWhitespace()||!e.addChild(this._parseIdent()))return null}else{if(!this.peek(d.Hash))return null;e=this.create(c),this.consumeToken()}return e.referenceTypes=[o.Mixin],this.finish(e)}_parsePseudo(){if(!this.peek(d.Colon))return null;var e=this.mark(),t=this.create(Ze);return this.consumeToken(),this.acceptIdent("extend")?this._completeExtends(t):(this.restoreAtMark(e),super._parsePseudo())}_parseExtend(){if(!this.peekDelim("&"))return null;var e=this.mark(),t=this.create(Ze);return this.consumeToken(),!this.hasWhitespace()&&this.accept(d.Colon)&&this.acceptIdent("extend")?this._completeExtends(t):(this.restoreAtMark(e),null)}_completeExtends(e){if(!this.accept(d.ParenthesisL))return this.finish(e,F.LeftParenthesisExpected);let t=e.getSelectors();if(!t.addChild(this._parseSelector(!0)))return this.finish(e,F.SelectorExpected);for(;this.accept(d.Comma);)if(!t.addChild(this._parseSelector(!0)))return this.finish(e,F.SelectorExpected);return this.accept(d.ParenthesisR)?this.finish(e):this.finish(e,F.RightParenthesisExpected)}_parseDetachedRuleSetMixin(){if(!this.peek(d.AtKeyword))return null;let e=this.mark(),t=this.create(nt);return!t.addChild(this._parseVariable(!0))||!this.hasWhitespace()&&this.accept(d.ParenthesisL)?this.accept(d.ParenthesisR)?this.finish(t):this.finish(t,F.RightParenthesisExpected):(this.restoreAtMark(e),null)}_tryParseMixinReference(e=!0){let t=this.mark(),n=this.create(nt),r=this._parseMixinDeclarationIdentifier();for(;r;){this.acceptDelim(">");var i=this._parseMixinDeclarationIdentifier();if(!i)break;n.getNamespaces().addChild(r),r=i}if(!n.setIdentifier(r))return this.restoreAtMark(t),null;let s=!1;if(this.accept(d.ParenthesisL)){if(s=!0,n.getArguments().addChild(this._parseMixinArgument()))for(;(this.accept(d.Comma)||this.accept(d.SemiColon))&&!this.peek(d.ParenthesisR);)if(!n.getArguments().addChild(this._parseMixinArgument()))return this.finish(n,F.ExpressionExpected);if(!this.accept(d.ParenthesisR))return this.finish(n,F.RightParenthesisExpected);r.referenceTypes=[o.Mixin]}else r.referenceTypes=[o.Mixin,o.Rule];return this.peek(d.BracketL)?e||this._addLookupChildren(n):n.addChild(this._parsePrio()),s||this.peek(d.SemiColon)||this.peek(d.CurlyR)||this.peek(d.EOF)?this.finish(n):(this.restoreAtMark(t),null)}_parseMixinArgument(){let e=this.create(pe),t=this.mark(),n=this._parseVariable();return n&&(this.accept(d.Colon)?e.setIdentifier(n):this.restoreAtMark(t)),e.setValue(this._parseDetachedRuleSet()||this._parseExpr(!0))?this.finish(e):(this.restoreAtMark(t),null)}_parseMixinParameter(){let e=this.create(he);var t;if(this.peekKeyword("@rest"))return t=this.create(p),this.consumeToken(),this.accept(fi)?(e.setIdentifier(this.finish(t)),this.finish(e)):this.finish(e,F.DotExpected,[],[d.Comma,d.ParenthesisR]);if(this.peek(fi))return t=this.create(p),this.consumeToken(),e.setIdentifier(this.finish(t)),this.finish(e);let n=!1;return e.setIdentifier(this._parseVariable())&&(this.accept(d.Colon),n=!0),e.setDefaultValue(this._parseDetachedRuleSet()||this._parseExpr(!0))||n?this.finish(e):null}_parseGuard(){if(!this.peekIdent("when"))return null;let e=this.create(at);if(this.consumeToken(),!e.getConditions().addChild(this._parseGuardCondition()))return this.finish(e,F.ConditionExpected);for(;this.acceptIdent("and")||this.accept(d.Comma);)if(!e.getConditions().addChild(this._parseGuardCondition()))return this.finish(e,F.ConditionExpected);return this.finish(e)}_parseGuardCondition(){let e=this.create(ot);return e.isNegated=this.acceptIdent("not"),this.accept(d.ParenthesisL)?(e.addChild(this._parseExpr()),this.accept(d.ParenthesisR)?this.finish(e):this.finish(e,F.RightParenthesisExpected)):e.isNegated?this.finish(e,F.LeftParenthesisExpected):null}_parseFunction(){let e=this.mark(),t=this.create(de);if(!t.setIdentifier(this._parseFunctionIdentifier()))return null;if(this.hasWhitespace()||!this.accept(d.ParenthesisL))return this.restoreAtMark(e),null;if(t.getArguments().addChild(this._parseMixinArgument()))for(;(this.accept(d.Comma)||this.accept(d.SemiColon))&&!this.peek(d.ParenthesisR);)if(!t.getArguments().addChild(this._parseMixinArgument()))return this.finish(t,F.ExpressionExpected);return this.accept(d.ParenthesisR)?this.finish(t):this.finish(t,F.RightParenthesisExpected)}_parseFunctionIdentifier(){if(this.peekDelim("%")){let e=this.create(c);return e.referenceTypes=[o.Function],this.consumeToken(),this.finish(e)}return super._parseFunctionIdentifier()}_parseURLArgument(){var t=this.mark(),e=super._parseURLArgument();if(e&&this.peek(d.ParenthesisR))return e;{this.restoreAtMark(t);let e=this.create(p);return e.addChild(this._parseBinaryExpr()),this.finish(e)}}},vi=class Ji extends mr{constructor(e,t){super("@",e,t)}createFunctionProposals(e,t,n,r){for(var i of e){let e={label:i.name,detail:i.example,documentation:i.description,textEdit:S.replace(this.getCompletionRange(t),i.name+"($0)"),insertTextFormat:g.Snippet,kind:C.Function};n&&(e.sortText="z"),r.items.push(e)}return r}getTermProposals(t,e,n){let r=Ji.builtInProposals;return t&&(r=r.filter(e=>!e.type||!t.restrictions||-1!==t.restrictions.indexOf(e.type))),this.createFunctionProposals(r,e,!0,n),super.getTermProposals(t,e,n)}getColorProposals(e,t,n){return this.createFunctionProposals(Ji.colorProposals,t,!1,n),super.getColorProposals(e,t,n)}getCompletionsForDeclarationProperty(e,t){return this.getCompletionsForSelector(null,!0,t),super.getCompletionsForDeclarationProperty(e,t)}};function wi(i,s){i=function(r){function i(e){return r.positionAt(e.offset).line}function s(e){return r.positionAt(e.offset+e.len).line}let t=[],a=[],e=function(){switch(r.languageId){case"scss":return new ai;case"less":return new gi;default:return new J}}(),o=(e.ignoreComment=!1,e.setSource(r.getText()),e.scan()),n=null;for(;o.type!==d.EOF;){switch(o.type){case d.CurlyL:case ei:a.push({line:i(o),type:"brace",isStart:!0});break;case d.CurlyR:if(0!==a.length){var l=yi(a,"brace");if(!l)break;let e=s(o);"brace"===l.type&&(n&&s(n)!==e&&e--,l.line!==e&&t.push({startLine:l.line,endLine:e,kind:void 0}))}break;case d.Comment:{let n=e=>"#region"===e?{line:i(o),type:"comment",isStart:!0}:{line:s(o),type:"comment",isStart:!1},e=(e=>{var t=e.text.match(/^\s*\/\*\s*(#region|#endregion)\b\s*(.*?)\s*\*\//);if(t)return n(t[1]);if("scss"===r.languageId||"less"===r.languageId){t=e.text.match(/^\s*\/\/\s*(#region|#endregion)\b\s*(.*?)\s*/);if(t)return n(t[1])}return null})(o);if(e)if(e.isStart)a.push(e);else{l=yi(a,"comment");if(!l)break;"comment"===l.type&&l.line!==e.line&&t.push({startLine:l.line,endLine:e.line,kind:"region"})}else{var c=function(e,t){var n=i(e),e=s(e);return n!==e?{startLine:n,endLine:e,kind:t}:null}(o,"comment");c&&t.push(c)}break}}n=o,o=e.scan()}return t}(i);{let e=s&&s.rangeLimit||Number.MAX_VALUE,t=i.sort((e,t)=>{let n=e.startLine-t.startLine;return n=0===n?e.endLine-t.endLine:n}),n=[],r=-1;return t.forEach(e=>{e.startLine<r&&r<e.endLine||(n.push(e),r=e.endLine)}),n.length<e?n:n.slice(0,e)}}function yi(t,n){if(0===t.length)return null;for(let e=t.length-1;0<=e;e--)if(t[e].type===n&&t[e].isStart)return t.splice(e,1)[0];return null}vi.builtInProposals=[{name:"if",example:"if(condition, trueValue [, falseValue]);",description:x("returns one of two values depending on a condition.")},{name:"boolean",example:"boolean(condition);",description:x('"store" a boolean test for later evaluation in a guard or if().')},{name:"length",example:"length(@list);",description:x("returns the number of elements in a value list")},{name:"extract",example:"extract(@list, index);",description:x("returns a value at the specified position in the list")},{name:"range",example:"range([start, ] end [, step]);",description:x("generate a list spanning a range of values")},{name:"each",example:"each(@list, ruleset);",description:x("bind the evaluation of a ruleset to each member of a list.")},{name:"escape",example:"escape(@string);",description:x("URL encodes a string")},{name:"e",example:"e(@string);",description:x("escape string content")},{name:"replace",example:"replace(@string, @pattern, @replacement[, @flags]);",description:x("string replace")},{name:"unit",example:"unit(@dimension, [@unit: '']);",description:x("remove or change the unit of a dimension")},{name:"color",example:"color(@string);",description:x("parses a string to a color"),type:"color"},{name:"convert",example:"convert(@value, unit);",description:x("converts numbers from one type into another")},{name:"data-uri",example:"data-uri([mimetype,] url);",description:x("inlines a resource and falls back to `url()`"),type:"url"},{name:"abs",description:x("absolute value of a number"),example:"abs(number);"},{name:"acos",description:x("arccosine - inverse of cosine function"),example:"acos(number);"},{name:"asin",description:x("arcsine - inverse of sine function"),example:"asin(number);"},{name:"ceil",example:"ceil(@number);",description:x("rounds up to an integer")},{name:"cos",description:x("cosine function"),example:"cos(number);"},{name:"floor",description:x("rounds down to an integer"),example:"floor(@number);"},{name:"percentage",description:x("converts to a %, e.g. 0.5 > 50%"),example:"percentage(@number);",type:"percentage"},{name:"round",description:x("rounds a number to a number of places"),example:"round(number, [places: 0]);"},{name:"sqrt",description:x("calculates square root of a number"),example:"sqrt(number);"},{name:"sin",description:x("sine function"),example:"sin(number);"},{name:"tan",description:x("tangent function"),example:"tan(number);"},{name:"atan",description:x("arctangent - inverse of tangent function"),example:"atan(number);"},{name:"pi",description:x("returns pi"),example:"pi();"},{name:"pow",description:x("first argument raised to the power of the second argument"),example:"pow(@base, @exponent);"},{name:"mod",description:x("first argument modulus second argument"),example:"mod(number, number);"},{name:"min",description:x("returns the lowest of one or more values"),example:"min(@x, @y);"},{name:"max",description:x("returns the lowest of one or more values"),example:"max(@x, @y);"}],vi.colorProposals=[{name:"argb",example:"argb(@color);",description:x("creates a #AARRGGBB")},{name:"hsl",example:"hsl(@hue, @saturation, @lightness);",description:x("creates a color")},{name:"hsla",example:"hsla(@hue, @saturation, @lightness, @alpha);",description:x("creates a color")},{name:"hsv",example:"hsv(@hue, @saturation, @value);",description:x("creates a color")},{name:"hsva",example:"hsva(@hue, @saturation, @value, @alpha);",description:x("creates a color")},{name:"hue",example:"hue(@color);",description:x("returns the `hue` channel of `@color` in the HSL space")},{name:"saturation",example:"saturation(@color);",description:x("returns the `saturation` channel of `@color` in the HSL space")},{name:"lightness",example:"lightness(@color);",description:x("returns the `lightness` channel of `@color` in the HSL space")},{name:"hsvhue",example:"hsvhue(@color);",description:x("returns the `hue` channel of `@color` in the HSV space")},{name:"hsvsaturation",example:"hsvsaturation(@color);",description:x("returns the `saturation` channel of `@color` in the HSV space")},{name:"hsvvalue",example:"hsvvalue(@color);",description:x("returns the `value` channel of `@color` in the HSV space")},{name:"red",example:"red(@color);",description:x("returns the `red` channel of `@color`")},{name:"green",example:"green(@color);",description:x("returns the `green` channel of `@color`")},{name:"blue",example:"blue(@color);",description:x("returns the `blue` channel of `@color`")},{name:"alpha",example:"alpha(@color);",description:x("returns the `alpha` channel of `@color`")},{name:"luma",example:"luma(@color);",description:x("returns the `luma` value (perceptual brightness) of `@color`")},{name:"saturate",example:"saturate(@color, 10%);",description:x("return `@color` 10% points more saturated")},{name:"desaturate",example:"desaturate(@color, 10%);",description:x("return `@color` 10% points less saturated")},{name:"lighten",example:"lighten(@color, 10%);",description:x("return `@color` 10% points lighter")},{name:"darken",example:"darken(@color, 10%);",description:x("return `@color` 10% points darker")},{name:"fadein",example:"fadein(@color, 10%);",description:x("return `@color` 10% points less transparent")},{name:"fadeout",example:"fadeout(@color, 10%);",description:x("return `@color` 10% points more transparent")},{name:"fade",example:"fade(@color, 50%);",description:x("return `@color` with 50% transparency")},{name:"spin",example:"spin(@color, 10);",description:x("return `@color` with a 10 degree larger in hue")},{name:"mix",example:"mix(@color1, @color2, [@weight: 50%]);",description:x("return a mix of `@color1` and `@color2`")},{name:"greyscale",example:"greyscale(@color);",description:x("returns a grey, 100% desaturated color")},{name:"contrast",example:"contrast(@color1, [@darkcolor: black], [@lightcolor: white], [@threshold: 43%]);",description:x("return `@darkcolor` if `@color1 is> 43% luma` otherwise return `@lightcolor`, see notes")},{name:"multiply",example:"multiply(@color1, @color2);"},{name:"screen",example:"screen(@color1, @color2);"},{name:"overlay",example:"overlay(@color1, @color2);"},{name:"softlight",example:"softlight(@color1, @color2);"},{name:"hardlight",example:"hardlight(@color1, @color2);"},{name:"difference",example:"difference(@color1, @color2);"},{name:"exclusion",example:"exclusion(@color1, @color2);"},{name:"average",example:"average(@color1, @color2);"},{name:"negation",example:"negation(@color1, @color2);"}],pi=[,,function(e){function i(e){this.__parent=e,this.__character_count=0,this.__indent_count=-1,this.__alignment_count=0,this.__wrap_point_index=0,this.__wrap_point_character_count=0,this.__wrap_point_indent_count=-1,this.__wrap_point_alignment_count=0,this.__items=[]}function n(e,t){this.__cache=[""],this.__indent_size=e.indent_size,this.__indent_string=e.indent_char,e.indent_with_tabs||(this.__indent_string=new Array(e.indent_size+1).join(e.indent_char)),t=t||"",0<e.indent_level&&(t=new Array(e.indent_level+1).join(this.__indent_string)),this.__base_string=t,this.__base_string_length=t.length}function t(e,t){this.__indent_cache=new n(e,t),this.raw=!1,this._end_with_newline=e.end_with_newline,this.indent_size=e.indent_size,this.wrap_line_length=e.wrap_line_length,this.indent_empty_lines=e.indent_empty_lines,this.__lines=[],this.previous_line=null,this.current_line=null,this.next_line=new i(this),this.space_before_token=!1,this.non_breaking_space=!1,this.previous_token_wrapped=!1,this.__add_outputline()}i.prototype.clone_empty=function(){var e=new i(this.__parent);return e.set_indent(this.__indent_count,this.__alignment_count),e},i.prototype.item=function(e){return e<0?this.__items[this.__items.length+e]:this.__items[e]},i.prototype.has_match=function(e){for(var t=this.__items.length-1;0<=t;t--)if(this.__items[t].match(e))return!0;return!1},i.prototype.set_indent=function(e,t){this.is_empty()&&(this.__indent_count=e||0,this.__alignment_count=t||0,this.__character_count=this.__parent.get_indent_size(this.__indent_count,this.__alignment_count))},i.prototype._set_wrap_point=function(){this.__parent.wrap_line_length&&(this.__wrap_point_index=this.__items.length,this.__wrap_point_character_count=this.__character_count,this.__wrap_point_indent_count=this.__parent.next_line.__indent_count,this.__wrap_point_alignment_count=this.__parent.next_line.__alignment_count)},i.prototype._should_wrap=function(){return this.__wrap_point_index&&this.__character_count>this.__parent.wrap_line_length&&this.__wrap_point_character_count>this.__parent.next_line.__character_count},i.prototype._allow_wrap=function(){var e;return!!this._should_wrap()&&(this.__parent.add_new_line(),(e=this.__parent.current_line).set_indent(this.__wrap_point_indent_count,this.__wrap_point_alignment_count),e.__items=this.__items.slice(this.__wrap_point_index),this.__items=this.__items.slice(0,this.__wrap_point_index),e.__character_count+=this.__character_count-this.__wrap_point_character_count,this.__character_count=this.__wrap_point_character_count," "===e.__items[0]&&(e.__items.splice(0,1),--e.__character_count),!0)},i.prototype.is_empty=function(){return 0===this.__items.length},i.prototype.last=function(){return this.is_empty()?null:this.__items[this.__items.length-1]},i.prototype.push=function(e){this.__items.push(e);var t=e.lastIndexOf(`
