...
namespace SampleAutoApp.Client.Pages;
...
public partial class DiffEditor
{
    ...
    private async Task EditorOnDidInit()
    {
        ...
        var original_model = await BlazorMonaco.Editor.Global.GetModel(jsRuntime, "sample-diff-editor-originalModel");
        ...
        var modified_model = await BlazorMonaco.Editor.Global.GetModel(jsRuntime, "sample-diff-editor-modifiedModel");
